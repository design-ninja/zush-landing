---
description: Comprehensive code quality review for React/TypeScript + Paddle integration
---

# Code Quality Review Workflow - React Landing Page & Paddle

Use this prompt to perform a thorough code quality audit for the landing page and Paddle checkout integration.
...
Begin by scanning the project structure, then systematically review each component. Focus on actionable improvements that will have the highest impact on code quality, maintainability, and performance.
