...
AD_GROUPS: tuple[AdGroupSpec, ...] = (
    AdGroupSpec(
        ...
        headlines=(
            ...
            "Apple Silicon + Intel",
            "Rename PDFs and Photos",
            "Folder Monitoring",
            "BYOK and Offline AI",
        ),
        descriptions=(
            "Rename screenshots, PDFs, photos and docs with AI. 50 renames included.",
            "Native Mac app for Apple Silicon and Intel. Batch rename or monitor folders.",
            "Originals stay on your Mac. Create searchable names for messy files.",
            "Replace IMG_4382 and download.pdf with clear names in seconds.",
        ),
    ),
    AdGroupSpec(
