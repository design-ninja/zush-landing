...
const EN_PLATFORM_OVERRIDES: PlatformOverrides = {
  mac: {
    featuresTitle: 'Your Mac naming system, powered by AI',
    featuresDescription:
      'Combine file content, metadata, dates, custom instructions, and reusable blocks into Finder filenames that match the way you work. Zush suggests — you review and decide.',
    featureCards: {
      aiAnalysis: {
        title: 'Rename files with AI on Mac',
        description:
          'Analyze screenshots, Figma, Sketch, Illustrator, PSD, audio, videos, EPUB and FB2 ebooks, PDFs, HEIC and RAW photos, Office docs, iWork files, and exports without leaving a native macOS workflow.',
      },
      foldersMonitoring: {
      ...
      byok: {
        title: 'BYOK on Mac',
        description:
          'Connect Gemini, OpenRouter, OpenAI, or Claude with your own key when you want unlimited cloud renames from macOS.',
      },
      offlineAi: {
    ...
    useCases: {
      items: [
        ...
        },
        {
          title: 'Creators',
          description:
            'Rename thumbnails, b-roll clips, screen recordings, and image exports before they pile up in Desktop or Downloads.',
        },
        {
          title: 'Managers',
          description:
  ...
  windows: {
    featuresTitle: 'Your Windows naming system, powered by AI',
    featuresDescription:
      'Combine file content, metadata, dates, custom instructions, and reusable blocks into File Explorer filenames that match the way you work. Zush suggests — you review and decide.',
    featureCards: {
      aiAnalysis: {
        title: 'Rename files with AI on Windows 11',
        description:
          'Analyze screenshots, design files, audio, videos, EPUB and FB2 ebooks, PDFs, photos, Office docs, iWork files, and exports from ordinary Windows 11 or Windows 10 folders.',
      },
      foldersMonitoring: {
      ...
      byok: {
        ...
        description:
          'Use your own Gemini, OpenRouter, OpenAI, or Claude key for cloud renames; FREE includes 50 across all modes and PRO is unlimited from the Windows app.',
      },
      offlineAi: {
        title: 'LM Studio or Ollama',
        description:
    ...
    useCases: {
      items: [
        ...
        },
        {
          title: 'Creators',
          description:
            'Organize thumbnails, social exports, b-roll clips, screen recordings, and reference images before project folders get hard to scan.',
        },
        {
          title: 'Managers',
          description:
...
const PLATFORM_OVERRIDES: Partial<Record<Locale, PlatformOverrides>> = {
  ...
  de: {
    mac: {
      featuresTitle: 'Dein Mac-Namenssystem, unterstützt durch KI',
      featuresDescription: 'Kombiniere Dateiinhalte, Metadaten, Daten, eigene Anweisungen und wiederverwendbare Bausteine zu Finder-Namen, die zu deiner Arbeitsweise passen. Zush schlägt vor — du entscheidest.',
      featureCards: {
        aiAnalysis: { title: 'KI-Analyse für Mac-Dateien', description: 'Analysiere Screenshots, Videos, EPUB- und FB2-E-Books, PDFs, HEIC- und RAW-Fotos, Office-Dokumente und Exporte direkt im nativen macOS-Workflow.' },
        ...
        byok: { title: 'BYOK auf dem Mac', description: 'Verbinde Gemini, OpenRouter, OpenAI oder Claude mit deinem eigenen Schlüssel für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt auf macOS.' },
        offlineAi: { title: 'Lokale KI mit Ollama', description: 'Nutze lokale Modelle für unterstützte Mac-Dateien, wenn Datenschutz oder Offline-Arbeit wichtiger als Cloud-Speed sind.' },
      },
    ...
    windows: {
      featuresTitle: 'Dein Windows-Namenssystem, unterstützt durch KI',
      featuresDescription: 'Kombiniere Dateiinhalte, Metadaten, Daten, eigene Anweisungen und wiederverwendbare Bausteine zu Namen für den Datei-Explorer. Zush schlägt vor — du entscheidest.',
      featureCards: {
        aiAnalysis: { title: 'KI-Analyse für Windows-Dateien', description: 'Analysiere Screenshots, Videos, EPUB- und FB2-E-Books, PDFs, Fotos, Office-Dokumente und Exporte aus normalen Windows-Ordnern.' },
        ...
        byok: { title: 'BYOK auf Windows', description: 'Nutze deinen eigenen Gemini-, OpenRouter-, OpenAI- oder Claude-Schlüssel für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt in der Windows-App.' },
        offlineAi: { title: 'Lokale KI mit Ollama', description: 'Analysiere unterstützte Dateien lokal, wenn private Umbenennung ohne Cloud-Modelle wichtig ist.' },
      },
  ...
  fr: {
    mac: {
      featuresTitle: 'Votre système de nommage Mac, propulsé par l’IA',
      featuresDescription: 'Combinez contenu, métadonnées, dates, instructions et blocs réutilisables pour créer des noms Finder adaptés à votre travail. Zush propose — vous décidez.',
      featureCards: {
        aiAnalysis: { title: 'Analyse IA des fichiers Mac', description: 'Analysez captures, audio, vidéos, ebooks EPUB et FB2, PDF, photos HEIC et RAW, documents Office et exports sans quitter un workflow macOS natif.' },
        ...
        byok: { title: 'BYOK sur Mac', description: 'Connectez Gemini, OpenRouter, OpenAI ou Claude avec votre propre clé pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité sur macOS.' },
        offlineAi: { title: 'IA locale avec Ollama', description: 'Analysez les fichiers Mac pris en charge avec des modèles locaux lorsque la confidentialité prime.' },
      },
    ...
    windows: {
      featuresTitle: 'Votre système de nommage Windows, propulsé par l’IA',
      featuresDescription: 'Combinez contenu, métadonnées, dates, instructions et blocs réutilisables pour créer des noms adaptés à l’Explorateur. Zush propose — vous décidez.',
      featureCards: {
        aiAnalysis: { title: 'Analyse IA des fichiers Windows', description: 'Analysez captures, audio, vidéos, ebooks EPUB et FB2, PDF, photos, documents Office et exports depuis des dossiers Windows ordinaires.' },
        ...
        byok: { title: 'BYOK sur Windows', description: 'Utilisez votre clé Gemini, OpenRouter, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité dans l’app Windows.' },
        offlineAi: { title: 'IA locale avec Ollama', description: 'Analysez localement les fichiers pris en charge quand vous voulez renommer sans modèle cloud.' },
      },
  ...
  'pt-br': {
    mac: {
      featuresTitle: 'Seu sistema de nomes no Mac, com IA',
      featuresDescription: 'Combine conteúdo, metadados, datas, instruções e blocos reutilizáveis em nomes do Finder que seguem seu jeito de trabalhar. O Zush sugere — você decide.',
      featureCards: {
        aiAnalysis: { title: 'Análise de IA para arquivos do Mac', description: 'Analise screenshots, vídeos, ebooks EPUB e FB2, PDFs, fotos HEIC e RAW, documentos Office e exports sem sair do fluxo nativo do macOS.' },
        ...
        byok: { title: 'BYOK no Mac', description: 'Conecte Gemini, OpenRouter, OpenAI ou Claude com sua própria chave para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado no macOS.' },
        offlineAi: { title: 'IA local com Ollama', description: 'Use modelos locais em arquivos Mac compatíveis quando privacidade ou trabalho offline forem prioridade.' },
      },
    ...
    windows: {
      featuresTitle: 'Seu sistema de nomes no Windows, com IA',
      featuresDescription: 'Combine conteúdo, metadados, datas, instruções e blocos reutilizáveis em nomes para o Explorador de Arquivos. O Zush sugere — você decide.',
      featureCards: {
        aiAnalysis: { title: 'Análise de IA para arquivos do Windows', description: 'Analise screenshots, vídeos, ebooks EPUB e FB2, PDFs, fotos, documentos Office e exports de pastas comuns do Windows.' },
        ...
        byok: { title: 'BYOK no Windows', description: 'Use sua chave Gemini, OpenRouter, OpenAI ou Claude para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado no app Windows.' },
        offlineAi: { title: 'IA local com Ollama', description: 'Analise arquivos compatíveis localmente quando quiser renomear com privacidade sem modelos cloud.' },
      },
  ...
  es: {
    mac: {
      featuresTitle: 'Tu sistema de nombres en Mac, impulsado por IA',
      featuresDescription: 'Combina contenido, metadatos, fechas, instrucciones y bloques reutilizables en nombres de Finder que encajan con tu trabajo. Zush propone — tú decides.',
      featureCards: {
        aiAnalysis: { title: 'Análisis IA para archivos de Mac', description: 'Analiza capturas, audio, videos, ebooks EPUB y FB2, PDFs, fotos HEIC y RAW, documentos Office y exports sin salir del flujo nativo de macOS.' },
        ...
        byok: { title: 'BYOK en Mac', description: 'Conecta Gemini, OpenRouter, OpenAI o Claude con tu propia clave para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado en macOS.' },
        offlineAi: { title: 'IA local con Ollama', description: 'Usa modelos locales con archivos Mac compatibles cuando importan más la privacidad o el trabajo sin conexión.' },
      },
    ...
    windows: {
      featuresTitle: 'Tu sistema de nombres en Windows, impulsado por IA',
      featuresDescription: 'Combina contenido, metadatos, fechas, instrucciones y bloques reutilizables en nombres para el Explorador. Zush propone — tú decides.',
      featureCards: {
        aiAnalysis: { title: 'Análisis IA para archivos Windows', description: 'Analiza capturas, audio, videos, ebooks EPUB y FB2, PDFs, fotos, documentos Office y exports desde carpetas normales de Windows.' },
        ...
        byok: { title: 'BYOK en Windows', description: 'Usa tu clave de Gemini, OpenRouter, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado desde la app Windows.' },
        offlineAi: { title: 'IA local con Ollama', description: 'Analiza archivos compatibles localmente cuando quieres renombrar en privado sin modelos cloud.' },
      },
  ...
  nl: {
    mac: {
      featuresTitle: 'Jouw Mac-naamsysteem, aangedreven door AI',
      featuresDescription: 'Combineer inhoud, metadata, datums, eigen instructies en herbruikbare blokken tot Finder-namen die bij jouw werkwijze passen. Zush stelt voor — jij beslist.',
      featureCards: {
        aiAnalysis: { title: 'AI-analyse voor Mac-bestanden', description: 'Analyseer screenshots, video’s, EPUB- en FB2-e-books, PDFs, HEIC- en RAW-foto’s, Office-documenten en exports binnen een native macOS-workflow.' },
        ...
        byok: { title: 'BYOK op Mac', description: 'Verbind Gemini, OpenRouter, OpenAI of Claude met je eigen sleutel voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt op macOS.' },
        offlineAi: { title: 'Lokale AI met Ollama', description: 'Gebruik lokale modellen voor ondersteunde Mac-bestanden wanneer privacy of offline werk belangrijker is.' },
      },
    ...
    windows: {
      featuresTitle: 'Jouw Windows-naamsysteem, aangedreven door AI',
      featuresDescription: 'Combineer inhoud, metadata, datums, eigen instructies en herbruikbare blokken tot namen voor Verkenner. Zush stelt voor — jij beslist.',
      featureCards: {
        aiAnalysis: { title: 'AI-analyse voor Windows-bestanden', description: 'Analyseer screenshots, video’s, EPUB- en FB2-e-books, PDFs, foto’s, Office-documenten en exports vanuit gewone Windows-mappen.' },
        ...
        byok: { title: 'BYOK op Windows', description: 'Gebruik je eigen Gemini-, OpenRouter-, OpenAI- of Claude-sleutel voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt vanuit de Windows-app.' },
        offlineAi: { title: 'Lokale AI met Ollama', description: 'Analyseer ondersteunde bestanden lokaal wanneer je privé wilt hernoemen zonder cloudmodellen.' },
      },
  ...
  it: {
    mac: {
      featuresTitle: 'Il tuo sistema di nomi Mac, potenziato dall’IA',
      featuresDescription: 'Combina contenuto, metadati, date, istruzioni e blocchi riutilizzabili in nomi Finder adatti al tuo lavoro. Zush propone — tu decidi.',
      featureCards: {
        aiAnalysis: { title: 'Analisi IA per file Mac', description: 'Analizza screenshot, video, ebook EPUB e FB2, PDF, foto HEIC e RAW, documenti Office ed export senza uscire dal workflow nativo macOS.' },
        ...
        byok: { title: 'BYOK su Mac', description: 'Collega Gemini, OpenRouter, OpenAI o Claude con la tua chiave per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato su macOS.' },
        offlineAi: { title: 'IA locale con Ollama', description: 'Usa modelli locali sui file Mac supportati quando privacy o lavoro offline contano di più.' },
      },
    ...
    windows: {
      featuresTitle: 'Il tuo sistema di nomi Windows, potenziato dall’IA',
      featuresDescription: 'Combina contenuto, metadati, date, istruzioni e blocchi riutilizzabili in nomi per Esplora file. Zush propone — tu decidi.',
      featureCards: {
        aiAnalysis: { title: 'Analisi IA per file Windows', description: 'Analizza screenshot, video, ebook EPUB e FB2, PDF, foto, documenti Office ed export da normali cartelle Windows.' },
        ...
        byok: { title: 'BYOK su Windows', description: 'Usa la tua chiave Gemini, OpenRouter, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato dall’app Windows.' },
        offlineAi: { title: 'IA locale con Ollama', description: 'Analizza localmente i file supportati quando vuoi rinominare in privato senza modelli cloud.' },
      },
  ...
  ja: {
    mac: {
      featuresTitle: 'AI でつくる Mac の命名システム',
      featuresDescription: '内容、メタデータ、日付、カスタム指示、再利用ブロックを組み合わせて Finder の名前を作成。Zush が提案し、あなたが決定します。',
      featureCards: {
        aiAnalysis: { title: 'Mac ファイルの AI 解析', description: 'スクリーンショット、動画、EPUB・FB2 電子書籍、PDF、HEIC/RAW 写真、Office 文書、書き出しファイルを macOS の流れのまま解析します。' },
        ...
        byok: { title: 'Mac で BYOK', description: 'Gemini、OpenRouter、OpenAI、Claude の自分のキーを使い、macOS からクラウドリネームを拡張できます。' },
        offlineAi: { title: 'Ollama でローカル AI', description: 'プライバシーやオフライン作業を優先したいとき、対応ファイルをローカルモデルで解析できます。' },
      },
    ...
    windows: {
      featuresTitle: 'AI でつくる Windows の命名システム',
      featuresDescription: '内容、メタデータ、日付、カスタム指示、再利用ブロックを組み合わせてエクスプローラーの名前を作成。Zush が提案し、あなたが決定します。',
      featureCards: {
        aiAnalysis: { title: 'Windows ファイルの AI 解析', description: '通常の Windows フォルダ内のスクリーンショット、動画、EPUB・FB2 電子書籍、PDF、写真、Office 文書、書き出しファイルを解析します。' },
        ...
        byok: { title: 'Windows で BYOK', description: '自分の Gemini、OpenRouter、OpenAI、Claude キーを使い、Windows アプリからクラウドリネームを拡張できます。' },
        offlineAi: { title: 'Ollama でローカル AI', description: 'クラウドモデルを使わず、対応ファイルをローカルで解析したいときに使えます。' },
      },
  ...
  ko: {
    mac: {
      featuresTitle: 'AI로 만드는 Mac 이름 규칙',
      featuresDescription: '내용, 메타데이터, 날짜, 사용자 지침과 재사용 블록을 조합해 Finder 이름을 만드세요. Zush가 제안하고 사용자가 결정합니다.',
      featureCards: {
        aiAnalysis: { title: 'Mac 파일 AI 분석', description: '스크린샷, 비디오, EPUB 및 FB2 전자책, PDF, HEIC/RAW 사진, Office 문서, 내보낸 파일을 macOS 흐름 안에서 분석합니다.' },
        ...
        byok: { title: 'Mac에서 BYOK', description: '자신의 Gemini, OpenRouter, OpenAI, Claude 키로 macOS에서 클라우드 이름 변경을 확장합니다.' },
        offlineAi: { title: 'Ollama 로컬 AI', description: '개인정보나 오프라인 작업이 중요할 때 지원되는 Mac 파일을 로컬 모델로 분석합니다.' },
      },
    ...
    windows: {
      featuresTitle: 'AI로 만드는 Windows 이름 규칙',
      featuresDescription: '내용, 메타데이터, 날짜, 사용자 지침과 재사용 블록을 조합해 파일 탐색기 이름을 만드세요. Zush가 제안하고 사용자가 결정합니다.',
      featureCards: {
        aiAnalysis: { title: 'Windows 파일 AI 분석', description: '일반 Windows 폴더의 스크린샷, 비디오, EPUB 및 FB2 전자책, PDF, 사진, Office 문서, 내보낸 파일을 분석합니다.' },
        ...
        byok: { title: 'Windows에서 BYOK', description: '자신의 Gemini, OpenRouter, OpenAI, Claude 키로 Windows 앱에서 클라우드 이름 변경을 확장합니다.' },
        offlineAi: { title: 'Ollama 로컬 AI', description: '클라우드 모델 없이 비공개로 이름을 바꾸고 싶을 때 지원 파일을 로컬에서 분석합니다.' },
      },
  ...
  'zh-cn': {
    mac: {
      featuresTitle: '由 AI 驱动的 Mac 命名系统',
      featuresDescription: '组合内容、元数据、日期、自定义指令和可复用模块，生成符合工作方式的 Finder 文件名。Zush 提供建议，由你决定。',
      featureCards: {
        aiAnalysis: { title: 'Mac 文件 AI 分析', description: '在原生 macOS 流程中分析截图、视频、EPUB 和 FB2 电子书、PDF、HEIC 和 RAW 照片、Office 文档与导出文件。' },
        ...
        byok: { title: 'Mac 上的 BYOK', description: '连接自己的 Gemini、OpenRouter、OpenAI 或 Claude 密钥，在 macOS 上扩展云端重命名。' },
        offlineAi: { title: '通过 Ollama 使用本地 AI', description: '当隐私或离线工作更重要时，用本地模型分析支持的 Mac 文件。' },
      },
    ...
    windows: {
      featuresTitle: '由 AI 驱动的 Windows 命名系统',
      featuresDescription: '组合内容、元数据、日期、自定义指令和可复用模块，生成符合工作方式的文件资源管理器名称。Zush 提供建议，由你决定。',
      featureCards: {
        aiAnalysis: { title: 'Windows 文件 AI 分析', description: '分析普通 Windows 文件夹中的截图、视频、EPUB 和 FB2 电子书、PDF、照片、Office 文档和导出文件。' },
        ...
        byok: { title: 'Windows 上的 BYOK', description: '使用自己的 Gemini、OpenRouter、OpenAI 或 Claude 密钥，在 Windows 应用中扩展云端重命名。' },
        offlineAi: { title: '通过 Ollama 使用本地 AI', description: '当你想不使用云端模型进行私密重命名时，本地分析支持的文件。' },
      },
  ...
  ar: {
    mac: {
      featuresTitle: 'نظام تسمية Mac الخاص بك، مدعوم بالذكاء الاصطناعي',
      featuresDescription: 'اجمع المحتوى والبيانات الوصفية والتواريخ والتعليمات والكتل القابلة لإعادة الاستخدام في أسماء Finder تناسب عملك. يقترح Zush — وأنت تقرر.',
      featureCards: {
        aiAnalysis: { title: 'تحليل بالذكاء الاصطناعي لملفات Mac', description: 'حلّل لقطات الشاشة والفيديو والكتب الإلكترونية EPUB وFB2 وملفات PDF وصور HEIC وRAW ومستندات Office والتصديرات دون مغادرة سير عمل macOS الأصلي.' },
        ...
        byok: { title: 'BYOK على Mac', description: 'وصّل Gemini أو OpenRouter أو OpenAI أو Claude بمفتاحك الخاص عندما تريد إعادة تسمية سحابية غير محدودة من macOS.' },
        offlineAi: { title: 'ذكاء اصطناعي محلي عبر Ollama', description: 'شغّل تحليل الملفات المدعومة على Mac بنماذج محلية عندما تكون الخصوصية أو العمل دون اتصال أهم من سرعة السحابة.' },
      },
    ...
    windows: {
      featuresTitle: 'نظام تسمية Windows الخاص بك، مدعوم بالذكاء الاصطناعي',
      featuresDescription: 'اجمع المحتوى والبيانات الوصفية والتواريخ والتعليمات والكتل القابلة لإعادة الاستخدام في أسماء File Explorer. يقترح Zush — وأنت تقرر.',
      featureCards: {
        aiAnalysis: { title: 'تحليل بالذكاء الاصطناعي لملفات Windows', description: 'حلّل لقطات الشاشة والفيديو والكتب الإلكترونية EPUB وFB2 وملفات PDF والصور ومستندات Office والتصديرات من مجلدات Windows العادية.' },
        ...
        byok: { title: 'BYOK على Windows', description: 'استخدم مفتاح Gemini أو OpenRouter أو OpenAI أو Claude الخاص بك لإعادة تسمية سحابية غير محدودة من تطبيق Windows.' },
        offlineAi: { title: 'ذكاء اصطناعي محلي عبر Ollama', description: 'شغّل تحليل الملفات المدعومة محليا عندما تريد إعادة تسمية خاصة دون إرسال المحتوى إلى نماذج سحابية.' },
      },
