...
const PLATFORM_OVERRIDES: Partial<Record<Locale, PlatformOverrides>> = {
  ...
  de: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'KI-Analyse für Mac-Dateien', description: 'Analysiere Screenshots, Videos, PDFs, HEIC- und RAW-Fotos, Office-Dokumente und Exporte direkt im nativen macOS-Workflow.' },
        ...
        byok: { title: 'BYOK auf dem Mac', description: 'Verbinde Gemini, Groq, OpenAI oder Claude mit deinem eigenen Schlüssel für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt auf macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'KI-Analyse für Windows-Dateien', description: 'Analysiere Screenshots, Videos, PDFs, Fotos, Office-Dokumente und Exporte aus normalen Windows-Ordnern.' },
        ...
        byok: { title: 'BYOK auf Windows', description: 'Nutze deinen eigenen Gemini-, Groq-, OpenAI- oder Claude-Schlüssel für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt in der Windows-App.' },
  ...
  fr: {
    mac: {
      ...
      featureCards: {
        ...
        byok: { title: 'BYOK sur Mac', description: 'Connectez Gemini, Groq, OpenAI ou Claude avec votre propre clé pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité sur macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        ...
        byok: { title: 'BYOK sur Windows', description: 'Utilisez votre clé Gemini, Groq, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité dans l’app Windows.' },
  ...
  'pt-br': {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Análise de IA para arquivos do Mac', description: 'Analise screenshots, vídeos, PDFs, fotos HEIC e RAW, documentos Office e exports sem sair do fluxo nativo do macOS.' },
        ...
        byok: { title: 'BYOK no Mac', description: 'Conecte Gemini, Groq, OpenAI ou Claude com sua própria chave para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado no macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Análise de IA para arquivos do Windows', description: 'Analise screenshots, vídeos, PDFs, fotos, documentos Office e exports de pastas comuns do Windows.' },
        ...
        byok: { title: 'BYOK no Windows', description: 'Use sua chave Gemini, Groq, OpenAI ou Claude para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado no app Windows.' },
  ...
  es: {
    mac: {
      ...
      featureCards: {
        ...
        byok: { title: 'BYOK en Mac', description: 'Conecta Gemini, Groq, OpenAI o Claude con tu propia clave para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado en macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        ...
        byok: { title: 'BYOK en Windows', description: 'Usa tu clave de Gemini, Groq, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado desde la app Windows.' },
  ...
  nl: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'AI-analyse voor Mac-bestanden', description: 'Analyseer screenshots, video’s, PDFs, HEIC- en RAW-foto’s, Office-documenten en exports binnen een native macOS-workflow.' },
        ...
        byok: { title: 'BYOK op Mac', description: 'Verbind Gemini, Groq, OpenAI of Claude met je eigen sleutel voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt op macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'AI-analyse voor Windows-bestanden', description: 'Analyseer screenshots, video’s, PDFs, foto’s, Office-documenten en exports vanuit gewone Windows-mappen.' },
        ...
        byok: { title: 'BYOK op Windows', description: 'Gebruik je eigen Gemini-, Groq-, OpenAI- of Claude-sleutel voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt vanuit de Windows-app.' },
  ...
  it: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Analisi IA per file Mac', description: 'Analizza screenshot, video, PDF, foto HEIC e RAW, documenti Office ed export senza uscire dal workflow nativo macOS.' },
        ...
        byok: { title: 'BYOK su Mac', description: 'Collega Gemini, Groq, OpenAI o Claude con la tua chiave per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato su macOS.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Analisi IA per file Windows', description: 'Analizza screenshot, video, PDF, foto, documenti Office ed export da normali cartelle Windows.' },
        ...
        byok: { title: 'BYOK su Windows', description: 'Usa la tua chiave Gemini, Groq, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato dall’app Windows.' },
  ...
  ja: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Mac ファイルの AI 解析', description: 'スクリーンショット、動画、PDF、HEIC/RAW 写真、Office 文書、書き出しファイルを macOS の流れのまま解析します。' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Windows ファイルの AI 解析', description: '通常の Windows フォルダ内のスクリーンショット、動画、PDF、写真、Office 文書、書き出しファイルを解析します。' },
  ...
  ko: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Mac 파일 AI 분석', description: '스크린샷, 비디오, PDF, HEIC/RAW 사진, Office 문서, 내보낸 파일을 macOS 흐름 안에서 분석합니다.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Windows 파일 AI 분석', description: '일반 Windows 폴더의 스크린샷, 비디오, PDF, 사진, Office 문서, 내보낸 파일을 분석합니다.' },
  ...
  'zh-cn': {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Mac 文件 AI 分析', description: '在原生 macOS 流程中分析截图、视频、PDF、HEIC 和 RAW 照片、Office 文档与导出文件。' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'Windows 文件 AI 分析', description: '分析普通 Windows 文件夹中的截图、视频、PDF、照片、Office 文档和导出文件。' },
  ...
  ar: {
    mac: {
      ...
      featureCards: {
        aiAnalysis: { title: 'تحليل بالذكاء الاصطناعي لملفات Mac', description: 'حلّل لقطات الشاشة والفيديو وملفات PDF وصور HEIC وRAW ومستندات Office والتصديرات دون مغادرة سير عمل macOS الأصلي.' },
    ...
    windows: {
      ...
      featureCards: {
        aiAnalysis: { title: 'تحليل بالذكاء الاصطناعي لملفات Windows', description: 'حلّل لقطات الشاشة والفيديو وملفات PDF والصور ومستندات Office والتصديرات من مجلدات Windows العادية.' },
