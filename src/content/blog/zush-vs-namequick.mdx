...
Quick answer: Zush is <BlogHighlight>$10 one-time</BlogHighlight> for Mac and Windows with 98 supported image, document, video, and audio formats, including RAW photos, documents, videos, and MP3/M4A/WAV audio. NameQuick is <BlogHighlight>macOS only</BlogHighlight>, priced at $5/month (Managed) or $38 one-time + your own API key (Self-Managed/BYOK), with 7 AI providers and a Rules Engine. Choose Zush for cross-platform + lowest total cost. Choose NameQuick for Mac-native depth.
...
| Image formats | 42 (incl. RAW + HEIC + AVIF + PSD) | 30+ formats spanning categories |
| RAW support | <BlogHighlight>Yes (11 variants)</BlogHighlight> | Not listed publicly |
| Document formats | 33 | Office docs covered |
...
Zush runs on both Mac (macOS 14+) and Windows (10/11) and offers two PRO plans: $8/month or $38 one-time, both with unlimited PRO renames. BYOK remains available when you want to use your own AI provider key. Version 3.0 supports 98 formats: 42 image formats including RAW, HEIC, AVIF, PSD, SVG, and TIFF; 33 document formats including Office, OpenDocument, text, CSV/TSV, JSON, XML/YAML, EML, SRT, and VTT; 16 video formats including MP4, MOV, M4V, MPEG, 3GP, TS, MTS, M2TS, DV, and VOB; and 7 audio formats including MP3, M4A, WAV, FLAC, OGG, WebM, and MPGA.
...
NameQuick mentions audio, video, and archives as part of its 30+ formats. Zush 3.0 supports common video files, subtitle sidecars, and audio files including MP3, M4A, WAV, FLAC, OGG, WebM, and MPGA. NameQuick is still broader if ZIP/archive renaming is central to your workflow.
