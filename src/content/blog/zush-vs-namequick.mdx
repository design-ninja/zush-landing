...
Zush runs on both Mac (macOS 14+) and Windows (10/11) and uses one pricing model: $10 one-time for 10,000 credits, with BYOK to remove the cap entirely. Version 2.0 supports 91 formats: 42 image formats including RAW, HEIC, AVIF, PSD, SVG, and TIFF; 33 document formats including Office, OpenDocument, text, CSV/TSV, JSON, XML/YAML, EML, SRT, and VTT; and 16 video formats including MP4, MOV, M4V, MPEG, 3GP, TS, MTS, M2TS, DV, and VOB.
