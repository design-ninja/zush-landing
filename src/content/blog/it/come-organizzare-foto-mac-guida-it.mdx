...
<BlogProductIntro
  title="Vuoi eseguire la rinomina in batch?"
  description="Zush trasforma i nomi predefiniti della fotocamera come IMG, DSC, HEIC e RAW in nomi descrittivi, con anteprima e ripristino prima di modificare la libreria organizzata."
  links={[
    { href: '/it/rename-photos-with-ai', label: 'Rinomina foto con IA' },
    { href: '/it/mac', label: 'Zush per Mac' },
    { href: '/it/for-photographers', label: 'Flusso per fotografi' },
    { href: '/ai-file-organizer', label: 'Organizzatore file con IA' },
  ]}
/>
