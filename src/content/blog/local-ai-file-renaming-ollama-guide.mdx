...
If you want the setup page first, start with the [Ollama setup guide](/ollama-setup). If you want the product surface first, see [File Renamer for Mac and Windows](/file-renamer) or [Zush for Mac](/mac). If you are comparing local-first tools, read [Zush vs AI Renamer](/blog/zush-vs-airenamer).
