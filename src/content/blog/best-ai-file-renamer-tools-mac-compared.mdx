...
<BlogToolMeta platform="macOS (Sonoma and newer)" website="https://zushapp.com/" label="zushapp.com">
  <Fragment slot="pricing">Free tier (50 renames to start), Pro $10 one-time (10,000 renames), BYOK unlimited cloud processing, Local Ollama on supported Mac builds</Fragment>
</BlogToolMeta>
