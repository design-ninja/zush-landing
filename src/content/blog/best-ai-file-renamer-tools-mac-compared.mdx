...
| **Image/design formats** | 41 images + 4 design formats | ~15 | ~4 (Desktop) | ~8 | ~11 | Various |
| **Document formats** | 37, including iWork | ~10 | ~2 (Desktop) | ~5+ | ~8 | Some |
...
| **AI provider choice** | 4 providers + BYOK | Fixed | Ollama/LM Studio/OpenAI | 6 providers + BYOK | Built-in local + 5 providers | Fixed (cloud) |
...
Several tools in this comparison support documents. Zush covers 37 document and PDF-related formats (PDF, DOCX, XLSX, PPTX, TXT, CSV, TSV, JSON, XML/YAML, EML, SRT, VTT, OpenDocument, and more). Renamer.ai supports 30+ formats including PDFs, DOC, DOCX, XLS, XLSX, PPT, PPTX, and more with OCR. NameQuick handles PDFs, Word, Excel, and Pages. RenameClick supports PDF, DOC, DOCX, TXT, MD, CSV, RTF, and ODT. AI Renamer's desktop app adds basic PDF and TXT support. Riffo supports images, PDFs, and some documents.
