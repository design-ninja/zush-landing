...
<BlogToolMeta platform="macOS (Sonoma and newer), plus Windows" website="https://zushapp.com/" label="zushapp.com">
...
![Zush AI Rename screen on macOS — a file renamed to a descriptive name alongside Finder file details](/images/showcase/macos/tags-light.webp)
