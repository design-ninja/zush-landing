...
description: "Compare Windows AI file renamers for screenshots, videos, PDFs, documents, photos, automation, pricing and Microsoft Store readiness."
date: "2026-04-23"
...
Quick answer: for mixed Windows folders our pick is Zush. It handles screenshots, videos, PDFs, photos, and documents in one Microsoft Store app with batch rename, folder monitoring, undo, and a $10 one-time price instead of a subscription.
...
[Zush](https://zushapp.com/windows) is the strongest pick when you need one Windows app for screenshots, videos, PDFs, photos, and documents instead of separate tools for each format. It supports batch rename, folder monitoring, custom prompts, one-click revert, and BYOK in the same desktop workflow.
