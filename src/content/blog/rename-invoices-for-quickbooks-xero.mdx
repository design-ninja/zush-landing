...
2. **Rename.** [Zush](/rename-invoices-with-ai) reads each file (AI vision for scans) and applies the convention with [folder monitoring](/docs/folder-monitoring), or in a manual preview-and-apply batch if you prefer eyes on every name.
