...
description: "File organization for students on Mac: a folder per semester, assignment names that sort correctly, note storage, and a screenshot cleanup that sticks."
date: "2026-02-16"
...
Quick answer: students should keep one semester folder with one subfolder per course, and filenames that include the course code, week, and what the file is — for example `cs101-week-3-lecture-notes.pdf`. Anything more elaborate slows you down.
...
For students with recurring Downloads or screenshot clutter, pair this system with [Auto Rename Files on Mac](/blog/auto-rename-files-mac-guide) and [File Naming Conventions](/blog/file-naming-conventions-best-practices).


<BlogProductIntro
  title="Lecture screenshots and course PDFs piling up?"
  description="Zush renames lecture slides, scanned readings, and screenshots by their actual content, so Spotlight finds the right file the week before an exam."
  links={[
