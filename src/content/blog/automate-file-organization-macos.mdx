...
That is why the strongest setup on Mac is a mixed system. Use Smart Folders, Hazel, Automator, or Shortcuts for routing. Use [Zush](https://zushapp.com) when the real problem is screenshots, videos, PDFs, documents, photos, and downloaded files arriving under useless names.
