...
description: "Set up Mac file automation with Smart Folders, Hazel, Automator, Shortcuts and AI renaming for Downloads, screenshots, PDFs and photos."
date: "2026-02-25"
...
Quick answer: use Smart Folders to see the mess, Hazel or Automator to route predictable files, and AI renaming for screenshots, PDFs, documents, photos, and downloads that need content-aware names.
