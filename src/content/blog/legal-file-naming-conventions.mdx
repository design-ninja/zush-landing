...
This article explains the naming convention itself. Law firms and legal teams comparing the complete product workflow should start with [Zush for legal teams](/for-legal). For generic bulk-renaming mechanics, see [renaming PDF files automatically](/blog/rename-pdf-files-automatically) and the [scanned documents guide](/blog/rename-scanned-documents-automatically).
...
The counterparty, court, or witness the document concerns: `– Vertex GmbH`, `– SDNY`, `– Chen Deposition`. Within a matter folder this is what the eye scans for. Standardize spellings, and keep client-confidential specifics out of names that travel. Medical teams solve the related scanner-intake problem through a separate [medical records file-renaming workflow](/for-medical) built around local Offline AI or organization-controlled BYOK.
...
This intake pile is where automation changes the economics. The [AI PDF renamer](/rename-pdf-with-ai) reads each incoming file — [scans via AI vision](/rename-scanned-documents), no OCR pass needed — and proposes names in your convention. Two features map directly onto legal intake:
