...
1. **Backlog:** drop the invoice archive into [Zush](/rename-invoices-with-ai), pick or build an invoice Template with [Naming Blocks](/docs/naming-blocks) (date, vendor, invoice number, amount), review the preview, and apply the batch — with undo history if the convention needs a second pass.
