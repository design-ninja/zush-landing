---
title: "BYOK AI File Renaming with Your Own API Key (2026)"
description: "Use your own API key for AI file renaming in Zush. Compare Gemini, Groq, OpenAI, and Claude setup, privacy, pricing, the 50-rename free limit, and unlimited PRO."
date: "2026-03-23"
...
tags:
  - "AI File Renaming"
  - "BYOK"
tldr: "Zush BYOK lets you connect your own Gemini, Groq, OpenAI, or Claude key on every plan. FREE includes 50 renames shared across Cloud AI, BYOK, and Offline AI; PRO removes the Zush rename limit. Provider usage is billed separately."
reviewed: "2026-08-04"
---
import BlogProductIntro from '@/components/blog/BlogProductIntro.astro';

Quick answer: BYOK (Bring Your Own Key) lets you connect your own OpenAI, Gemini, Groq, or Claude API key to Zush so you can use your preferred provider account and pay the provider's metered API cost. The final cost depends on provider, model, file size, and token usage. If you are deciding between BYOK, built-in cloud credits, and local Ollama processing, start with [Cloud AI vs Local AI File Renaming](/blog/cloud-vs-local-ai-file-renaming).

Pricing and provider notes last checked June 12, 2026.

Zush includes 50 free AI renames shared across Cloud AI, BYOK, and Offline AI. Both PRO plans remove that limit for $10/month or $48 one-time. BYOK is available on every plan when you want provider-level control or prefer to pay your AI provider directly.

BYOK (Bring Your Own Key) means you connect your personal API key from a supported AI provider to [Zush](/). In current Mac builds, the key is stored locally in macOS Keychain. When BYOK is enabled, Zush relays the analysis request through its backend to your selected provider using your key for that request, the provider returns a descriptive name, and you pay the provider directly at their standard API rates. There is no Zush markup.
