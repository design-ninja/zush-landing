...
description: "Use your own API key for unlimited AI file renaming in Zush. Compare Gemini, Groq, OpenAI, and Claude BYOK setup, privacy, pricing, and cost estimates."
date: "2026-03-23"
...
tags:
  - "AI File Renaming"
  - "BYOK"
tldr: "Zush's BYOK feature lets you connect your own API key from Gemini, Groq, OpenAI, or Claude for unlimited cloud AI file renaming. Two of the four providers offer free tiers, and paid usage depends on provider, model, file size, and token use."
reviewed: "2026-07-19"
---
...
Zush includes 50 free AI renames on the free plan, while both PRO plans unlock unlimited PRO renames: $10/month or $48 one-time. If you process large photo libraries, manage client assets at scale, or want provider-level control, there is another option: bring your own API key.
...
<BlogProductIntro
  title="Want unlimited renames on your own API key?"
  description="Zush BYOK mode sends files to your own Gemini, OpenAI, Groq, or Claude key, so volume is billed by your provider instead of a subscription tier."
  links={[
...
For a comparison of Zush against other tools in this category, see [Mac AI renamer tools comparison](/blog/best-ai-file-renamer-tools-mac-compared) and [AI renamer tools comparison](/blog/best-ai-file-renamer-tools-2026). To get started with [Zush](/), the free plan includes 50 free renames, PRO gives you unlimited renames, and BYOK lets you use your own provider account.
