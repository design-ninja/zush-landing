...
![Zush AI Setup with Offline AI mode using local Ollama models](/images/showcase/macos/offline-ai-light.webp)
...
For a comparison of Zush against other tools in this category, see [Best AI File Renamer Tools for Mac Compared](/blog/best-ai-file-renamer-tools-mac-compared) and [Best AI File Renamer Tools 2026](/blog/best-ai-file-renamer-tools-2026). To get started with [Zush](/file-renamer), the free plan includes 50 free renames, PRO gives you unlimited renames, and BYOK lets you use your own provider account.
