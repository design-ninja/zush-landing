...
Quick answer: BYOK (Bring Your Own Key) lets you connect your own OpenAI, Gemini, Groq, or Claude API key to Zush so you can use your preferred provider account and pay only the provider per-request cost — typically fractions of a cent per file. If you are deciding between BYOK, built-in cloud credits, and local Ollama processing, start with [Cloud AI vs Local AI File Renaming](/blog/cloud-vs-local-ai-file-renaming).
...
BYOK gives you provider control. If you have already decided content-aware renaming is worth doing and want to route analysis through your own account, a Gemini or Groq key will typically cover your entire year for free. At 2,000 renames per month (heavy professional use), OpenAI and Claude both come in under $2/month.
