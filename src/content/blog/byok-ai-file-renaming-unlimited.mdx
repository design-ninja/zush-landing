...
For a comparison of Zush against other tools in this category, see [Best AI File Renamer Tools for Mac Compared](/blog/best-ai-file-renamer-tools-mac-compared). To get started with [Zush](/), the free plan includes 50 free renames, PRO gives you unlimited renames, and BYOK lets you use your own provider account.
