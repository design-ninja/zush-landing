...
Quick answer: BYOK (Bring Your Own Key) lets you connect your own OpenAI, Gemini, Groq, or Claude API key to Zush so you can use your preferred provider account and pay only the provider per-request cost — typically fractions of a cent per file.
...
For a comparison of Zush against other tools in this category, see [Best AI File Renamer Tools for Mac Compared](/blog/best-ai-file-renamer-tools-mac-compared). To get started with [Zush](/file-renamer), the free plan includes 50 free renames, PRO gives you unlimited renames, and BYOK lets you use your own provider account.
