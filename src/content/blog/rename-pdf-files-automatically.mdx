...
Pick your worst PDF folder (usually Downloads or the scanner output directory), open it in [Zush](/rename-pdf-with-ai), and test the naming pattern on a representative batch. The free tier includes 50 renames, so you can validate the workflow before applying it to a larger archive.
