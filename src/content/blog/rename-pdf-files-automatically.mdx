...
If it becomes a regular need, PRO unlocks unlimited renames with either a $8/month plan or a $38 one-time plan. For high-volume directories with folder monitoring on, BYOK remains available if you want to use your own AI provider key.
