...
Storage, access, backup, retention, and deletion rules remain decisions for the organization and the systems that officially hold the records. Zush does not replace those controls. Zush can optionally move renamed files into AI-named folders (beta); keep sorting disabled and the original destination when records must stay in place.
