...
The [AI invoice renamer](/rename-invoices-with-ai) reads each arrival — text PDFs directly, [scans and photos with AI vision](/rename-scanned-documents) — and applies one convention:
