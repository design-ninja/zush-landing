...
If pricing, privacy, or high-volume usage is the deciding factor, read [BYOK: Unlimited AI File Renames](/blog/byok-ai-file-renaming-unlimited) and [Cloud AI vs Local AI File Renaming](/blog/cloud-vs-local-ai-file-renaming) before choosing a setup.
...
Zush offers 50 free renames. For heavier use, PRO unlocks unlimited renames with either a $10/month plan or a $48 one-time plan. BYOK remains available if you want to use your own AI provider key.
