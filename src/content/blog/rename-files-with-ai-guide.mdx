...
[Zush](/file-renamer) is built specifically for this workflow on desktop. It supports 100+ formats across images, design files, documents, videos, and audio, including PNG, JPG, HEIC, RAW, PDF, DOCX, XLSX, SRT, VTT, MP4, MOV, and M2TS.
...
For a Mac-specific batch tutorial, see [Batch Rename Files on Mac: Complete Guide](/blog/batch-rename-files-on-mac-complete-guide). For the Windows equivalent workflow, go to [How to Rename Files with AI on Windows](/blog/rename-files-with-ai-windows-guide) or straight to the [AI batch rename tool](/batch-rename-tool).
