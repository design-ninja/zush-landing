...
[Zush](https://zushapp.com/ai-file-renamer) is built specifically for this workflow on desktop. It supports 23 image formats including PNG, JPG, HEIC, and RAW formats, plus 11 document formats including PDF, DOCX, and XLSX.
