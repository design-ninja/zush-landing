...
For a Mac-specific batch tutorial, see [Batch Rename Files on Mac: Complete Guide](/blog/batch-rename-files-on-mac-complete-guide). For the Windows equivalent workflow, go to [How to Rename Files with AI on Windows](/blog/rename-files-with-ai-windows-guide) or straight to the [AI batch rename tool](/).
