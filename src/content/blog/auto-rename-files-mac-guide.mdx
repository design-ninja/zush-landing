...
There are three serious approaches to this on macOS, each suited to different kinds of rename logic. Automator handles pattern-based rules. Hazel handles condition-based sorting and renaming. [Zush](/) handles content-aware renaming where the filename needs to describe what is actually inside the file.
