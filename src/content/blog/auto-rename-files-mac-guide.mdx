...
Auto renaming is not the same as using a [batch rename tool](/batch-rename-tool). Batch renaming is something you trigger manually on a set of files. Auto renaming happens continuously without your involvement.
