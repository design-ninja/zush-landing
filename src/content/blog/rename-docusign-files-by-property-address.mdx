...
This can live in Downloads, a local transaction workspace, OneDrive, Dropbox, or another synced folder. Zush does not upload files into a transaction platform. Zush can optionally sort files into folders using content-based rules (beta). Review any property grouping before applying it.
...
Zush can optionally sort files into folders with AI (beta). Review property details and destinations before applying a batch. Keep the intake and filing steps separate when your workflow requires it.
