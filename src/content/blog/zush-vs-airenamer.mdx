...
Sources checked for this update: [Zush](/file-renamer), [AI Renamer Desktop](https://airenamer.app/), and the [ai-renamer CLI repository](https://github.com/ozgrozer/ai-renamer), including pricing, local model, file-type, automation, and undo claims.
