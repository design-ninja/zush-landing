...
<BlogProductIntro
  ...
  description="Zush is a Mac and Windows app with batch preview, folder monitoring, rollback history, and RAW, design, iWork, and audio support, at $8/month or $38 one-time."
  links={[
