...
tags:
  - "AI File Renaming"
  - "Tool Comparisons"
tldr: "Pick Zush if you want a finished desktop app — RAW + HEIC, documents, videos, folder monitoring, undo, BYOK — for $10 one-time. Pick AI Renamer's open-source CLI if you are a developer who wants free local-only image/video renaming and is fine with terminal setup and no automation. The AI Renamer Desktop app is a halfway option at $19."
reviewed: "2026-05-05"
featuredOrder: 4
---
...
| Image formats | <BlogHighlight>42 (incl. RAW + HEIC + AVIF)</BlogHighlight> | JPG, PNG, GIF, WEBP | Images + video (with ffmpeg) |
| Document formats | 33 (PDF, DOCX, XLSX, etc.) | PDF, TXT only | Generic files (no doc parsing) |
...
Zush is a complete desktop AI file renamer for Mac and Windows. The differentiators in this comparison are the things AI Renamer (either version) does not do: 98 formats across images, documents, videos, and audio; folder monitoring for automatic ongoing renames; full rename history with one-click undo; and BYOK across 4 providers without paying extra.
...
Zush has the broadest official format support: 98 formats across images, documents, videos, and audio. AI Renamer Desktop lists 4 image formats + PDF/TXT. The CLI handles images + video (with ffmpeg) but does not parse documents.
