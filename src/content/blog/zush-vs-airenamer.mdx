...
Zush is a complete desktop AI file renamer for Mac and Windows. The differentiators in this comparison are the things AI Renamer (either version) does not do: 91 supported formats across images, documents, and videos; folder monitoring for automatic ongoing renames; full rename history with one-click undo; and BYOK across 4 providers without paying extra.
...
The AI Renamer CLI can rename videos by extracting frames with ffmpeg and feeding them to the AI. Zush 2.0 now supports common video formats from the desktop app, using sampled frames and optional sidecar subtitles as context. AI Renamer Desktop does not list video support.
...
Zush has the broadest official format support: 91 formats across images, documents, and videos. AI Renamer Desktop lists 4 image formats + PDF/TXT. The CLI handles images + video (with ffmpeg) but does not parse documents.
