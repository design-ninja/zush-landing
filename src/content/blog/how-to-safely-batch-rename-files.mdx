...
Use preview to prevent the mistake. Use rename history to recover after it. For mixed screenshots, PDFs, photos, documents, design files, audio, and video, start with the [Zush batch rename workflow](/batch-rename-files) on a small representative folder.
