...
People teams comparing the complete workflow can start with [AI file renaming for HR teams](/for-hr). For adjacent workflows, see the guides to [organizing onboarding documents](/blog/organize-employee-onboarding-documents) and [organizing candidate files](/blog/organize-candidate-files-recruiting).
...
The [HR document renaming workflow](/for-hr) reads each file and proposes a filename built from a reusable Template. Custom AI Blocks can describe organization-specific fields such as “the employee ID in format EMP-NNNN,” “the effective date, not the signature date,” or “the review period as YYYY H1 or YYYY H2.”
