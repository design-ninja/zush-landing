...
Quick answer: auto-rename Mac screenshots by setting Zush to monitor your Screenshots folder. Each new screenshot gets a descriptive AI-generated name within seconds — `slack-conversation-project-update.png` instead of `Screenshot 2026-03-23 at 14.32.07.png`.
