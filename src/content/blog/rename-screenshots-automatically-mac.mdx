...
Zush offers 50 free renames, which covers light screenshot use. If you capture screenshots frequently, the Pro plan provides 10,000 renames for a one-time $10 payment. For high-volume workflows, bring your own API key for unlimited renaming.
