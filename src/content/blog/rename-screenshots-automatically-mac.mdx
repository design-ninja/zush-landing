...
Zush offers 50 free renames, which covers light screenshot use. If you capture screenshots frequently, PRO unlocks unlimited renames with either a $8/month plan or a $38 one-time plan. BYOK remains available if you want to use your own AI provider key.
