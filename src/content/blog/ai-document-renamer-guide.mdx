...
That coverage matters because most disorganized document folders contain a mix of these types. A tool that only handles PDFs leaves you doing manual work on everything else, especially when a folder mixes Office and iWork files.
