...
Zush offers 50 free renames, which is enough to test the workflow on a real folder. If document renaming becomes part of your regular routine, PRO unlocks unlimited renames with either a $8/month plan or a $38 one-time plan. For heavy or automated workflows, BYOK remains available if you want to use your own AI provider key.
