...
Zush offers 50 free renames, which is enough to test the workflow on a real folder. If document renaming becomes part of your regular routine, the Pro plan gives you 10,000 renames for a one-time $10 payment. For heavy or automated workflows, bring your own API key for unlimited renaming.
