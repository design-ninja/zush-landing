---
title: "AI Document Renamer: Auto-Name Docs, Ebooks, PDFs & Spreadsheets"
description: "An AI document renamer reads what is inside EPUB, FB2, PDF, DOCX, or XLSX files and names them from that. See how content-aware renaming works on Mac."
date: "2026-03-23"
...
tags:
  ...
  - "File Organization"
  - "PDFs & Documents"
tldr: "An AI document renamer reads the content of EPUB and FB2 ebooks, PDFs, Word docs, and spreadsheets to generate descriptive filenames automatically."
reviewed: "2026-09-02"
---
import BlogProductIntro from '@/components/blog/BlogProductIntro.astro';

Quick answer: an AI document renamer reads the actual content of EPUB and FB2 ebooks, PDFs, DOCX, XLSX, and similar files — titles, authors, invoice numbers, contract parties, headings — and replaces generic names with descriptive, searchable filenames automatically.
...
|---|---|
| EPUB | Ebook stores, public-domain libraries, personal ebook collections |
| FB2 / FB2.ZIP | FictionBook libraries and archived ebook collections |
