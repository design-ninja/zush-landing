...
Quick answer: auto-rename Windows screenshots by pointing Zush at your Pictures/Screenshots folder. New captures get descriptive AI names — content-aware, not timestamp-based — within seconds, with full undo if any rename looks wrong.
