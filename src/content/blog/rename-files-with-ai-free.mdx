...
tags:
  ...
  - "File Organization"
  - "BYOK"
tldr: "Zush FREE includes 50 renames shared across Cloud AI, BYOK, and Offline AI. Open-source local tools can offer unlimited processing, while Zush PRO removes the app's rename limit."
reviewed: "2026-08-04"
---
...
<BlogProductIntro
  ...
  description="Zush includes 50 free renames with no signup across Cloud AI, BYOK, and Offline AI. PRO removes the rename limit."
  links={[
...
The cost per file rename through BYOK is provider-dependent and changes with model, file size, prompt length, and token usage. In practice it can be fractions of a cent per file on efficient models, but confirm current provider pricing before estimating a large batch. For a deeper walkthrough, see [BYOK AI File Renaming with Your Own API Key](/blog/byok-ai-file-renaming-unlimited).
...
5. BYOK renames count toward the shared 50-rename FREE allowance; PRO removes the Zush limit.
...
![Zush BYOK demo showing file renaming with your own AI provider key](/videos/zush-byok.mp4)
