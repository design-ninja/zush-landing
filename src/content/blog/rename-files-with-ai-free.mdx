...
| AI Renamer CLI (local) | $0 | High | Medium | Images/video via local setup | No |
...
AI Renamer works if privacy is your top priority. The CLI is best for developers comfortable with the terminal; the desktop app is easier to use and markets broader format support. For the direct trade-off against Zush, read [Zush vs AI Renamer](/blog/zush-vs-airenamer). If you are choosing between free cloud credits, BYOK, and local models, read [Cloud AI vs Local AI File Renaming](/blog/cloud-vs-local-ai-file-renaming).
