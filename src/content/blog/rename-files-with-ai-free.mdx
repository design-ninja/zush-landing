...
|---|---|---|---|---|---|
| Zush free tier | $0 | Low | High | 98 image + document + video + audio formats | Yes |
| Zush BYOK | API cost only (~$0.001/file) | Medium | High | 98 image + document + video + audio formats | Yes |
