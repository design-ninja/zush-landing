...
|---|---|---|---|---|---|
| Zush free tier | $0 | Low | High | 91 image + document + video formats | Yes |
| Zush BYOK | API cost only (~$0.001/file) | Medium | High | 91 image + document + video formats | Yes |
...
Download [Zush](/) and rename your first batch with the 50-rename free tier. Under two minutes of setup. If the generated names match what you would have typed manually, you already know the tool works for you — and Pro at $10 one-time gives you another 10,000 if you need to scale up.
