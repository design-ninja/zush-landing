...
- **Heavy use (500+ files/month):** Zush PRO unlocks unlimited renames with a $8/month plan or a $38 one-time plan. BYOK is optional when you want provider control.
