...
Renaming is the preparation step. The organization still decides where each approved record is imported or stored, who can access it, how long it is retained, and when it is deleted. Zush does not enforce those rules. Zush offers optional AI folder sorting (beta); leave it off and keep the original destination when documents must stay in place.
