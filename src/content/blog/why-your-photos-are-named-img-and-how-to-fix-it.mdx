...
[Zush AI file renamer](/) fits this well because it is built around image-heavy Mac workflows rather than generic rename rules. It can rename, tag, and make those files easier to find later with Spotlight.
