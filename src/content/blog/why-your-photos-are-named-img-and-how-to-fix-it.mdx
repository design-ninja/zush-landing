---
title: "Why Photos Get Generic Names and How to Rename Them"
description: "Learn why iPhone and camera photos use generic filenames and how to rename them into searchable Mac filenames with AI, without sorting one by one."
date: "2026-02-22"
...
Quick answer: photos are named `IMG_` because iPhones and cameras use simple sequence numbers. To fix them on Mac, rename small sets manually, use Finder for date/event patterns, or use AI for descriptive names based on image content.
