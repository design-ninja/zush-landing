...
That works across 98 supported image, document, video, and audio formats, which covers the files most Mac users encounter daily: PNG screenshots, HEIC and RAW photos, downloaded JPEGs, PDFs, Word documents, spreadsheets, presentations, subtitle files, MP4/MOV screen recordings, M2TS camera clips, MP3 voice memos, WAV exports, and more. In Zush 3.0, monitoring can also use templates and Naming Blocks for folders that need repeatable naming rules.
