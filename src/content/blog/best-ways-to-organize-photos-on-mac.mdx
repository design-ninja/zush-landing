...
[Zush](https://zushapp.com) can rename photos based on visible content, apply date-based patterns, and add Finder tags automatically. It supports 42 image formats including HEIC, AVIF, RAW (CR2, NEF, ARW, DNG), JPEG, PNG, PSD, SVG, TIFF, and WebP.
