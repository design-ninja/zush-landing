...
description: "Learn how an AI photo renamer turns generic camera and phone filenames into descriptive names like sunset-pacific-beach.heic. Supports HEIC, AVIF, JPG, PSD, SVG, and RAW formats."
date: "2026-03-23"
...
[Zush](https://zushapp.com/rename-photos-with-ai) does this on Mac across 42 image formats, including RAW, HEIC, AVIF, PSD, SVG, and WebP, with batch renaming and custom naming patterns.
...
[Zush](https://zushapp.com/rename-photos-with-ai) supports 42 image formats:

| Category | Formats |
|---|---|
| Standard | PNG, JPG/JPEG/JPE, WebP, AVIF, GIF, BMP/DIB, TIFF/TIF, HEIC/HEIF/HEICS, SVG, PDF, JP2/JPF/JPX/J2K/J2C, PSD, EXR, TGA, ICO, ICNS, PBM, PGM, PPM, PFM |
