...
[Zush](https://zushapp.com/rename-photos-with-ai) does this on Mac across 41 image formats, including RAW, HEIC, AVIF, SVG, TIFF, and WebP, with batch renaming and custom naming patterns. PSD is supported separately in Zush's design file workflow.
...
[Zush](https://zushapp.com/rename-photos-with-ai) supports 41 image formats:
