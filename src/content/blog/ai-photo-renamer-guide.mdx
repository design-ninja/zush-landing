---
title: "AI Photo Renamer for Mac: Auto-Name HEIC, RAW, and JPG"
description: "How an AI photo renamer turns IMG_4382.HEIC into a name that says what the shot contains, across HEIC, AVIF, JPG, TIFF, and RAW, with preview and undo."
date: "2026-03-23"
...
tags:
  ...
  - "Photos"
  - "File Naming"
tldr: "An AI photo renamer reads the visual content of HEIC, RAW, and JPG images and produces descriptive filenames. This guide covers when AI renaming makes sense, supported formats, and Mac workflow tips."
reviewed: "2026-08-08"
---
import BlogProductIntro from '@/components/blog/BlogProductIntro.astro';

Quick answer: an AI photo renamer reads the visual content of HEIC, RAW, and JPG images and replaces generic names like `IMG_4382.HEIC` with descriptive ones like `golden-gate-bridge-fog-morning.heic`. Setup is minutes and the cleanup runs in batch.
...
This guide explains how AI photo renaming works on Mac. Photographers and videographers comparing a complete studio workflow across RAW photos, JPEGs, and clips should start with [Zush for photographers and videographers](/for-photographers). For the generic photo product on Mac, use [AI Photo Renamer for Mac](/rename-photos-with-ai).

[The AI photo renamer](https://zushapp.com/rename-photos-with-ai) does this on Mac across 41 image formats, including RAW, HEIC, AVIF, SVG, TIFF, and WebP, with batch renaming and custom naming patterns. PSD is supported separately in Zush's design file workflow.

For app-level trade-offs, compare [Mac AI renamer comparison](/blog/best-ai-file-renamer-tools-mac-compared). If you also need albums, face search, culling, or editing, see the broader comparison of [photo organizing software for Mac](/blog/best-photo-organizing-software-mac). For large photo libraries, read [BYOK](/blog/byok-ai-file-renaming-unlimited) and [Cloud AI vs Local AI File Renaming](/blog/cloud-vs-local-ai-file-renaming).


<BlogProductIntro
  title="Still looking at IMG_4382.HEIC in every folder?"
  description="Zush renames HEIC, RAW, JPG, and AVIF photos from what is visible in the frame, with reusable naming patterns, Finder metadata, and rollback."
  links={[
    { href: '/for-photographers', label: 'Zush for photographers' },
...
[The AI photo renamer](https://zushapp.com/rename-photos-with-ai) supports 41 image formats:

| Category | Formats |
|---|---|
| Standard | PNG, JPG/JPEG/JPE, WebP, AVIF, GIF, BMP/DIB, TIFF/TIF, HEIC/HEIF/HEICS, SVG, PDF, JP2/JPF/JPX/J2K/J2C, EXR, TGA, ICO, ICNS, PBM, PGM, PPM, PFM |
| RAW | CR2, CR3 (Canon), NEF (Nikon), ARW/SR2/SRW (Sony/Samsung), DNG (Adobe), ORF (Olympus), RAF (Fujifilm), RW2 (Panasonic), PEF (Pentax), RAW |
...
![Batch renaming photos with AI to replace generic IMG filenames](/images/showcase/macos/batch-rename-light.webp)
...
Drag the folder into [the AI photo renamer](https://zushapp.com/rename-photos-with-ai) or browse to it. The app detects all supported image formats and displays them for review.
...
For more on photo organization on Mac, see [Best Ways to Organize Photos on Mac](/blog/best-ways-to-organize-photos-on-mac).
...
- **Free tier**: 50 free renames for light use and testing
- **Pro**: Unlimited PRO renames with a $10/month plan or a $48 one-time plan
- **BYOK**: Bring your own API key when you want provider control on ongoing workflows

For photographers dealing with regular imports of hundreds or thousands of images, PRO removes the Zush rename limit, and BYOK is useful when you want to route analysis through your own provider account.
...
The fastest way to stop using `IMG_` filenames is to start with one folder. Pick the photo import directory or project folder that has been bothering you, open it in [the AI photo renamer](https://zushapp.com/rename-photos-with-ai), and run a batch rename. Once you see 200 photos go from anonymous numbers to descriptive titles, the workflow sells itself.
