...
**Pricing:** Free (50 renames/month), Pro <BlogHighlight>$10 one-time</BlogHighlight> for 10,000 renames, BYOK unlimited at API cost, Local Ollama on supported Mac builds
...
**Platform:** macOS only
**Pricing:** Managed $5/month (or $5/year with annual discount, credit-based 500–10,000/mo); Self-Managed $38 one-time + your own API key (BYOK); 7-day free trial with 50 renames
**Website:** [namequick.app](https://www.namequick.app/)
...
**Platform:** Web app + cloud integrations (Google Drive, Dropbox, Box, OneDrive); REST API + CLI + file watcher daemon; Zapier, Make, n8n
**Pricing:** Free 50/month; pay-as-you-go credit packs ($9/1,000 = $0.009 each, $49/10,000 = $0.0049 each); 12-month credit validity; 30-day money-back
**Website:** [renamed.to](https://www.renamed.to/)
