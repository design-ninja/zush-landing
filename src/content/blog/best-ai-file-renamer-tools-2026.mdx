...
[Zush AI file renamer for Mac and Windows](/) is the pick for users who work with a mix of file types and want one desktop workflow instead of separate rename tools for images, documents, videos, and audio. It supports 98 formats: 42 image formats (including HEIC, AVIF, PSD, SVG, and RAW), 33 document formats (PDF, Office, OpenDocument, text, data, email, and subtitle files), 16 video formats (including MP4, MOV, M4V, MPEG, 3GP, TS, MTS, M2TS, DV, and VOB), and 7 audio formats (including MP3, M4A, WAV, FLAC, OGG, WebM, and MPGA). That breadth matters because real workflows mix phone photos, camera RAW files, scanned PDFs, office documents, subtitles, screen recordings, and audio files in the same folders, and most tools in this post fail on at least one of those categories.
...
- Content-aware naming across images, documents, videos, and audio
...
| Image formats | 42 (incl. RAW) | ~4 (Desktop) | ~15 | OCR + EXIF, broad | Various | Various | Scanned images | Various |
| Document formats | 33 | ~2 (Desktop) | ~10 | 30+ formats | Various | Some | PDF/DOCX/XLSX/PPTX | Limited |
...
**If you want the lowest total cost on Mac or Windows:** <BlogHighlight>Zush One-Time at $38</BlogHighlight>. Full RAW support (CR2, NEF, ARW, DNG), 33 document formats, 16 video formats, folder monitoring, rollback, and unlimited PRO renames.
