...
description: "Naming photos for social media so you can find and reuse them later: what belongs in the filename, what does not, and how to apply it across a whole shoot."
date: "2026-02-17"
...
Quick answer: rename photos for social media with descriptive, kebab-case filenames that include subject, location, and post-relevant keywords — e.g., `paris-louvre-pyramid-night-shot.jpg`. Skip random IMG_ codes; descriptive names help your own retrieval and SEO when published.
