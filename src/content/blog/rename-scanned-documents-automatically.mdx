...
For profession-specific patterns — invoice numbers for bookkeeping, matter numbers for legal work, HIPAA-safe identifiers for medical records — see the [file naming conventions guide](/blog/file-naming-conventions-best-practices).
