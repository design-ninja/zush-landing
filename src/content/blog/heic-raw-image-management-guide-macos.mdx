...
description: "HEIC and RAW on macOS: which apps open them, how much space they cost, when to convert, and how to name them so Finder search finds the right shot."
date: "2026-03-03"
...
Quick answer: store HEIC and RAW in date-based folders, rename them with content-aware names ([Zush](/mac) supports both formats), and keep EXIF metadata intact for searchability. Convert HEIC to JPG only when sharing outside the Apple ecosystem.
...
If retrieval is the hard part, pair this format workflow with [AI Photo Renamer for Mac](/blog/how-to-rename-images-with-ai-on-macos), [How to Organize Photos on Mac](/blog/best-ways-to-organize-photos-on-mac), and the comparison of [photo organizing software for Mac](/blog/best-photo-organizing-software-mac).

<BlogProductIntro
  title="RAW and HEIC files still on camera-default names?"
  description="Zush reads CR2, NEF, ARW, DNG, and HEIC images and names them by what they show, keeping RAW and JPEG pairs consistent across a shoot."
  links={[
...
This structure makes it obvious where each file type lives and prevents accidental deletion of originals when cleaning up exports. Collapsing originals and exports into one folder is one of the [10 digital photo organization mistakes to avoid](/blog/digital-photo-organization-mistakes-to-avoid), and it is the hardest to reverse once a cleanup pass has run.
