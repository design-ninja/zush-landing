...
const defaultCopy: WhyZushCopy = {
  ...
  formatsDescription: 'Supports AVIF, RAW, Sketch, Figma, Illustrator, PSD, Office, iWork, PDFs, subtitles, MP3, M4A, WAV, FLAC, and common video formats, so mixed folders can be renamed by actual content instead of file-type silos.',
