...
const defaultRows: ComparisonRow[] = [
  { tool: 'Zush', platform: 'Mac & Windows', freeTier: '50', batchRename: true, autoMonitor: true, pricing: '$10 one-time / 10,000 renames', imageFormats: '22 formats', rawSupport: true, documentFormats: 'PDF, DOCX, XLSX, PPTX, +', pdfExtraction: true, screenshotDetect: true, exifPreserve: true },
