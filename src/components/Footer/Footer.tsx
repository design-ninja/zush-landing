    ...
    <footer className={styles.Footer}>
      <div className={styles.Footer__Container}>
        <div className={styles.Footer__Grid}>
          ...
          <div>
            ...
            <ul className={styles.Footer__Links}>
              ...
              <li><a href="https://github.com/design-ninja/zush/releases" className={styles.Footer__Link}>Releases</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className={styles.Footer__Bottom}>
          <p>© 2026 Zush App. All rights reserved.</p>
          <div className={styles.Footer__BottomLinks}>
            <a href="mailto:zush@lirik.pro">Contact Support</a>
          </div>
        </div>
      </div>
    </footer>
