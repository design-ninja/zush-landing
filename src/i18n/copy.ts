...
const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    heroSubtitle:
      'Blazing fast AI file renamer for Mac and Windows. Auto-rename screenshots, photos, videos, PDFs, and documents with meaningful names — folder watching, BYOK, and offline AI built in.',
    buyPro: 'Buy 🌟 PRO',
    ...
    videos: {
      ...
      switchTo: 'Switch to',
      items: {
        'batch-rename': { title: 'Batch Rename', description: 'Batch rename files with AI based on their actual content' },
        monitor: { title: 'Folder Monitoring', description: 'Automatically rename selected file types as they appear' },
  ...
  platforms: {
    mac: {
      ...
      softwareDescription:
        'AI-powered file renamer for macOS. Rename screenshots, videos, PDFs, photos and documents with cloud AI or Offline AI mode via Ollama.',
    ...
    windows: {
      ...
      softwareDescription:
        'AI-powered file renamer for Windows. Rename screenshots, videos, PDFs, photos and documents with descriptive names.',
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  hi: {
    ...
    videos: {
      ...
      titleAccent: 'Zush',
      description: 'देखें Zush real file organization workflow को key features के साथ कैसे handle करता है',
      playDemo: 'Demo play करें',
      switchTo: 'Switch करें:',
      items: {
        'batch-rename': { title: 'Batch rename', description: 'Actual content के आधार पर AI से files batch rename करें' },
        monitor: { title: 'Folder monitoring', description: 'नई files आते ही automatically rename करें' },
        ...
        'offline-ai': { title: 'Offline AI mode', description: 'Ollama के private local models से supported files offline process करें' },
        activity: { title: 'Activity history', description: 'Recent renames देखें और जरूरत पड़ने पर undo करें' },
      },
    },
    whyZush: {
      title: 'Zush real desktop work में क्यों fit बैठता है',
      titlePlatform: '{os} पर Zush क्यों win करता है',
      description: 'One-time price, native desktop feel, fast rename और less decision fatigue',
      ...
      formatsEyebrow: '91 supported formats',
      formatsTitle: 'Images, documents और videos',
      formatsDescription: '42 image, 33 document और 16 video formats support करता है, ताकि mixed folders को real content के basis पर names मिलें।',
      controlEyebrow: 'Low-risk automation',
      controlTitle: 'Batch, monitor और undo',
      controlDescription: 'Old batches clean करें, new folders readable रखें और जरूरत हो तो history से undo करें।',
      workflowSteps: ['Old batches clean करें', 'New folders monitor करें', 'History से undo करें'],
    },
    useCases: {
      items: [
  ...
  ar: {
    ...
    videos: {
      ...
      items: {
        'batch-rename': { title: 'إعادة تسمية دفعة واحدة', description: 'أعد تسمية الملفات دفعة واحدة بالذكاء الاصطناعي بناء على محتواها الفعلي' },
    ...
    whyZush: {
      ...
      formatsTitle: 'صور ومستندات وفيديوهات',
      formatsDescription: 'يدعم 42 صيغة صور و33 صيغة مستندات و16 صيغة فيديو، حتى يمكن تسمية المجلدات المختلطة حسب محتواها الحقيقي.',
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  de: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Schneller KI-Dateiumbenenner für Mac und Windows. Benenne Screenshots, Videos, PDFs, Fotos und Dokumente automatisch sinnvoll um — kostenlos testen.',
      buyPro: 'PRO kaufen 🌟',
    ...
    seo: {
      '/': { title: 'Zush — KI-Dateiumbenenner für Mac & Windows', description: 'Benenne Screenshots, Videos, PDFs, Fotos und Dokumente auf Mac und Windows automatisch mit KI um. Kostenlos testen, keine Anmeldung.' },
    },
  ...
  fr: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Un renommeur de fichiers IA rapide pour Mac et Windows. Renommez screenshots, vidéos, PDF, photos et documents avec des noms utiles — essai gratuit.',
      buyPro: 'Acheter PRO 🌟',
    ...
    seo: { '/': { title: 'Zush — Renommeur de fichiers IA pour Mac & Windows', description: 'Renommez automatiquement screenshots, vidéos, PDF, photos et documents sur Mac et Windows avec l’IA. Essai gratuit.' } },
  ...
  'pt-br': localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renomeador de arquivos com IA para Mac e Windows. Renomeie screenshots, vídeos, PDFs, fotos e documentos com nomes úteis — teste grátis.',
      buyPro: 'Comprar PRO 🌟',
    ...
    seo: { '/': { title: 'Zush — Renomeador de arquivos com IA para Mac & Windows', description: 'Renomeie screenshots, vídeos, PDFs, fotos e documentos no Mac e Windows usando IA. Teste grátis, sem cadastro.' } },
  ...
  es: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renombrador de archivos con IA para Mac y Windows. Renombra capturas, videos, PDFs, fotos y documentos con nombres útiles — prueba gratis.',
      buyPro: 'Comprar PRO 🌟',
    ...
    seo: { '/': { title: 'Zush — Renombrador de archivos con IA para Mac & Windows', description: 'Renombra capturas, videos, PDFs, fotos y documentos en Mac y Windows usando IA. Prueba gratis, sin registro.' } },
  ...
  nl: localized({
    ...
    home: {
      ...
      heroAccent: 'Automatisch.',
      heroSubtitle: 'Snelle AI-bestandshernoemer voor Mac en Windows. Hernoem screenshots, video’s, PDFs, foto’s en documenten met betekenisvolle namen — gratis proberen.',
      buyPro: 'Koop PRO 🌟',
    ...
    seo: { '/': { title: 'Zush — AI-bestandshernoemer voor Mac & Windows', description: 'Hernoem screenshots, video’s, PDFs, foto’s en documenten op Mac en Windows met AI. Gratis proberen.' } },
  ...
  it: localized({
    ...
    home: {
      ...
      heroAccent: 'Automaticamente.',
      heroSubtitle: 'Rinomina file con IA per Mac e Windows. Rinomina screenshot, video, PDF, foto e documenti con nomi utili — prova gratis.',
      buyPro: 'Acquista PRO 🌟',
    ...
    seo: { '/': { title: 'Zush — Rinomina file con IA per Mac e Windows', description: 'Rinomina screenshot, video, PDF, foto e documenti su Mac e Windows con l’IA. Prova gratis.' } },
  ...
  ja: localized({
    ...
    home: {
      ...
      heroAccent: '自動で。',
      heroSubtitle: 'Mac と Windows 向けの高速 AI ファイルリネーム。スクリーンショット、動画、PDF、写真、文書を意味のある名前に自動変更します。',
      buyPro: 'PROを購入 🌟',
    ...
    seo: { '/': { title: 'Zush — Mac と Windows 向け AI ファイルリネーム', description: 'スクリーンショット、動画、PDF、写真、文書を AI で自動リネーム。無料で試せます。' } },
  ...
  ko: localized({
    ...
    home: {
      ...
      heroAccent: '자동으로.',
      heroSubtitle: 'Mac과 Windows를 위한 빠른 AI 파일 이름 변경 도구. 스크린샷, 비디오, PDF, 사진, 문서를 의미 있는 이름으로 자동 변경합니다.',
      buyPro: 'PRO 구매 🌟',
    ...
    seo: { '/': { title: 'Zush — Mac 및 Windows용 AI 파일 이름 변경', description: '스크린샷, 비디오, PDF, 사진, 문서를 AI로 자동 이름 변경하세요. 무료 체험 가능.' } },
  ...
  'zh-cn': localized({
    ...
    home: {
      ...
      heroAccent: '自动完成。',
      heroSubtitle: '适用于 Mac 和 Windows 的高速 AI 文件重命名工具。自动为截图、视频、PDF、照片和文档生成有意义的名称。',
      buyPro: '购买 PRO 🌟',
    ...
    platforms: {
      mac: {
        breadcrumbLabel: 'Zush for Mac',
        softwareName: 'Zush for Mac',
      softwareDescription: '适用于 macOS 的 AI 文件重命名工具。可用云端 AI 或通过 Ollama 使用离线 AI 模式来重命名截图、视频、PDF、照片和文档。',
        heroTitle: '适用于 Mac 的 AI 文件重命名工具',
        heroSubtitle: '在 macOS 上用 AI 重命名截图、视频、PDF、照片和文档。支持快速云端模型，也支持通过 Ollama 使用私有本地模型。',
        ctaTitle: '在 Mac 上免费试用 Zush',
        ctaSubtitle: '安装已签名的 macOS 应用，几分钟内开始整理截图、视频、PDF、照片和文档。',
        faqDescription: '关于 Zush for Mac 和产品功能的常见问题。',
        features: [
          '用 AI 重命名截图、视频、PDF、照片和文档',
          '文件夹监控，自动处理新文件',
          '批量重命名并支持逐个重新生成',
          '自定义文件名和元数据标签提示词',
          '从 Activity 记录一键恢复',
      ...
      windows: {
        breadcrumbLabel: 'Zush for Windows',
        softwareName: 'Zush for Windows',
        softwareDescription: '适用于 Windows 的 AI 文件重命名工具。为截图、视频、PDF、照片和文档生成清晰、有意义的文件名。',
        heroTitle: '适用于 Windows 的 AI 文件重命名工具',
        heroSubtitle: '在 Windows 上用 AI 重命名截图、视频、PDF、照片和文档。通过 Microsoft Store 安装，自动更新，可免费试用且无需注册。',
    ...
    seo: {
      '/': { title: 'Zush — 适用于 Mac 和 Windows 的 AI 文件重命名工具', description: '用 AI 自动重命名截图、视频、PDF、照片和文档。可免费试用。' },
      '/mac': { title: 'Zush for Mac — macOS AI 文件重命名工具', description: '在 Mac 上用 AI 重命名截图、视频、PDF、照片和文档。支持 Apple Silicon、Intel、BYOK 和 Ollama 离线 AI。' },
      '/windows': { title: 'Zush for Windows — Windows AI 文件重命名工具', description: '在 Windows 上用 AI 重命名截图、视频、PDF、照片和文档。通过 Microsoft Store 安装，可免费试用。' },
    },
  ...
  hi: localized({
    ...
    footer: {
      description: 'Mac और Windows के लिए AI file renamer — files को automatically rename करें',
      product: 'Product',
    ...
    home: {
      heroTitle: 'Files को AI से rename करें। Automatically.',
      heroAccent: 'Automatically.',
      heroSubtitle: 'Mac और Windows के लिए fast AI file renamer। Screenshots, videos, PDFs, photos और documents को useful names दें — folder monitoring, BYOK और Offline AI included।',
      buyPro: 'PRO खरीदें 🌟',
      trustSignals: ['✨ Free try करें', '💳 Credit card नहीं चाहिए', '🚫 No subscription'],
      featuresTitle: 'Zush AI आपकी files कैसे rename करता है',
      featuresDescription: 'Simple, clean interface में powerful features',
      supportedFormats: 'Supported file formats',
      images: 'Images',
      documents: 'Documents',
      videosLabel: 'Videos',
      downloadTitle: 'Zush free try करें',
      downloadSubtitle: 'Custom prompts, folder monitoring और one-click undo के साथ AI file renaming।',
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'macOS के लिए AI file renamer। Screenshots, videos, PDFs, photos और documents को cloud AI या Ollama के Offline AI mode से rename करें।',
        heroTitle: 'Mac के लिए AI file renamer',
        heroSubtitle:
          'macOS पर screenshots, videos, PDFs, photos और documents को AI से rename करें। Fast cloud models या Ollama के private local models वाला Offline AI mode use करें।',
        ctaTitle: 'Mac पर Zush free try करें',
        ctaSubtitle: 'Signed macOS app install करें और कुछ minutes में screenshots, videos, PDFs, photos और documents rename करना शुरू करें।',
        faqDescription: 'Mac के लिए Zush और बाकी product के बारे में जरूरी details।',
        features: [
          'Screenshots, videos, PDFs, photos और documents के लिए AI rename',
      ...
      windows: {
        ...
        softwareDescription:
          'Windows के लिए AI file renamer। Screenshots, videos, PDFs, photos और documents को clear names दें।',
        heroTitle: 'Windows के लिए AI file renamer',
        heroSubtitle:
          'Windows पर screenshots, videos, PDFs, photos और documents को AI से rename करें। Microsoft Store से install होता है, auto-updates मिलते हैं, free try कर सकते हैं और signup की जरूरत नहीं।',
    ...
    seo: {
      '/': {
        title: 'Zush — Mac और Windows पर AI file renamer',
        description: 'Screenshots, videos, PDFs, photos और documents को seconds में rename करें। Mac और Windows पर batch rename या folders watch करें। Free try करें।',
      },
      '/mac': {
        title: 'Mac के लिए Zush — macOS AI file renamer',
        description: 'Mac पर screenshots, videos, PDFs, photos और documents को AI से rename करें। Apple Silicon, Intel, BYOK और Ollama Offline AI support।',
      },
      '/windows': {
        title: 'Windows के लिए Zush — AI file renamer',
        description: 'Windows पर screenshots, videos, PDFs, photos और documents को AI से rename करें। Microsoft Store install, auto-updates और free trial।',
      },
    },
  ...
  ar: localized({
    ...
    home: {
      ...
      heroAccent: 'تلقائيا.',
      heroSubtitle: 'أداة سريعة لإعادة تسمية الملفات بالذكاء الاصطناعي على Mac وWindows. أعد تسمية لقطات الشاشة والفيديو وPDF والصور والمستندات بأسماء مفهومة — مع تجربة مجانية.',
      buyPro: 'شراء PRO 🌟',
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'أداة إعادة تسمية ملفات بالذكاء الاصطناعي لنظام macOS. أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات عبر الذكاء الاصطناعي السحابي أو وضع الذكاء الاصطناعي دون اتصال عبر Ollama.',
        heroTitle: 'أداة إعادة تسمية الملفات بالذكاء الاصطناعي لنظام Mac',
        heroSubtitle:
          'أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات على macOS بالذكاء الاصطناعي. استخدم نماذج سحابية سريعة أو وضع الذكاء الاصطناعي دون اتصال مع نماذج محلية خاصة عبر Ollama.',
        ctaTitle: 'جرّب Zush مجانا على Mac',
        ctaSubtitle: 'ثبّت تطبيق macOS الموقّع وابدأ إعادة تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات خلال دقائق.',
        faqDescription: 'كل ما تحتاج إلى معرفته عن Zush لنظام Mac وبقية المنتج.',
        features: [
          'إعادة تسمية بالذكاء الاصطناعي للقطات الشاشة والفيديو وملفات PDF والصور والمستندات',
      ...
      windows: {
        ...
        softwareDescription:
          'أداة إعادة تسمية ملفات بالذكاء الاصطناعي لنظام Windows. أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات بأسماء وصفية.',
        heroTitle: 'أداة إعادة تسمية الملفات بالذكاء الاصطناعي لنظام Windows',
        heroSubtitle:
          'أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات على Windows بالذكاء الاصطناعي. يثبّت من Microsoft Store مع تحديثات تلقائية وتجربة مجانية دون تسجيل.',
    ...
    seo: {
      '/': {
        ...
        description: 'أعد تسمية لقطات الشاشة والفيديو وPDF والصور والمستندات خلال ثوان. أعد التسمية دفعة واحدة أو راقب المجلدات على Mac وWindows. تجربة مجانية.',
      },
      '/mac': {
        title: 'Zush لنظام Mac — أداة إعادة تسمية ملفات بالذكاء الاصطناعي',
        description: 'أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات على Mac بالذكاء الاصطناعي. يدعم Apple Silicon وIntel وBYOK ووضع Ollama دون اتصال.',
      },
      '/windows': {
        title: 'Zush لنظام Windows — أداة إعادة تسمية ملفات بالذكاء الاصطناعي',
        description: 'أعد تسمية لقطات الشاشة والفيديو وملفات PDF والصور والمستندات على Windows بالذكاء الاصطناعي. تثبيت من Microsoft Store وتحديثات تلقائية وتجربة مجانية.',
      },
    },
