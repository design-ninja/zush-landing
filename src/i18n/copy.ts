...
export interface DownloadMenuCopy {
  ...
  windowsHint: string;
  windowsTrialHint: string;
  windowsWebFallback: string;
...
export interface FeatureCardsCopy {
  ...
  customAiBlocks: { title: string; description: string };
...
export const DEFAULT_FEATURE_CARDS_COPY: FeatureCardsCopy = {
  aiAnalysis: {
    ...
    description: 'Analyze and rename 100+ file formats in one batch, from images, EPUB and FB2 ebooks, and PDFs to audio, video, and Office files.',
  },
  foldersMonitoring: {
  ...
  byok: {
    ...
    description: 'Connect your own API key from Gemini, OpenRouter, OpenAI, or Claude for cloud renames; FREE includes 50 across all modes and PRO is unlimited. Keys are stored locally in secure platform storage.',
  },
  offlineAi: {
    title: 'Private Local AI Options',
    description: 'Keep supported analysis on your device with LM Studio or Ollama. Each local mode works offline after setup.',
  },
  cloudAi: {
    title: 'Cloud AI',
  ...
  bandSubtitle: 'Choose Zush Cloud, BYOK, LM Studio or Ollama for the same review-first rename workflow.',
...
export interface HomeCopy {
  ...
  offlineAiModal: OfflineAiModalCopy;
...
const localizedFileExamples: Record<Exclude<Locale, 'en'>, { featureCards: Partial<FeatureCardsCopy>; showcaseSlides: Slide[] }> = {
  ...
  tr: {
    featureCards: {
      ...
      batchNewNames: ['kanban_panosi_arayuzu.png', 'ise_alim_plani_notlari.docx', 'yatirimci_guncelleme_sunumu.pptx'],
      metadataFileName: 'siberpunk_sanati.png',
      metadataTags: ['glitch sanatı', 'vaporwave', 'heykel', 'siberpunk', 'dijital sanat', 'palmiye'],
      historyNewNames: ['pano_inceleme_notlari.docx', 'q1_gelir_raporu.xlsx'],
      promptExample: 'Adları kısa tutun, konuyu başa alın ve eşleşen Finder etiketlerini ekleyin.',
    },
    showcaseSlides: homeShowcaseSlides([
      'sari_sapkali_pug.jpg',
      'q1_planlama_notlari.docx',
      'urun_lansman_butcesi.xlsx',
      'yatirimci_guncelleme_sunumu.pptx',
      'musteri_yaratici_brifi.pdf',
      'ayarlar_kenar_cubugu_tanitimi.mov',
      'ise_alim_plani_notlari.docx',
      'gelir_tahmini.xlsx',
      'satis_baslangic_sunumu.pptx',
      'plajdaki_mutlu_kopek.jpg',
      'web_sitesi_teklifi.pdf',
      'odeme_akisi_hata_kaydi.mov',
      'tedarikci_sozlesmesi_notlari.docx',
      'mart_satis_hatti.xlsx',
      'kampanya_inceleme_sunumu.pptx',
      'imzali_hizmet_sozlesmesi.pdf',
      'parlak_sari_cicekler.jpg',
      'fabrika_turu_kurgusu.m2ts',
    ], ['lofi_piyano_dongusu_92bpm.mp3', 'musteri_kesif_gorusmesi.m4a', 'podcast_giris_roportaji.wav']),
  },
  ar: {
    featureCards: {
...
const localizedFullHomeFaqItems: Partial<Record<Exclude<Locale, 'en'>, FAQCopyItem[]>> = {
  de: [
    ...
    { question: 'Wie funktioniert der Preis?', answer: `Zush PRO hat zwei Pläne: Monthly für ${PRO_PRICING.monthly.usd} $/Monat oder One-Time für ${PRO_PRICING.oneTime.usd} $. BYOK und Offline-KI sind bereits in FREE verfügbar; beide PRO-Pläne entfernen das gemeinsame Limit von 50 Umbenennungen.` },
    { question: 'Was ist BYOK (Bring Your Own Key)?', answer: 'BYOK erlaubt Nutzern aller Pläne, eigene API-Schlüssel von Gemini, OpenRouter, OpenAI oder Claude zu verbinden. FREE umfasst 50 Umbenennungen in allen Modi; PRO entfernt das Limit. Der Schlüssel wird lokal sicher gespeichert.' },
    { question: 'Gibt es einen Einmalkauf?', answer: `Ja. Neben dem Monatsplan gibt es einen Einmalkauf für ${PRO_PRICING.oneTime.usd} USD. BYOK und Offline-KI sind bereits in FREE verfügbar; beide Pläne entfernen das gemeinsame Limit von 50 Umbenennungen.` },
    { question: 'Welche Betriebssysteme werden unterstützt?', answer: 'Zush läuft auf macOS 15 Sequoia und neuer sowie Windows 10 / 11. Mac gibt es als signierte dmg, im Mac App Store und über Homebrew, Windows im Microsoft Store.' },
    ...
    { question: 'Funktioniert die App offline?', answer: 'Cloud-Verarbeitung benötigt Internet. Nutzer aller Pläne können nach Installation von Ollama und einem kompatiblen Modell Offline-KI aktivieren.' },
  ...
  fr: [
    ...
    { question: 'Comment fonctionne le prix ?', answer: `Zush PRO propose deux offres : Monthly à ${PRO_PRICING.monthly.usd} $/mois ou One-Time à ${PRO_PRICING.oneTime.usd} $. BYOK et l’IA hors ligne sont déjà disponibles avec FREE; les deux offres PRO suppriment la limite partagée de 50 renommages.` },
    { question: 'Qu’est-ce que BYOK (Bring Your Own Key) ?', answer: 'BYOK permet aux utilisateurs de toutes les offres de connecter leur clé Gemini, OpenRouter, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité. La clé est stockée localement de façon sécurisée.' },
    { question: 'Existe-t-il un achat unique ?', answer: `Oui. En plus du plan mensuel, vous pouvez choisir l’achat unique à ${PRO_PRICING.oneTime.usd} USD. BYOK et l’IA hors ligne sont déjà disponibles avec FREE; les deux offres suppriment la limite partagée de 50 renommages.` },
    { question: 'Quels systèmes d’exploitation sont pris en charge ?', answer: 'Zush fonctionne sur macOS 15 Sequoia et versions récentes, ainsi que Windows 10 / 11. Mac est disponible en dmg signé, sur le Mac App Store et via Homebrew, Windows via Microsoft Store.' },
    ...
    { question: 'L’app fonctionne-t-elle hors ligne ?', answer: 'Le cloud nécessite internet. Les utilisateurs de toutes les offres peuvent activer l’IA hors ligne après installation d’Ollama et d’un modèle compatible.' },
  ...
  'pt-br': [
    ...
    { question: 'Como funciona o preço?', answer: `Zush PRO tem dois planos: Monthly por US$ ${PRO_PRICING.monthly.usd}/mês ou One-Time por US$ ${PRO_PRICING.oneTime.usd}. BYOK e IA offline já estão disponíveis no FREE; ambos os planos PRO removem o limite compartilhado de 50 renomeações.` },
    { question: 'O que é BYOK (Bring Your Own Key)?', answer: 'BYOK permite conectar sua própria chave Gemini, OpenRouter, OpenAI ou Claude para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado. A chave fica armazenada localmente com segurança.' },
    ...
    { question: 'Quais sistemas operacionais são suportados?', answer: 'Zush funciona no macOS 15 Sequoia ou mais recente e no Windows 10 / 11. Mac tem dmg assinado, Mac App Store e Homebrew; Windows vem pela Microsoft Store.' },
    ...
    { question: 'O app funciona offline?', answer: 'O modo cloud requer internet. Usuários de todos os planos podem ativar IA offline depois de instalar Ollama e um modelo compatível.' },
  ...
  es: [
    ...
    { question: '¿Cómo funciona el precio?', answer: `Zush PRO tiene dos planes: Monthly por ${PRO_PRICING.monthly.usd} US$/mes o One-Time por ${PRO_PRICING.oneTime.usd} US$. BYOK e IA offline ya están disponibles en FREE; ambos planes PRO eliminan el límite compartido de 50 renombrados.` },
    { question: '¿Qué es BYOK (Bring Your Own Key)?', answer: 'BYOK permite conectar tu propia clave de Gemini, OpenRouter, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado. La clave se guarda localmente de forma segura.' },
    ...
    { question: '¿Qué sistemas operativos son compatibles?', answer: 'Zush funciona en macOS 15 Sequoia o posterior y Windows 10 / 11. Mac tiene dmg firmado, Mac App Store y Homebrew; Windows está en Microsoft Store.' },
    ...
    { question: '¿La app funciona sin conexión?', answer: 'El modo cloud requiere internet. Los usuarios de todos los planes pueden activar IA offline tras instalar Ollama y un modelo compatible.' },
  ...
  nl: [
    ...
    { question: 'Hoe werkt de prijs?', answer: `Zush PRO heeft twee plannen: Monthly voor ${PRO_PRICING.monthly.label}/maand of One-Time voor ${PRO_PRICING.oneTime.label}. BYOK en Offline AI zijn al beschikbaar in FREE; beide PRO-plannen verwijderen de gedeelde limiet van 50 hernoemingen.` },
    { question: 'Wat is BYOK (Bring Your Own Key)?', answer: 'BYOK laat gebruikers van elk abonnement hun eigen Gemini-, OpenRouter-, OpenAI- of Claude-sleutel koppelen voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt. De sleutel wordt lokaal veilig opgeslagen.' },
    { question: 'Is er een eenmalige aankoop?', answer: `Ja. Naast het maandplan kun je kiezen voor een eenmalige aankoop van ${PRO_PRICING.oneTime.usd} USD. BYOK en Offline AI zijn al beschikbaar in FREE; beide plannen verwijderen de gedeelde limiet van 50 hernoemingen.` },
    { question: 'Welke besturingssystemen worden ondersteund?', answer: 'Zush werkt op macOS 15 Sequoia en nieuwer en Windows 10 / 11. Mac is er als ondertekende dmg, via de Mac App Store en via Homebrew; Windows via Microsoft Store.' },
    ...
    { question: 'Werkt de app offline?', answer: 'Cloudverwerking vereist internet. Gebruikers van elk abonnement kunnen offline AI activeren na installatie van Ollama en een compatibel model.' },
  ...
  it: [
    ...
    { question: 'Come funziona il prezzo?', answer: `Zush PRO ha due piani: Monthly a ${PRO_PRICING.monthly.usd} $/mese oppure One-Time a ${PRO_PRICING.oneTime.usd} $. BYOK e IA offline sono già disponibili in FREE; entrambi i piani PRO rimuovono il limite condiviso di 50 rinomine.` },
    { question: 'Cos’è BYOK (Bring Your Own Key)?', answer: 'BYOK consente agli utenti di tutti i piani di collegare una chiave Gemini, OpenRouter, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato. La chiave è salvata localmente in modo sicuro.' },
    { question: 'Esiste un acquisto unico?', answer: `Sì. Oltre al piano mensile puoi scegliere l’acquisto unico a ${PRO_PRICING.oneTime.usd} USD. BYOK e IA offline sono già disponibili in FREE; entrambi i piani rimuovono il limite condiviso di 50 rinomine.` },
    { question: 'Quali sistemi operativi sono supportati?', answer: 'Zush funziona su macOS 15 Sequoia e versioni successive e su Windows 10 / 11. Mac è disponibile come dmg firmato, su Mac App Store e via Homebrew, Windows su Microsoft Store.' },
    ...
    { question: 'L’app funziona offline?', answer: 'La modalità cloud richiede internet. Gli utenti di tutti i piani possono attivare IA offline dopo aver installato Ollama e un modello compatibile.' },
  ...
  ja: [
    ...
    { question: '料金はどうなっていますか？', answer: `Zush PRO には Monthly（月額 ${PRO_PRICING.monthly.usd} ドル）と One-Time（${PRO_PRICING.oneTime.usd} ドル）の 2 つのプランがあります。BYOK とオフライン AI は FREE でも利用でき、どちらの PRO プランも共通 50 回の上限を解除します。` },
    { question: 'BYOK（Bring Your Own Key）とは？', answer: 'すべてのプランのユーザーが Gemini、OpenRouter、OpenAI、Claude の自分の API キーを接続し、クラウドリネームを利用でき、FREE は全モード共通 50 回、PRO は無制限となる機能です。キーはローカルに安全に保存されます。' },
    { question: '買い切りプランはありますか？', answer: `はい。月額プランに加えて、${PRO_PRICING.oneTime.usd} ドルの買い切りプランを選べます。BYOK とオフライン AI は FREE でも利用でき、どちらの PRO プランも共通 50 回の上限を解除します。` },
    { question: '対応 OS は？', answer: 'macOS 15 Sequoia 以降と Windows 10 / 11 に対応しています。Mac は署名済み dmg、Mac App Store、Homebrew、Windows は Microsoft Store で提供されます。' },
    { question: 'アプリはどの AI モデルを使いますか？', answer: '画像、動画、対応文書を高速かつ正確に分析するため、最新のマルチモーダル AI モデルを使います。具体的なモデルは最適化により変わる場合があります。' },
    { question: 'オフラインで使えますか？', answer: 'クラウド処理にはインターネットが必要です。すべてのプランのユーザーは Ollama と対応モデルを入れるとオフライン AI を有効化できます。' },
  ...
  ko: [
    ...
    { question: '가격은 어떻게 되나요?', answer: `Zush PRO는 두 가지 플랜입니다: Monthly 월 ${PRO_PRICING.monthly.label} 또는 One-Time ${PRO_PRICING.oneTime.label}. BYOK와 오프라인 AI는 FREE에서도 제공되며, 두 PRO 플랜 모두 공통 50회 제한을 제거합니다.` },
    { question: 'BYOK(Bring Your Own Key)이란 무엇인가요?', answer: '모든 플랜의 사용자가 Gemini, OpenRouter, OpenAI, Claude API 키를 연결해 클라우드 이름 변경을 사용하며 FREE는 모든 모드에서 공통 50회, PRO는 무제한인 기능입니다. 키는 로컬에 안전하게 저장됩니다.' },
    { question: '일회성 구매 옵션이 있나요?', answer: `예. 월간 플랜 외에도 ${PRO_PRICING.oneTime.usd} USD 일회성 구매를 선택할 수 있습니다. BYOK와 오프라인 AI는 FREE에서도 제공되며, 두 플랜 모두 공통 50회 제한을 제거합니다.` },
    { question: '지원 운영체제는 무엇인가요?', answer: 'macOS 15 Sequoia 이상과 Windows 10 / 11을 지원합니다. Mac은 서명된 dmg, Mac App Store, Homebrew로 제공되며 Windows는 Microsoft Store에서 제공됩니다.' },
    { question: '앱은 어떤 AI 모델을 사용하나요?', answer: '이미지, 비디오, 지원 문서를 빠르고 정확하게 분석하기 위해 최신 멀티모달 AI 모델을 사용합니다. 구체적인 모델은 최적화에 따라 바뀔 수 있습니다.' },
    { question: '오프라인으로 사용할 수 있나요?', answer: '클라우드 처리는 인터넷이 필요합니다. 모든 플랜의 사용자는 Ollama와 호환 모델을 설치한 뒤 오프라인 AI를 활성화할 수 있습니다.' },
  ...
  tr: [
    { question: 'Zush nedir?', answer: 'Zush, Mac ve Windows için dosyaları yapay zekâyla otomatik olarak yeniden adlandıran akıllı bir masaüstü uygulamasıdır. Görselleri, videoları, PDF’leri ve desteklenen belgeleri analiz ederek anlamlı adlar ve meta veriler oluşturur.' },
    { question: 'Hangi dosya biçimleri destekleniyor?', answer: 'Zush; görselleri, sesleri, videoları, ekran görüntülerini, PDF’leri, belgeleri, elektronik tabloları, sunumları, metin dosyalarını, CSV, SVG ve daha birçok günlük biçimi destekler.' },
    { question: 'Zush AI Rename nasıl çalışır?', answer: 'AI Rename, dosyaları içeriklerine göre yeniden adlandırmak için yapay zekâ kullanır. Dosyaları Zush penceresine sürükleyip bırakmanız yeterlidir; dosyalar saniyeler içinde analiz edilir ve yeniden adlandırılır. Değişiklikleri uygulamadan önce her adı inceleyebilir veya yeniden oluşturabilirsiniz. Ekran görüntülerini, tasarım dosyalarını, sesleri, videoları, PDF’leri, iWork belgelerini ve indirilenleri tek geçişte düzenlemek için idealdir.' },
    { question: 'Klasör izleme nasıl çalışır?', answer: 'Zush seçtiğiniz klasörleri arka planda izler. Yeni desteklenen dosyalar eklendiğinde, çevrimiçiyken otomatik olarak analiz edilir ve yeniden adlandırılır.' },
    { question: 'Yapay zekânın oluşturduğu dosya adını yeniden üretebilir miyim?', answer: 'Evet. AI Rename bölümünde dosyayı seçin ve yeni bir öneri almak için Yeniden Oluştur’a tıklayın.' },
    { question: 'Adlar ve etiketler için yapay zekâ istemini özelleştirebilir miyim?', answer: 'Evet. Kısa adlar, ana konunun başta olması veya yalnızca belirli etiketlerin kullanılması gibi dosya adı ve meta veri kurallarınızı yazabilirsiniz.' },
    { question: 'Verilerim güvende mi?', answer: 'Orijinal dosyalarınız bilgisayarınızda kalır. Bulut modunda yalnızca analiz için gereken içerik seçtiğiniz yapay zekâ sağlayıcısına gönderilir. Çevrimdışı Yapay Zekâ modunda Ollama, desteklenen dosyaları yerel olarak işler.' },
    { question: 'Değişiklikleri geri alabilir miyim?', answer: 'Evet. Etkinlik geçmişinden dosyaları tek tıklamayla orijinal adlarına döndürebilirsiniz.' },
    { question: 'Zush birden fazla dili ve tarih biçimini destekliyor mu?', answer: 'Evet. Zush 60’tan fazla dilde dosya adı oluşturabilir ve tercih ettiğiniz tarih biçimini kullanabilir.' },
    { question: 'Ücretlendirme nasıl çalışır?', answer: `Zush PRO iki plan sunar: ayda ${PRO_PRICING.monthly.usd} USD Monthly veya tek seferlik ${PRO_PRICING.oneTime.usd} USD One-Time. BYOK ve Çevrimdışı Yapay Zekâ FREE’de de sunulur; her iki PRO planı ortak 50 yeniden adlandırma limitini kaldırır.` },
    { question: 'BYOK (Bring Your Own Key) nedir?', answer: 'BYOK, tüm planlardaki kullanıcıların kendi Gemini, OpenRouter, OpenAI veya Claude API anahtarlarını bağlayarak bulut yeniden adlandırmayı kullanmasını sağlar. FREE tüm modlarda ortak 50 işlem sunar; PRO limiti kaldırır. Anahtar yerel ve güvenli depolamada tutulur.' },
    { question: 'Monthly ile One-Time arasındaki fark nedir?', answer: `Monthly plan ayda ${PRO_PRICING.monthly.usd} USD’dir ve esnektir. One-Time plan ${PRO_PRICING.oneTime.usd} USD’dir ve ömür boyu erişim sağlar. BYOK ve Çevrimdışı Yapay Zekâ FREE’de de sunulur; her iki plan ortak 50 yeniden adlandırma limitini kaldırır.` },
    { question: 'Hangi işletim sistemleri destekleniyor?', answer: 'Zush macOS 15 Sequoia ve daha yeni sürümlerde, ayrıca Windows 10 ve 11’de çalışır. Mac için imzalanmış dmg, Mac App Store ve Homebrew; Windows için Microsoft Store seçenekleri vardır.' },
    { question: 'Uygulama hangi yapay zekâ modelini kullanıyor?', answer: 'Zush görselleri, videoları ve desteklenen belgeleri hızlı ve doğru analiz etmek için modern çok modlu yapay zekâ modelleri kullanır. Belirli model, optimizasyonlarla birlikte değişebilir.' },
    { question: 'Uygulama çevrimdışı çalışır mı?', answer: 'Bulut işleme için internet gerekir. tüm planlardaki kullanıcılar Ollama ve uyumlu bir model kurduktan sonra Çevrimdışı Yapay Zekâ’yı etkinleştirebilir.' },
    { question: 'Ses veya video dosyaları destekleniyor mu?', answer: 'Zush 3.0; MP4, MOV, M4V, MPEG, 3GP, TS, MTS, M2TS, DV ve VOB videolarının yanı sıra MP3, M4A, WAV, FLAC, OGG, WebM ve MPGA ses dosyalarını destekler. Ses analizi meta verileri, tanımayı ve transkript bağlamını kullanabilir.' },
    { question: 'Uygulama bana uygun değilse para iadesi alabilir miyim?', answer: 'Evet. Zush 14 günlük para iade garantisi sunar. Ayrıntılar iade politikasında yer alır.' },
  ],
  ar: [
    ...
    { question: 'كيف يعمل السعر؟', answer: `يتوفر Zush PRO بخطتين: Monthly مقابل ${PRO_PRICING.monthly.usd} دولارات/شهر أو One-Time مقابل ${PRO_PRICING.oneTime.usd} دولارا. يتوفر BYOK وOffline AI في FREE أيضا ضمن حد مشترك يبلغ 50 إعادة تسمية، وتزيل خطتا PRO هذا الحد.` },
    { question: 'ما هو BYOK (Bring Your Own Key)؟', answer: 'يتيح BYOK للمستخدمين في جميع الخطط ربط مفاتيح Gemini أو OpenRouter أو OpenAI أو Claude الخاصة بهم لإعادة التسمية عبر السحابة؛ تشمل FREE ‏50 عملية مشتركة بين جميع الأوضاع، وPRO غير محدود. يتم تخزين المفتاح محليا وبشكل آمن.' },
    ...
    { question: 'ما أنظمة التشغيل المدعومة؟', answer: 'يعمل Zush على macOS 15 Sequoia والإصدارات الأحدث، وعلى Windows 10 / 11. يتوفر Mac كملف dmg موقّع وعلى Mac App Store وعبر Homebrew، ويتوفر Windows عبر Microsoft Store.' },
    ...
    { question: 'هل يعمل التطبيق دون اتصال؟', answer: 'تتطلب المعالجة السحابية اتصالا بالإنترنت. يمكن للمستخدمين في جميع الخطط تفعيل Offline AI بعد تثبيت Ollama ونموذج متوافق.' },
...
const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    heroSubtitle:
      'Zush renames files by content with AI and your own naming rules. Preview every filename, undo any batch, and choose Zush Cloud, BYOK, LM Studio or Ollama.',
    ...
    heroModes: ['Zush Cloud', 'BYOK', 'LM Studio', 'Ollama'],
    ...
    offlineAiModal: {
      title: 'Two ways to keep AI on your device',
      description: 'Connect LM Studio or run your own Ollama model on Mac or Windows without cloud processing.',
      points: [
        'LM Studio lets you choose a local model through its desktop server.',
        'Ollama runs compatible local models through its local service.',
        'Switch to Cloud or BYOK anytime for more models and file types.',
      ],
      proTitle: 'Available on every plan',
      proDescription: 'Free includes 50 renames shared across Zush Cloud, BYOK, LM Studio, and Ollama. PRO removes the limit.',
      closeLabel: 'Close',
    },
    showcase: {
      ...
      items: {
        ...
        'custom-ai-blocks': { title: 'Custom AI Blocks', description: 'Describe what AI should extract and reuse it as your own naming block' },
        ...
        'offline-ai': { title: 'Local AI Renaming', description: 'Use LM Studio or Ollama for supported on-device analysis, even without an internet connection' },
      },
    },
    speedComparison: {
      eyebrow: 'Batch rename test',
      title: 'Faster batches. Sharper names.',
    ...
    whyZush: {
      ...
      description: 'AI batch renaming, 100+ file formats, audio and video support, bulk review, templates, naming blocks, folder monitoring, rollback, BYOK, and Local AI in one desktop app',
      ...
      formatsDescription: 'Supports AVIF, RAW, Sketch, Figma, Illustrator, PSD, Office files, Pages, Numbers, Keynote, EPUB, FB2, PDFs, subtitles, MP3, M4A, WAV, FLAC, and common video formats for content-aware renaming in one batch.',
    ...
    useCases: {
      items: [
        { title: 'Designers', description: 'Batch rename Figma, Sketch, Illustrator, PSD, screenshots, mockups, UI references, and handoff assets by what they show.' },
        { title: 'Photographers', description: 'Bulk rename and organize large photo libraries. Supports RAW, HEIC, AVIF, SVG, TIFF, and other image formats.' },
    ...
    workflows: {
      ...
      description: 'Choose a workflow, decide which details Zush should extract, and control how the final filename is structured.',
      items: {
        ...
        documents: { title: 'Rename documents and ebooks', description: 'EPUB, FB2, Word, Excel, PowerPoint, and iWork files named by topic.' },
  ...
  pricing: {
    ...
    description: 'Monthly flexibility or one-time lifetime access. Both plans remove the rename limit across every AI mode.',
    planName: 'Zush PRO 🌟',
    ...
    features: [
      { title: 'Unlimited AI Renames', desc: 'Remove the 50-rename limit across Zush Cloud, BYOK, LM Studio, and Ollama' },
    ],
  ...
  platforms: {
    mac: {
      ...
      ctaSubtitle: 'Set your naming rules, preview every change, and rename Finder files with Zush Cloud, your own AI provider, or Local AI.',
      ...
      features: [
        ...
        'LM Studio and Ollama for supported on-device analysis',
      ],
      faqs: [
        ...
        { question: 'Can I use Zush offline?', answer: 'Yes. LM Studio and Ollama work offline after you configure a compatible local model. Free includes 50 renames shared across all four AI modes; PRO removes the limit.' },
      ],
    },
    windows: {
...
function withFeaturePages(copy: LocaleCopy): LocaleCopy {
  const routeLabels: Array<[LocalizedRoute, string, string]> = [
    ...
    ['/rename-documents-with-ai', 'Rename Documents with AI', 'Rename EPUB, FB2, DOCX, XLSX, PPTX, Pages, Numbers, Keynote, TXT, CSV, and email files by their actual content.'],
...
const localized = (overrides: DeepPartial<LocaleCopy>): LocaleCopy => ({
  ...
  home: {
    ...
    offlineAiModal: {
      ...base.home.offlineAiModal,
      ...overrides.home?.offlineAiModal,
      points: overrides.home?.offlineAiModal?.points ?? base.home.offlineAiModal.points,
    },
    showcase: {
      ...base.home.showcase,
      ...overrides.home?.showcase,
      items: {
        ...base.home.showcase.items,
        ...overrides.home?.showcase?.items,
      },
    } as ShowcaseCopy,
    speedComparison: {
...
const localizedPlatforms: Record<Exclude<Locale, 'en' | 'zh-cn' | 'tr' | 'ar'>, LocaleCopy['platforms']> = {
  de: {
    mac: {
      ...
      ctaSubtitle: 'Lege deine Namensregeln fest, prüfe jede Änderung und benenne Finder-Dateien mit Zush Cloud, deinem KI-Anbieter oder lokaler KI um.',
      faqDescription: 'Alles Wichtige über Zush für Mac und den Rest des Produkts.',
      features: [
        'Dateiumbenenner für Mac mit KI-Stapelumbenennung für Screenshots, Videos, PDFs, Fotos und Dokumente',
        ...
        'BYOK für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt',
        'Lokale KI mit Ollama; funktioniert nach der Einrichtung offline',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Lege deine Namensregeln fest, prüfe jede Änderung und benenne Dateien mit Zush Cloud, deinem KI-Anbieter oder lokaler KI um.',
      faqDescription: 'Alles Wichtige über Zush für Windows und den Rest des Produkts.',
      features: [
        'Dateiumbenenner für Windows 11 und 10 mit KI-Bulk-Umbenennung für Screenshots, Videos, PDFs, Fotos und Dokumente',
        'Ordnerüberwachung mit Dateityp-Ausschlüssen',
        'Stapelumbenennung mit Neugenerierung pro Datei',
        'Eigene Prompts für Namen und Metadaten-Tags',
        'Ein-Klick-Rückgängig aus dem Aktivitätsverlauf',
  ...
  fr: {
    mac: {
      ...
      ctaSubtitle: 'Définissez vos règles, prévisualisez chaque changement et renommez dans Finder avec Zush Cloud, votre fournisseur d’IA ou l’IA locale.',
      faqDescription: 'Tout ce qu’il faut savoir sur Zush pour Mac et le reste du produit.',
      features: [
        'Renommeur de fichiers pour Mac avec renommage par lot IA pour screenshots, vidéos, PDF, photos et documents',
        ...
        'BYOK pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité',
        'IA locale avec Ollama; fonctionne hors ligne après configuration',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Définissez vos règles, prévisualisez chaque changement et renommez dans l’Explorateur avec Zush Cloud, votre fournisseur d’IA ou l’IA locale.',
      faqDescription: 'Tout ce qu’il faut savoir sur Zush pour Windows et le reste du produit.',
      features: [
        'Renommeur de fichiers pour Windows 11 et 10 avec renommage en masse IA pour screenshots, vidéos, PDF, photos et documents',
        'Surveillance des dossiers avec exclusions par type de fichier',
        'Renommage par lot avec régénération par fichier',
        'Prompts personnalisés pour noms et tags de métadonnées',
        'Annulation en un clic depuis l’historique d’activité',
  ...
  'pt-br': {
    mac: {
      ...
      ctaSubtitle: 'Defina suas regras, veja cada alteração e renomeie no Finder com Zush Cloud, seu provedor de IA ou IA local.',
      faqDescription: 'Tudo que você precisa saber sobre o Zush para Mac e o restante do produto.',
      features: [
        'Renomeador de arquivos para Mac com renomeação em lote por IA para screenshots, vídeos, PDFs, fotos e documentos',
        ...
        'IA local com Ollama; funciona offline após a configuração',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Defina suas regras, veja cada alteração e renomeie no Explorador com Zush Cloud, seu provedor de IA ou IA local.',
      faqDescription: 'Tudo que você precisa saber sobre o Zush para Windows e o restante do produto.',
      features: [
        'Renomeador de arquivos para Windows 11 e 10 com renomeação em massa por IA para screenshots, vídeos, PDFs, fotos e documentos',
        'Monitoramento de pastas com exclusões por tipo de arquivo',
        'Renomeação em lote com regeneração por arquivo',
        'Prompts personalizados para nomes e tags de metadados',
        'Desfazer em um clique pelo histórico de atividade',
  ...
  es: {
    mac: {
      ...
      ctaSubtitle: 'Define tus reglas, previsualiza cada cambio y renombra en Finder con Zush Cloud, tu proveedor de IA o IA local.',
      faqDescription: 'Todo lo que necesitas saber sobre Zush para Mac y el resto del producto.',
      features: [
        'Renombrador de archivos para Mac con renombrado por lotes con IA para capturas, videos, PDFs, fotos y documentos',
        ...
        'IA local con Ollama; funciona sin conexión después de configurarla',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Define tus reglas, previsualiza cada cambio y renombra en el Explorador con Zush Cloud, tu proveedor de IA o IA local.',
      faqDescription: 'Todo lo que necesitas saber sobre Zush para Windows y el resto del producto.',
      features: [
        'Renombrador de archivos para Windows 11 y 10 con renombrado masivo por IA para capturas, videos, PDFs, fotos y documentos',
        'Monitoreo de carpetas con exclusiones por tipo de archivo',
        'Renombrado por lotes con regeneración por archivo',
        'Prompts personalizados para nombres y tags de metadatos',
        'Deshacer en un clic desde el historial de actividad',
  ...
  nl: {
    mac: {
      ...
      ctaSubtitle: 'Stel je naamregels in, bekijk elke wijziging en hernoem Finder-bestanden met Zush Cloud, je AI-provider of Lokale AI.',
      faqDescription: 'Alles wat je moet weten over Zush voor Mac en de rest van het product.',
      features: [
        'Bestandshernoemer voor Mac met AI-batchhernoeming voor screenshots, video’s, PDFs, foto’s en documenten',
        ...
        'BYOK voor cloud-hernoemingen; FREE bevat 50 voor alle modi en PRO is onbeperkt',
        'Lokale AI met Ollama; werkt offline na installatie',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Stel je naamregels in, bekijk elke wijziging en hernoem bestanden met Zush Cloud, je AI-provider of Lokale AI.',
      faqDescription: 'Alles wat je moet weten over Zush voor Windows en de rest van het product.',
      features: [
        'Bestandshernoemer voor Windows 11 en 10 met AI-bulkhernoeming voor screenshots, video’s, PDFs, foto’s en documenten',
        'Mapmonitoring met uitsluitingen per bestandstype',
        'Bulk hernoemen met opnieuw genereren per bestand',
        'Aangepaste prompts voor namen en metadata-tags',
        'Een klik terugzetten vanuit de activiteitsgeschiedenis',
  ...
  it: {
    mac: {
      ...
      ctaSubtitle: 'Imposta le tue regole, visualizza ogni modifica e rinomina in Finder con Zush Cloud, il tuo provider IA o l’IA locale.',
      faqDescription: 'Tutto quello che devi sapere su Zush per Mac e sul resto del prodotto.',
      features: [
        'Rinomina file per Mac con rinomina in batch tramite IA per screenshot, video, PDF, foto e documenti',
        ...
        'BYOK per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato',
        'IA locale con Ollama; funziona offline dopo la configurazione',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: 'Imposta le tue regole, visualizza ogni modifica e rinomina in Esplora file con Zush Cloud, il tuo provider IA o l’IA locale.',
      faqDescription: 'Tutto quello che devi sapere su Zush per Windows e sul resto del prodotto.',
      features: [
        'Rinomina file per Windows 11 e 10 con rinomina in massa tramite IA per screenshot, video, PDF, foto e documenti',
        'Monitoraggio cartelle con esclusioni per tipo di file',
        'Rinomina in batch con rigenerazione per file',
        'Prompt personalizzati per nomi e tag metadati',
        'Annulla in un clic dalla cronologia attività',
  ...
  ja: {
    mac: {
      ...
      ctaSubtitle: '命名ルールを設定し、変更を確認して、Zush Cloud、自分のAIプロバイダー、ローカルAIでFinderのファイルをリネーム。',
      faqDescription: 'Zush for Mac と製品全体について知っておきたいこと。',
      features: [
        'Mac向けファイルリネーム。スクリーンショット、動画、PDF、写真、文書をAIで一括リネーム',
        'ファイルタイプ除外付きのフォルダ監視',
        ...
        '60以上の言語と柔軟な日付形式',
        'BYOK によるクラウドリネーム。FREE は全モード共通 50 回、PRO は無制限',
        'Ollama を使うローカル AI。設定後はオフラインで動作',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: '命名ルールを設定し、変更を確認して、Zush Cloud、自分のAIプロバイダー、ローカルAIでファイルをリネーム。',
      faqDescription: 'Zush for Windows と製品全体について知っておきたいこと。',
      features: [
        'Windows 11/10向けファイルリネーム。スクリーンショット、動画、PDF、写真、文書をAIで大量リネーム',
        'ファイルタイプ除外付きのフォルダ監視',
        'ファイルごとの再生成に対応した一括リネーム',
        '名前とメタデータタグ用のカスタムプロンプト',
        'アクティビティ履歴からワンクリックで復元',
  ...
  ko: {
    mac: {
      ...
      ctaSubtitle: '이름 규칙을 정하고 모든 변경을 확인한 뒤 Zush Cloud, 내 AI 제공업체 또는 로컬 AI로 Finder 파일 이름을 변경하세요.',
      faqDescription: 'Mac용 Zush와 제품 전반에 대해 알아야 할 내용입니다.',
      features: [
        'Mac용 파일 이름 변경 도구. 스크린샷, 비디오, PDF, 사진, 문서를 AI로 일괄 이름 변경',
        ...
        'BYOK로 클라우드 이름 변경. FREE는 모든 모드에서 공통 50회, PRO는 무제한',
        'Ollama를 사용하는 로컬 AI; 설정 후 오프라인 작동',
      ],
      faqs: [
    ...
    windows: {
      ...
      ctaSubtitle: '이름 규칙을 정하고 모든 변경을 확인한 뒤 Zush Cloud, 내 AI 제공업체 또는 로컬 AI로 파일 이름을 변경하세요.',
      faqDescription: 'Windows용 Zush와 제품 전반에 대해 알아야 할 내용입니다.',
      features: [
        'Windows 11 및 10용 파일 이름 변경 도구. 스크린샷, 비디오, PDF, 사진, 문서를 AI로 대량 이름 변경',
        '파일 형식 제외가 가능한 폴더 모니터링',
        '파일별 재생성을 지원하는 일괄 이름 변경',
        '이름 및 메타데이터 태그용 사용자 지정 프롬프트',
        '활동 기록에서 한 번의 클릭으로 되돌리기',
...
const localizedFooterDetails: Record<Exclude<Locale, 'en'>, FooterVisibleCopy> = {
  ...
  tr: {
    ...
    appStoreKicker: 'Şuradan indirin',
    appStoreLabel: 'Mac App Store',
    appStoreAria: 'Zush’u Mac App Store’dan indirin',
    microsoftStoreKicker: 'Şuradan indirin',
    microsoftStoreLabel: 'Microsoft Store',
    ...
    productLinks: {
      ...
      screenshots: 'Ekran görüntülerini yeniden adlandır',
      documents: 'Belgeleri yeniden adlandır',
      videos: 'Videoları yeniden adlandır',
...
const localizedDownloadMenu: Record<Exclude<Locale, 'en'>, DownloadMenuCopy> = {
  de: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Kostenlos testen · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Microsoft Store im Browser öffnen',
    appStoreTitle: 'Mac App Store',
  ...
  fr: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Essai gratuit · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Ouvrir Microsoft Store dans le navigateur',
    appStoreTitle: 'Mac App Store',
  ...
  'pt-br': {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Teste grátis · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Abrir a Microsoft Store no navegador',
    appStoreTitle: 'Mac App Store',
  ...
  es: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Prueba gratis · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Abrir Microsoft Store en el navegador',
    appStoreTitle: 'Mac App Store',
  ...
  nl: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Gratis proberen · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Microsoft Store openen in de browser',
    appStoreTitle: 'Mac App Store',
  ...
  it: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Prova gratuita · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'Apri Microsoft Store nel browser',
    appStoreTitle: 'Mac App Store',
  ...
  ja: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: '無料で試す · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'ブラウザーで Microsoft Store を開く',
    appStoreTitle: 'Mac App Store',
  ...
  ko: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: '무료 체험 · Windows 10/11 · Microsoft Store',
    windowsWebFallback: '브라우저에서 Microsoft Store 열기',
    appStoreTitle: 'Mac App Store',
  ...
  'zh-cn': {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: '免费试用 · Windows 10/11 · Microsoft Store',
    windowsWebFallback: '在浏览器中打开 Microsoft Store',
    appStoreTitle: 'Mac App Store',
  ...
  tr: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'Ücretsiz deneyin · Windows 10/11 · Microsoft Store',
    windowsWebFallback: "Microsoft Store'u tarayıcıda aç",
    appStoreTitle: 'Mac App Store',
  ...
  ar: {
    ...
    windowsHint: 'Microsoft Store',
    windowsTrialHint: 'جرّبه مجانا · Windows 10/11 · Microsoft Store',
    windowsWebFallback: 'فتح Microsoft Store في المتصفح',
    appStoreTitle: 'Mac App Store',
...
const localizedPricingFeatures: Record<Exclude<Locale, 'en'>, PricingCopy['features']> = {
  de: simpleFeatures([
    ['Unbegrenzte KI-Umbenennungen', 'Entfernt das Limit von 50 Umbenennungen für Cloud-KI, BYOK und Offline-KI'],
  ]),
  fr: simpleFeatures([
    ['Renommages IA illimités', 'Supprime la limite de 50 renommages pour l’IA cloud, BYOK et l’IA hors ligne'],
  ]),
  'pt-br': simpleFeatures([
    ['Renomeações ilimitadas com IA', 'Remove o limite de 50 renomeações em Cloud AI, BYOK e IA offline'],
  ]),
  es: simpleFeatures([
    ['Renombrados ilimitados con IA', 'Elimina el límite de 50 renombrados en Cloud AI, BYOK e IA sin conexión'],
  ]),
  nl: simpleFeatures([
    ['Onbeperkt hernoemen met AI', 'Verwijdert de limiet van 50 hernoemingen voor Cloud AI, BYOK en Offline AI'],
  ]),
  it: simpleFeatures([
    ['Rinomine IA illimitate', 'Rimuove il limite di 50 rinomine per Cloud AI, BYOK e IA offline'],
  ]),
  ja: simpleFeatures([
    ['AI リネーム無制限', 'Cloud AI、BYOK、オフライン AI 共通の 50 回上限を解除'],
  ]),
  ko: simpleFeatures([
    ['무제한 AI 이름 변경', 'Cloud AI, BYOK, 오프라인 AI의 공통 50회 제한 제거'],
  ]),
  'zh-cn': simpleFeatures([
    ['无限 AI 重命名', '移除 Cloud AI、BYOK 和离线 AI 共用的 50 次限制'],
  ]),
  tr: simpleFeatures([
    ['Sınırsız yapay zekâ yeniden adlandırma', 'Cloud AI, BYOK ve Çevrimdışı Yapay Zekâ için ortak 50 işlem sınırını kaldırır'],
  ]),
  ar: simpleFeatures([
    ['إعادة تسمية غير محدودة بالذكاء الاصطناعي', 'يزيل حد 50 عملية المشترك بين Cloud AI وBYOK وOffline AI'],
  ]),
};
...
const localizedPricingExtras: Record<Exclude<Locale, 'en'>, PricingExtrasCopy> = {
  de: {
    ...
    monthlyPlan: {
      ...
      buttonText: 'PRO Monthly starten',
      billing: '/Monat',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
  ...
  fr: {
    ...
    monthlyPlan: {
      ...
      buttonText: 'Démarrer PRO Monthly',
      billing: '/mois',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
  ...
  'pt-br': {
    ...
    monthlyPlan: {
      ...
      buttonText: 'Começar PRO Monthly',
      billing: '/mês',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
  ...
  es: {
    ...
    monthlyPlan: {
      ...
      buttonText: 'Empezar PRO Monthly',
      billing: '/mes',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
  ...
  ko: {
    title: 'PRO 플랜을 선택하세요',
    description: '월간 유연성 또는 일회성 평생 액세스. 두 플랜 모두 모든 AI 모드의 이름 변경 제한을 제거합니다.',
  ...
  tr: {
    ...
    description: 'Aylık esneklik veya tek seferlik ömür boyu erişim. Her iki plan da sınırsız PRO’nun kilidini açar.',
    sharedFeaturesTitle: 'PRO 🌟 özellikleri',
    monthlyDifferentiators: ['İstediğiniz zaman iptal edin', 'En düşük başlangıç fiyatı', 'Uzun vadeli taahhüt yok'],
    oneTimeDifferentiators: ['Bir kez ödeyin, sonsuza kadar kullanın', 'Gelecekteki tüm güncellemeler dâhil', 'Yaklaşık 5 ayda kendini amorti eder'],
    monthlyPlan: {
      titleSuffix: 'Monthly',
      description: 'Esnek aylık plan',
      buttonText: 'PRO Monthly’yi başlat',
      billing: '/ay',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
      description: 'Bir kez ödeyin, ömür boyu erişin',
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  de: {
    featureCards: {
      ...
      byok: { title: 'Eigener API-Schlüssel', description: 'Verbinde Gemini, OpenRouter, OpenAI oder Claude für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt. Schlüssel bleiben lokal gespeichert.' },
      offlineAi: { title: 'Lokale KI', description: 'Lokale Modelle über Ollama verarbeiten unterstützte Dateien auf deinem Gerät und funktionieren nach der Einrichtung offline.' },
      ...
      bandTitle: 'Bestimme, wo die KI läuft', bandSubtitle: 'Nutze Zush Cloud, deinen eigenen KI-Anbieter oder unterstützte Analysen lokal mit Ollama.',
  ...
  fr: {
    featureCards: {
      ...
      byok: { title: 'Votre propre clé API', description: 'Connectez Gemini, OpenRouter, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité. Les clés restent stockées localement.' },
      offlineAi: { title: 'IA locale privée', description: 'Les modèles Ollama locaux traitent les fichiers pris en charge sur votre appareil et fonctionnent hors ligne après la configuration.' },
      ...
      bandTitle: 'Choisissez où tourne l’IA', bandSubtitle: 'Utilisez Zush Cloud, connectez votre fournisseur d’IA ou gardez les analyses compatibles sur votre appareil avec Ollama.',
  ...
  'pt-br': {
    featureCards: {
      ...
      byok: { title: 'Use sua própria chave', description: 'Conecte Gemini, OpenRouter, OpenAI ou Claude para renomeações ilimitadas. As chaves ficam salvas localmente.' },
      offlineAi: { title: 'IA local privada', description: 'Os modelos locais do Ollama processam arquivos compatíveis no seu dispositivo e funcionam offline após a configuração.' },
      ...
      bandTitle: 'Escolha onde a IA roda', bandSubtitle: 'Use Zush Cloud, conecte seu provedor de IA ou mantenha análises compatíveis no dispositivo com Ollama.',
    ...
    offlineAiModal: {
      title: 'IA que fica no seu dispositivo',
      description: 'A IA offline é um modo opcional. Um modelo Ollama local roda direto no seu Mac ou PC Windows — sem nuvem.',
      points: [
        'Nada sai do seu dispositivo. Sem nuvem do Zush, sem IA de terceiros.',
        'Ideal para screenshots, fotos, PDFs e prévias de documentos.',
        'Mude para a nuvem ou BYOK quando quiser mais modelos e formatos.',
      ],
      proTitle: 'Disponível em todos os planos',
      proDescription: 'FREE inclui 50 renomeações entre Cloud AI, BYOK e IA offline. PRO remove o limite. O Ollama e um modelo local são instalados à parte.',
      closeLabel: 'Fechar',
    },
    showcase: { title: 'Faça um tour pelo Zush', titleAccent: 'Zush', description: 'Uma demo curta por recurso — clique numa aba para ver em ação', playShowcase: 'Reproduzir demo', switchTo: 'Alternar para', items: { 'batch-rename': { title: 'Renomeação em lote com IA', description: 'Renomeie vários arquivos pelo conteúdo real antes de aplicar' }, monitor: { title: 'Monitor de pastas', description: 'Monitore pastas e renomeie novos arquivos' }, activity: { title: 'Histórico de atividade', description: 'Revise renomeações recentes e desfaça alterações' }, statistics: { title: 'Estatísticas', description: 'Veja volume de renomeações, participação do Monitor, atividade e tendências por tipo de arquivo' }, templates: { title: 'Modelos', description: 'Salve configurações reutilizáveis para AI Rename e Monitor' }, tags: { title: 'Tags inteligentes', description: 'Gere tags para encontrar arquivos mais rápido' }, 'naming-blocks': { title: 'Blocos de nomes', description: 'Crie nomes a partir do conteúdo dos arquivos com 145+ blocos prontos' }, 'custom-ai-blocks': { title: 'Blocos de IA personalizados', description: 'Descreva o que a IA deve extrair e reutilize como seu próprio bloco de nome' }, multilanguage: { title: 'Multilíngue', description: 'Gere nomes em mais de 60 idiomas' }, 'custom-prompts': { title: 'Prompts personalizados', description: 'Guie a geração com suas próprias instruções' }, byok: { title: 'BYOK', description: 'Conecte seu próprio provedor de IA com BYOK' }, 'offline-ai': { title: 'Renomeação IA offline', description: 'Use modelos locais privados via Ollama para arquivos compatíveis' } } },
    whyZush: { title: 'Por que o Zush vence renomeadores genéricos', titlePlatform: 'Por que o Zush vence no {os}', description: 'Renomeação em lote com IA, monitoramento automático, desfazer, BYOK, IA offline e formatos mistos em um app desktop', descriptionPlatform: 'Sensação nativa, renomeação rápida, preço único e menos decisões no {os}', nativeEyebrow: 'Sensação nativa de desktop', nativeEyebrowPlatform: 'Sensação nativa do {os}', nativeTitle: 'Nativo, rápido e moderno', nativeDescription: 'O Zush parece um app desktop de verdade: abre rápido, é limpo de usar e combina com seu sistema.', nativeDescriptionPlatform: 'O Zush parece um app nativo de {os}: abre rápido, é limpo de usar e combina com seu sistema.', pricingTrustItems: ['✨ Teste grátis', '∞ PRO ilimitado', '↩️ Reembolso em 14 dias'], priceEyebrow: 'Reusable templates', priceTitle: 'One setup for every folder', priceDescription: 'Save naming rules for screenshots, expenses, music tracks, client notes, legal files, travel bookings, and monitored folders.', priceLabel: '11 built-in', speedEyebrow: 'Muito rápido', speedTitle: 'Renomeações em segundos', speedDescription: 'Organização só funciona quando não interrompe o trabalho. Solte arquivos, revise, aplique e continue.', formatsEyebrow: '100+ formatos compatíveis', formatsTitle: 'Screenshots, PDFs, fotos, áudio, documentos e vídeos', formatsDescription: 'Compatível com AVIF, RAW, Office, ebooks EPUB e FB2, PDFs, legendas, MP3, M4A, WAV, FLAC e formatos de vídeo comuns.', controlEyebrow: 'Blocos de nomes', controlTitle: 'Nomes de arquivos estruturados para trabalho profissional', controlDescription: 'Profissionais montam seus próprios padrões de nome com blocos que combinam com o trabalho. A IA lê cada arquivo e preenche esses blocos com os detalhes escolhidos: cliente, data, número da nota, local ou projeto.', workflowSteps: ['Fotógrafos: data, cliente, ensaio, cena', 'Médicos: tipo de consulta, data, tipo de prontuário', 'Contadores: fornecedor, nota fiscal, período'] },
  ...
  es: {
    featureCards: {
      ...
      byok: { title: 'Trae tu propia clave', description: 'Conecta Gemini, OpenRouter, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado. Las claves se guardan localmente.' },
      offlineAi: { title: 'IA local privada', description: 'Los modelos locales de Ollama procesan los archivos compatibles en tu dispositivo y funcionan sin conexión después de configurarlos.' },
      ...
      bandTitle: 'Elige dónde se ejecuta la IA', bandSubtitle: 'Usa Zush Cloud, conecta tu proveedor de IA o mantén los análisis compatibles en tu dispositivo con Ollama.',
  ...
  nl: {
    featureCards: {
      ...
      byok: { title: 'Eigen sleutel gebruiken', description: 'Koppel Gemini, OpenRouter, OpenAI of Claude voor cloud-hernoemen. FREE bevat 50 hernoemingen voor alle modi; PRO verwijdert de limiet. Sleutels blijven lokaal opgeslagen.' },
      offlineAi: { title: 'Private lokale AI', description: 'Lokale Ollama-modellen verwerken ondersteunde bestanden op je apparaat en werken na de installatie offline.' },
      ...
      bandTitle: 'Kies waar AI draait', bandSubtitle: 'Gebruik Zush Cloud, koppel je eigen AI-provider of houd ondersteunde analyse op je apparaat met Ollama.',
  ...
  it: {
    featureCards: {
      ...
      byok: { title: 'Usa la tua chiave', description: 'Collega Gemini, OpenRouter, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato. Le chiavi restano locali.' },
      offlineAi: { title: 'IA locale privata', description: 'I modelli Ollama locali elaborano i file supportati sul dispositivo e funzionano offline dopo la configurazione.' },
      ...
      bandTitle: 'Scegli dove gira l’IA', bandSubtitle: 'Usa Zush Cloud, collega il tuo provider IA o mantieni le analisi supportate sul dispositivo con Ollama.',
  ...
  ja: {
    featureCards: {
      ...
      byok: { title: '自分のキーを使用', description: 'Gemini、OpenRouter、OpenAI、Claude を接続してクラウドリネーム。FREE は全モード共通 50 回、PRO は無制限。キーはローカルに安全保存されます。' },
      offlineAi: { title: 'プライベートなローカル AI', description: 'ローカルの Ollama モデルが対応ファイルをデバイス上で処理し、セットアップ後はオフラインでも動作します。' },
      cloudAi: { title: 'クラウド AI', description: '当社のリレー経由で商用 AI プロバイダーに接続し、その標準 API 規約に従います。リレーがあるのは、API キーをアプリから取り出せないようにするためです。' },
      bandTitle: 'AI の実行場所を選択', bandSubtitle: 'Zush Cloud、自分の AI プロバイダー、または Ollama による対応オンデバイス分析から選べます。',
    ...
    showcase: { title: 'Zush をひと巡り', titleAccent: 'Zush', description: '機能ごとに短いデモを1本 — タブをクリックして動作を確認', playShowcase: 'デモを再生', switchTo: '切り替え:', items: { 'batch-rename': { title: 'AI一括リネーム', description: '実際の内容に基づいて複数ファイルを確認してから適用' }, monitor: { title: 'フォルダ監視', description: 'フォルダを監視し、新しいファイルを自動リネーム' }, activity: { title: 'アクティビティ履歴', description: '最近のリネームを確認し、必要なら元に戻す' }, statistics: { title: '統計', description: 'リネーム量、フォルダ監視の割合、アクティビティ、ファイル種別の傾向を確認' }, templates: { title: 'テンプレート', description: 'AIリネームとフォルダ監視で繰り返し使える設定を保存' }, tags: { title: 'スマートタグ', description: '検索しやすいタグを生成' }, 'naming-blocks': { title: '命名ブロック', description: 'ファイルの内容から 145+ の用意済みブロックでファイル名を構築' }, 'custom-ai-blocks': { title: 'カスタム AI ブロック', description: '抽出したい内容を指定して、自分専用の命名ブロックとして再利用' }, multilanguage: { title: '多言語対応', description: '60以上の言語でファイル名を生成' }, 'custom-prompts': { title: 'カスタムプロンプト', description: '独自の指示で名前生成を調整' }, byok: { title: 'BYOK', description: '自分の AI プロバイダーを BYOK で接続' }, 'offline-ai': { title: 'オフラインAIリネーム', description: '対応ファイルに Ollama のプライベートなローカルモデルを使用' } } },
    whyZush: { title: 'Zush が汎用リネームツールに勝つ理由', titlePlatform: '{os} で Zush が選ばれる理由', description: 'AI一括リネーム、自動フォルダ監視、取り消し、BYOK、オフラインAI、混在形式対応を1つのデスクトップアプリに統合', descriptionPlatform: '{os} でのネイティブ感、速いリネーム、買い切り価格、迷いの少ない操作', nativeEyebrow: 'デスクトップネイティブ', nativeEyebrowPlatform: '{os} ネイティブ', nativeTitle: 'ネイティブ、高速、モダン', nativeDescription: 'Zush は本物のデスクトップアプリのように、すぐ開けて、使いやすく、OS に自然になじみます。', nativeDescriptionPlatform: 'Zush は本物の {os} ネイティブアプリのように、すぐ開けて、使いやすく、OS に自然になじみます。', pricingTrustItems: ['✨ 無料で試せる', '∞ 無制限 PRO', '↩️ 14日返金'], priceEyebrow: 'Reusable templates', priceTitle: 'One setup for every folder', priceDescription: 'Save naming rules for screenshots, expenses, music tracks, client notes, legal files, travel bookings, and monitored folders.', priceLabel: '11 built-in', speedEyebrow: '超高速', speedTitle: 'リネームは数秒で完了', speedDescription: '整理は作業を止めないことが大切です。ファイルを入れ、確認し、適用して次へ進めます。', formatsEyebrow: '100+種類の対応形式', formatsTitle: 'スクリーンショット、PDF、写真、音声、文書、動画', formatsDescription: 'AVIF、RAW、Officeファイル、EPUB・FB2電子書籍、PDF、字幕、MP3、M4A、WAV、FLAC、一般的な動画形式に対応します。', controlEyebrow: '命名ブロック', controlTitle: 'プロの仕事のための構造化ファイル名', controlDescription: 'プロは自分の仕事に合うブロックで独自のファイル名パターンを組み立てられます。AI が各ファイルを読み取り、選んだ詳細（クライアント、日付、請求書番号、場所、プロジェクトなど）でそれらのブロックを埋めます。', workflowSteps: ['フォトグラファー: 日付、クライアント、撮影、シーン', '医師: 受診種別、日付、記録種別', '会計士: 取引先、請求書、期間'] },
  ...
  ko: {
    featureCards: {
      ...
      byok: { title: '내 키 가져오기', description: 'Gemini, OpenRouter, OpenAI, Claude를 연결해 클라우드에서 이름을 변경하세요. FREE는 모든 모드에서 공통 50회이며 PRO는 제한이 없습니다. 키는 로컬에 저장됩니다.' },
      offlineAi: { title: '비공개 로컬 AI', description: '로컬 Ollama 모델이 지원 파일을 기기에서 처리하며 설정 후에는 오프라인으로 작동합니다.' },
      ...
      bandTitle: 'AI 실행 위치 선택', bandSubtitle: 'Zush Cloud, 내 AI 제공업체 또는 Ollama를 통한 지원되는 기기 내 분석을 선택하세요.',
    ...
    showcase: { title: 'Zush 둘러보기', titleAccent: 'Zush', description: '기능마다 짧은 데모 하나 — 탭을 클릭해 작동 모습을 확인하세요', playShowcase: '데모 재생', switchTo: '전환:', items: { 'batch-rename': { title: 'AI 일괄 이름 변경', description: '실제 내용으로 여러 파일을 검토한 뒤 적용' }, monitor: { title: '폴더 모니터링', description: '폴더를 감시하고 새 파일 이름을 자동 변경' }, activity: { title: '활동 기록', description: '최근 이름 변경을 확인하고 되돌리기' }, statistics: { title: '통계', description: '이름 변경 양, 폴더 모니터링 비중, 활동, 파일 유형 추이를 확인' }, templates: { title: '템플릿', description: 'AI 이름 변경과 폴더 모니터링에 재사용할 설정을 저장' }, tags: { title: '스마트 태그', description: '빠른 검색을 위한 태그 생성' }, 'naming-blocks': { title: 'Naming Blocks', description: '파일 내용을 기반으로 145개 이상의 준비된 블록으로 파일명 구성' }, 'custom-ai-blocks': { title: '사용자 지정 AI 블록', description: 'AI가 추출할 내용을 설명하고 나만의 이름 블록으로 재사용' }, multilanguage: { title: '다국어', description: '60개 이상 언어로 파일 이름 생성' }, 'custom-prompts': { title: '사용자 지정 프롬프트', description: '직접 작성한 지침으로 이름 생성 제어' }, byok: { title: 'BYOK', description: 'BYOK로 내 AI 제공자 연결' }, 'offline-ai': { title: '오프라인 AI 이름 변경', description: '지원 파일에 Ollama 개인 로컬 모델 사용' } } },
    whyZush: { title: 'Zush가 일반 이름 변경 도구보다 강한 이유', titlePlatform: '{os}에서 Zush가 강한 이유', description: 'AI 일괄 이름 변경, 자동 폴더 모니터링, 되돌리기, BYOK, 오프라인 AI, 혼합 형식 지원을 하나의 데스크톱 앱에 담았습니다', descriptionPlatform: '{os}에서 네이티브 느낌, 빠른 이름 변경, 일회성 가격, 줄어든 결정 피로', nativeEyebrow: '데스크톱 네이티브 느낌', nativeEyebrowPlatform: '{os} 네이티브 느낌', nativeTitle: '네이티브, 빠름, 모던함', nativeDescription: 'Zush는 빠르게 열리고 깔끔하게 사용할 수 있으며 시스템에 자연스럽게 어울리는 진짜 데스크톱 앱처럼 느껴집니다.', nativeDescriptionPlatform: 'Zush는 빠르게 열리고 깔끔하게 사용할 수 있으며 {os}에 자연스럽게 어울리는 진짜 네이티브 앱처럼 느껴집니다.', pricingTrustItems: ['✨ 무료 체험', '∞ 무제한 PRO', '↩️ 14일 환불'], priceEyebrow: 'Reusable templates', priceTitle: 'One setup for every folder', priceDescription: 'Save naming rules for screenshots, expenses, music tracks, client notes, legal files, travel bookings, and monitored folders.', priceLabel: '11 built-in', speedEyebrow: '매우 빠름', speedTitle: '몇 초 만에 이름 변경', speedDescription: '정리는 작업을 방해하지 않을 때 지속됩니다. 파일을 넣고, 확인하고, 적용하고, 계속하세요.', formatsEyebrow: '100+개 지원 형식', formatsTitle: '스크린샷, PDF, 사진, 오디오, 문서, 비디오', formatsDescription: 'AVIF, RAW, Office 파일, EPUB 및 FB2 전자책, PDF, 자막, MP3, M4A, WAV, FLAC, 일반 비디오 형식을 지원합니다.', controlEyebrow: 'Naming Blocks', controlTitle: '전문 업무를 위한 구조화된 파일명', controlDescription: '전문가는 자신의 작업에 맞는 블록으로 직접 파일명 패턴을 구성할 수 있습니다. AI가 각 파일을 읽고 선택한 세부 정보(고객, 날짜, 송장 번호, 장소, 프로젝트 등)로 블록을 채웁니다.', workflowSteps: ['포토그래퍼: 날짜, 고객, 촬영, 장면', '의사: 방문 유형, 날짜, 기록 종류', '회계사: 거래처, 송장, 기간'] },
  ...
  tr: {
    featureCards: {
      ...
      renameHistory: { title: 'Yeniden adlandırma geçmişi', description: 'Her değişikliği izleyin. Sonuç uygun değilse tek tıklamayla orijinal dosya adına dönün.' },
      ...
      byok: { title: 'Kendi anahtarınızı kullanın', description: 'Bulut yeniden adlandırma için kendi Gemini, OpenRouter, OpenAI veya Claude API anahtarınızı bağlayın. FREE tüm modlarda ortak 50 işlem sunar; PRO limiti kaldırır. Anahtarlar yerel ve güvenli depolamada tutulur.' },
      offlineAi: { title: 'Özel yerel yapay zekâ', description: 'Yerel Ollama modelleri desteklenen dosyaları cihazınızda işler ve kurulumdan sonra çevrimdışı çalışır.' },
      ...
      bandTitle: 'Yapay zekânın nerede çalışacağını seç', bandSubtitle: 'Zush Cloud’u, kendi AI sağlayıcını veya Ollama ile desteklenen cihaz içi analizi kullan.',
      addFolder: 'Klasör ekle',
      promptRules: 'İstem kuralları',
      customBadge: 'Özel',
      templateActive: 'Etkin şablon',
      templateNames: ['Ekran Görüntüleri', 'Müzik Parçaları', 'Müşteri Notları'],
      namingBlockLabels: ['{date}', '{client_name}', '{artist}', '{bpm}', '{invoice_number}', '{title}'],
      ...
      today: 'Bugün',
      undo: 'Geri al',
      audioNewNames: ['lofi_piyano_dongusu_92bpm.mp3', 'musteri_kesif_gorusmesi.m4a'],
    },
    offlineAiModal: {
    ...
    showcase: {
      ...
      switchTo: 'Şuna geç:',
      items: {
        'batch-rename': { title: 'Yapay zekâyla toplu yeniden adlandırma', description: 'Uygulamadan önce dosyaları gerçek içeriklerine göre topluca inceleyin ve yeniden adlandırın' },
        monitor: { title: 'Klasör izleme', description: 'Klasörleri izleyin ve yeni dosyaları otomatik yeniden adlandırın' },
        activity: { title: 'Etkinlik geçmişi', description: 'Son yeniden adlandırmaları görün ve gerektiğinde geri alın' },
        statistics: { title: 'İstatistikler', description: 'Yeniden adlandırma hacmini, klasör izleme payını, etkinlikleri ve dosya türü eğilimlerini görün' },
        templates: { title: 'Şablonlar', description: 'Yapay zekâyla yeniden adlandırma ve klasör izleme için yeniden kullanılabilir ayarları kaydedin' },
        tags: { title: 'Akıllı etiketler', description: 'Dosyaları daha hızlı aramak için akıllı etiketler oluşturun' },
        'naming-blocks': { title: 'Adlandırma Blokları', description: 'Dosya içeriğini kullanarak 145’ten fazla hazır blokla dosya adları oluşturun' },
        'custom-ai-blocks': { title: 'Özel Yapay Zekâ Blokları', description: 'Yapay zekânın ne çıkaracağını açıklayın ve kendi adlandırma bloğunuz olarak yeniden kullanın' },
        multilanguage: { title: 'Çoklu dil', description: '60’tan fazla dilde dosya adı oluşturun' },
        'custom-prompts': { title: 'Özel istemler', description: 'Kendi talimatlarınızla dosya adı oluşturmayı yönetin' },
        byok: { title: 'BYOK', description: 'BYOK ile kendi yapay zekâ sağlayıcınızı bağlayın' },
        'offline-ai': { title: 'Çevrimdışı yapay zekâyla yeniden adlandırma', description: 'Desteklenen dosyalar için Ollama’nın özel yerel modellerini kullanın' },
      },
    },
    whyZush: {
      ...
      pricingTrustItems: ['✨ Ücretsiz deneyin', '∞ Sınırsız PRO', '↩️ 14 gün iade'],
      ...
      workflowSteps: ['Fotoğrafçılar: tarih, müşteri, çekim, sahne', 'Doktorlar: ziyaret türü, tarih, kayıt türü', 'Muhasebeciler: tedarikçi, fatura, dönem'],
    },
    useCases: {
      items: [
        { title: 'Tasarımcılar', description: 'Yüzlerce ekran görüntüsü arasında kaybolmadan maketleri, arayüz öğelerini ve referansları saniyeler içinde bulun.' },
        { title: 'Fotoğrafçılar', description: 'CR2, NEF, ARW, DNG, RAF ve RW2 gibi RAW biçimlerinin desteğiyle büyük fotoğraf arşivlerini düzenleyin.' },
        { title: 'Pazarlama ve sosyal medya', description: 'Kampanya sunumlarını, dışa aktarmaları, ekran görüntülerini ve varlıkları düzenli tutup doğru dosyayı hızla bulun.' },
        { title: 'Geliştiriciler', description: 'Belgeleri, hata raporlarını ve PR inceleme ekran görüntülerini düzenli ve aranabilir tutun.' },
        { title: 'İçerik üreticileri', description: 'Küçük resimleri, b-roll referanslarını ve görsel varlıkları düzenli tutun.' },
        { title: 'Ürün yöneticileri', description: 'PRD’leri, toplantı notlarını, elektronik tabloları ve paydaş sunumlarını anında aranabilir hâle getirin.' },
      ],
    },
  },
  'zh-cn': {
    faqItems: [
      ...
      { question: '价格如何计算？', answer: `Zush PRO 有两个方案：Monthly 每月 ${PRO_PRICING.monthly.usd} 美元，或 One-Time ${PRO_PRICING.oneTime.usd} 美元。BYOK 和离线 AI 已在 FREE 中提供；两个 PRO 方案都会移除共用的 50 次重命名限制。` },
      { question: '什么是 BYOK（Bring Your Own Key）？', answer: 'BYOK 允许所有方案的用户连接自己的 Gemini、OpenRouter、OpenAI 或 Claude API key，用于云端重命名。FREE 在所有模式间共享 50 次；PRO 会移除此限制。密钥会保存在本地安全存储中。' },
      { question: '是否有一次性购买选项？', answer: `有。除了月付方案，也可以选择 ${PRO_PRICING.oneTime.usd} USD 一次性购买。BYOK 和离线 AI 已在 FREE 中提供；两个方案都会移除共用的 50 次重命名限制。` },
      { question: '支持哪些操作系统？', answer: 'Zush 支持 macOS 15 Sequoia 及更新版本，以及 Windows 10 / 11。Mac 可使用签名 dmg、Mac App Store 或 Homebrew，Windows 可从 Microsoft Store 安装。' },
      { question: '应用使用哪个 AI 模型？', answer: 'Zush 使用先进的多模态 AI 模型来分析图片、视频和支持的文档。具体模型可能会随着速度和准确性优化而更新。' },
      { question: '应用可以离线使用吗？', answer: '云端处理需要网络。所有方案的用户都可以安装 Ollama 和兼容模型后启用离线 AI 模式。' },
    ...
    featureCards: {
      ...
      byok: { title: '使用自己的密钥', description: '连接 Gemini、OpenRouter、OpenAI 或 Claude，实现云端重命名；FREE 在所有模式间共享 50 次，PRO 无限制。密钥会安全保存在本地。' },
      offlineAi: { title: '私有本地 AI', description: '本地 Ollama 模型会在设备上处理受支持的文件，完成设置后也可离线运行。' },
      cloudAi: { title: '云端 AI', description: '通过我们的中继连接到商用 AI 提供商，遵循其标准 API 条款。中继的作用是让 API 密钥无法从应用中被提取。' },
      bandTitle: '选择 AI 运行位置', bandSubtitle: '使用 Zush Cloud、连接自己的 AI 服务商，或通过 Ollama 在设备上运行受支持的分析。',
    ...
    showcase: { title: '来一次 Zush 漫游', titleAccent: 'Zush', description: '每个功能一段简短演示 — 点击标签查看实际效果', playShowcase: '播放演示', switchTo: '切换到', items: { 'batch-rename': { title: 'AI 批量重命名', description: '根据真实内容批量检查并重命名文件后再应用' }, monitor: { title: '文件夹监控', description: '监控文件夹，自动重命名新文件' }, activity: { title: '活动历史', description: '查看最近的重命名并在需要时撤销' }, statistics: { title: '统计', description: '查看重命名数量、文件夹监控占比、活动以及文件类型趋势' }, templates: { title: '模板', description: '为 AI 重命名和文件夹监控保存可复用的设置' }, tags: { title: '智能标签', description: '生成标签，让文件搜索更快' }, 'naming-blocks': { title: '命名块', description: '用 145+ 个现成的命名块从文件内容生成文件名' }, 'custom-ai-blocks': { title: '自定义 AI 块', description: '描述 AI 要提取的内容，并作为你自己的命名块复用' }, multilanguage: { title: '多语言', description: '生成 60 多种语言的文件名' }, 'custom-prompts': { title: '自定义提示词', description: '用自己的指令控制文件名生成' }, byok: { title: 'BYOK', description: '通过 BYOK 连接自己的 AI 服务商' }, 'offline-ai': { title: '离线 AI 重命名', description: '对支持的文件使用 Ollama 私有本地模型' } } },
    whyZush: { title: '为什么 Zush 优于通用重命名工具', titlePlatform: '为什么 Zush 适合 {os}', description: 'AI 批量重命名、自动文件夹监控、撤销、BYOK、离线 AI 和混合格式支持集中在一个桌面应用中', descriptionPlatform: '在 {os} 上提供原生体验、快速重命名、一次付费和更少干扰', nativeEyebrow: '桌面原生体验', nativeEyebrowPlatform: '{os} 原生体验', nativeTitle: '原生、快速、现代', nativeDescription: 'Zush 像真正的桌面应用一样：启动快、界面清爽，并且自然融入你的系统。', nativeDescriptionPlatform: 'Zush 像真正的 {os} 原生应用一样：启动快、界面清爽，并且自然融入你的系统。', pricingTrustItems: ['✨ 免费试用', '∞ 无限 PRO', '↩️ 14 天退款'], priceEyebrow: 'Reusable templates', priceTitle: 'One setup for every folder', priceDescription: 'Save naming rules for screenshots, expenses, music tracks, client notes, legal files, travel bookings, and monitored folders.', priceLabel: '11 built-in', speedEyebrow: '非常快', speedTitle: '几秒完成重命名', speedDescription: '整理文件只有在不打断工作时才会坚持下去。拖入文件、检查、应用，然后继续工作。', formatsEyebrow: '100+ 种支持格式', formatsTitle: '截图、PDF、照片、音频、文档和视频', formatsDescription: '支持 AVIF、RAW、Office 文件、EPUB 和 FB2 电子书、PDF、字幕、MP3、M4A、WAV、FLAC 和常见视频格式。', controlEyebrow: '命名块', controlTitle: '为专业工作而生的结构化文件名', controlDescription: '专业人士可以用契合自己工作的命名块自定义文件名模板。AI 会读取每个文件，并用你选择的细节（如客户、日期、发票号、地点或项目）填充这些块。', workflowSteps: ['摄影师：日期、客户、拍摄、场景', '医生：就诊类型、日期、记录类别', '会计：供应商、发票、周期'] },
  ...
  ar: {
    featureCards: {
      ...
      byok: { title: 'استخدم مفتاحك الخاص', description: 'اربط مفتاح API الخاص بك من Gemini أو OpenRouter أو OpenAI أو Claude لإعادة التسمية عبر السحابة؛ تشمل FREE ‏50 عملية مشتركة بين جميع الأوضاع، وPRO غير محدود. يتم حفظ المفاتيح محليا بأمان.' },
      offlineAi: { title: 'ذكاء اصطناعي محلي خاص', description: 'تعالج نماذج Ollama المحلية الملفات المدعومة على جهازك، وتعمل دون اتصال بعد الإعداد.' },
      ...
      bandTitle: 'اختر مكان تشغيل الذكاء الاصطناعي', bandSubtitle: 'استخدم Zush Cloud أو مزود الذكاء الاصطناعي الخاص بك أو التحليل المدعوم على الجهاز عبر Ollama.',
    ...
    showcase: {
      ...
      items: {
        ...
        'custom-ai-blocks': { title: 'كتل AI مخصصة', description: 'صف ما يجب أن يستخرجه الذكاء الاصطناعي وأعد استخدامه ككتلة تسمية خاصة بك' },
        ...
        byok: { title: 'BYOK', description: 'اربط مزود الذكاء الاصطناعي الخاص بك عبر BYOK' },
    ...
    whyZush: {
      ...
      formatsDescription: 'يدعم AVIF وRAW وملفات Office والكتب الإلكترونية EPUB وFB2 وPDF والترجمات وMP3 وM4A وWAV وFLAC وصيغ الفيديو الشائعة لإعادة تسمية الملفات حسب المحتوى في دفعة واحدة.',
...
const localizedWorkflows: Record<Exclude<Locale, 'en'>, HomeWorkflowsCopy> = {
  ...
  tr: {
    ...
    items: {
      screenshots: { title: 'Ekran görüntülerini yeniden adlandır', description: '"Ekran Görüntüsü 2026-07-03", ekranda ne olduğunu anlatan bir ada dönüşür.' },
      pdfs: { title: 'PDF’leri ve taramaları yeniden adlandır', description: 'Faturaları, sözleşmeleri ve taramaları belge içindeki metne göre adlandırın.' },
      photos: { title: 'Fotoğrafları yeniden adlandır', description: 'RAW, HEIC ve JPG dosyalarını konuya ve sahneye göre adlandırın.' },
      documents: { title: 'Belgeleri yeniden adlandır', description: 'Word, Excel, PowerPoint ve iWork dosyalarını konuya göre adlandırın.' },
      design: { title: 'Tasarım dosyalarını yeniden adlandır', description: 'Figma, Sketch, PSD ve dışa aktarılan dosyaları içeriklerine göre adlandırın.' },
      videos: { title: 'Videoları yeniden adlandır', description: 'Kayıtları ve klipleri karelere ve bağlama göre adlandırın.' },
      audio: { title: 'Ses dosyalarını yeniden adlandır', description: 'MP3, WAV ve sesli notları sese ve meta verilere göre adlandırın.' },
      organizer: { title: 'Dosyaları yapay zekâyla düzenle', description: 'İndirilenler ve karma klasörleri aranabilir adlarla düzenleyin.' },
      batch: { title: 'Dosyaları toplu yeniden adlandır', description: 'Yüzlerce dosyayı aynı anda, önizleme ve tek tıklamayla geri alma desteğiyle işleyin.' },
      offline: { title: 'Çevrimdışı yapay zekâ adlandırıcı', description: 'Ollama aracılığıyla yerel modeller; dosyalar cihazınızdan asla ayrılmaz.' },
    },
  },
  ja: {
...
const withLocalizedFileExamples = (
  ...
  details: DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>,
): DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'workflows' | 'faqItems' | 'showcaseSlides'>> => ({
  ...details,
...
const COPY: Record<Locale, LocaleCopy> = {
  en: base,
  de: localized({
    header: { features: 'Funktionen', reviews: 'Bewertungen', security: 'Cloud/Lokale KI', pricing: 'Preise', faq: 'FAQ', blog: 'Blog', buyPro: 'PRO kaufen', download: 'Herunterladen', downloadZush: 'Zush herunterladen', toggleTheme: 'Design wechseln', language: 'Sprache', menu: 'Menü', homeAria: 'Zur Startseite', skipToContent: 'Zum Inhalt springen' },
    ...
    home: {
      ...
      heroSubtitle: 'Benenne Dateien mit KI nach Inhalt um und wende deine eigenen Namensregeln an. Prüfe jeden Dateinamen, mache jeden Stapel rückgängig und wähle Cloud-KI oder Offline-KI.',
      heroHighlights: ['Benenne Dateien mit KI nach Inhalt um', 'deine eigenen Namensregeln'],
      buyPro: 'PRO kaufen',
      trustSignals: ['Kostenlos starten', 'Keine Registrierung', 'Keine Kreditkarte erforderlich'],
      heroModes: ['Erst prüfen', 'Eigene Regeln', 'Ein-Klick-Undo', 'Offline-KI', 'Cloud-KI'],
      featuresTitle: 'Dein Namenssystem, unterstützt durch KI',
      featuresDescription: 'Kombiniere Dateiinhalte, Metadaten, Daten, eigene Anweisungen und wiederverwendbare Bausteine zu Namen, die zu deiner Arbeitsweise passen. Zush schlägt vor — du prüfst und entscheidest.',
    ...
    seo: {
      '/': {
        title: 'KI-Dateiumbenenner für Mac & Windows — Zush',
        description:
          'Dateien nach Inhalt umbenennen mit Zush für Mac und Windows. Eigene Regeln für PDFs, Fotos, Video und Audio. Mit Vorschau und Undo. 50 Umbenennungen gratis.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: {
      ...localizedFeaturePages('Häufig gestellte Fragen', 'Verwandte Tools', 'Verwandte Anleitungen', [
        ...
        ['/rename-documents-with-ai', 'Dokumente mit KI umbenennen', 'Benenne EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV und E-Mails nach ihrem Inhalt.'],
      ...
      '/batch-rename-files': {
        ...
        faqItems: [
          ...
          },
          {
            ...
            answer: 'Nutze KI, wenn unterschiedliche Dateien Beschreibungen aus ihrem Inhalt brauchen. Für ein gemeinsames Präfix, eine Ersetzung oder eine Nummernfolge genügt oft ein Dateimanager oder ein regelbasiertes Werkzeug. Prüfe das Ergebnis vor dem Anwenden.',
          },
          {
  ...
  fr: localized({
    header: { features: 'Fonctions', reviews: 'Avis', security: 'IA cloud/locale', pricing: 'Tarifs', faq: 'FAQ', blog: 'Blog', buyPro: 'Acheter PRO', download: 'Télécharger', downloadZush: 'Télécharger Zush', toggleTheme: 'Changer le thème', language: 'Langue', menu: 'Menu', homeAria: 'Aller à l’accueil', skipToContent: 'Aller au contenu' },
    ...
    home: {
      ...
      heroSubtitle: 'Renommez les fichiers selon leur contenu avec l’IA et appliquez vos propres règles de nommage. Prévisualisez chaque nom, annulez n’importe quel lot et choisissez l’IA cloud ou hors ligne.',
      heroHighlights: ['Renommez les fichiers selon leur contenu avec l’IA', 'vos propres règles de nommage'],
      buyPro: 'Acheter PRO',
      trustSignals: ['Commencez gratuitement', 'Sans inscription', 'Sans carte bancaire'],
      heroModes: ['Aperçu d’abord', 'Règles sur mesure', 'Annulation en un clic', 'IA hors ligne', 'IA cloud'],
      featuresTitle: 'Votre système de nommage, propulsé par l’IA',
      featuresDescription: 'Combinez contenu, métadonnées, dates, instructions personnalisées et blocs réutilisables pour créer des noms adaptés à votre travail. Zush propose — vous vérifiez et décidez.',
    ...
    seo: {
      '/': {
        title: 'Renommeur de fichiers IA pour Mac et Windows — Zush',
        description:
          'Renommez vos fichiers par contenu avec Zush sur Mac et Windows. Règles pour PDF, photos, vidéo et audio, aperçu et annulation. 50 renommages gratuits.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('Questions fréquentes', 'Outils associés', 'Guides associés', [
      ...
      ['/rename-documents-with-ai', 'Renommer des documents avec l’IA', 'Renommez EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV et emails selon leur contenu.'],
  ...
  'pt-br': localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renomeie arquivos por conteúdo com IA e aplique suas próprias regras de nomenclatura. Veja cada nome, desfaça qualquer lote e escolha IA na nuvem ou IA offline.',
      heroHighlights: ['Renomeie arquivos por conteúdo com IA', 'suas próprias regras de nomenclatura'],
      buyPro: 'Comprar PRO',
      trustSignals: ['Comece grátis', 'Sem cadastro', 'Sem cartão de crédito'],
      heroModes: ['Prévia primeiro', 'Regras próprias', 'Desfazer em um clique', 'IA offline', 'IA na nuvem'],
      featuresTitle: 'Seu sistema de nomes, com IA',
      featuresDescription: 'Combine conteúdo, metadados, datas, instruções personalizadas e blocos reutilizáveis em nomes que seguem seu jeito de trabalhar. O Zush sugere — você revisa e decide.',
    ...
    seo: {
      '/': {
        title: 'Renomeador de arquivos com IA para Mac e Windows — Zush',
        description:
          'Renomeie arquivos pelo conteúdo com Zush no Mac e Windows. Regras para PDF, fotos, vídeo e áudio, prévia e desfazer. Experimente 50 renomeações grátis.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('Perguntas frequentes', 'Ferramentas relacionadas', 'Guias relacionados', [
      ...
      ['/rename-documents-with-ai', 'Renomear documentos com IA', 'Renomeie EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV e emails pelo conteúdo real.'],
  ...
  es: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renombra archivos por contenido con IA y aplica tus propias reglas de nomenclatura. Previsualiza cada nombre, deshaz cualquier lote y elige IA en la nube o IA sin conexión.',
      heroHighlights: ['Renombra archivos por contenido con IA', 'tus propias reglas de nomenclatura'],
      buyPro: 'Comprar PRO',
      trustSignals: ['Empieza gratis', 'Sin registro', 'Sin tarjeta de crédito'],
      heroModes: ['Vista previa', 'Reglas propias', 'Deshacer en un clic', 'IA sin conexión', 'IA en la nube'],
      featuresTitle: 'Tu sistema de nombres, impulsado por IA',
      featuresDescription: 'Combina contenido, metadatos, fechas, instrucciones personalizadas y bloques reutilizables en nombres que encajan con tu forma de trabajar. Zush propone — tú revisas y decides.',
    ...
    seo: {
      '/': {
        title: 'Renombrador de archivos con IA para Mac y Windows — Zush',
        description:
          'Renombra archivos por contenido con Zush en Mac y Windows. Reglas para PDF, fotos, vídeo y audio, vista previa y deshacer. Prueba 50 cambios gratis.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('Preguntas frecuentes', 'Herramientas relacionadas', 'Guías relacionadas', [
      ...
      ['/rename-documents-with-ai', 'Renombrar documentos con IA', 'Renombra EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV y emails por su contenido real.'],
  ...
  nl: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Hernoem bestanden op inhoud met AI en pas je eigen naamregels toe. Bekijk elke bestandsnaam, herstel elke batch en kies Cloud AI of Offline AI.',
      heroHighlights: ['Hernoem bestanden op inhoud met AI', 'je eigen naamregels'],
      buyPro: 'Koop PRO',
      trustSignals: ['Gratis aan de slag', 'Geen registratie', 'Geen creditcard nodig'],
      heroModes: ['Eerst bekijken', 'Eigen regels', 'Undo met één klik', 'Offline AI', 'Cloud-AI'],
      featuresTitle: 'Jouw naamsysteem, aangedreven door AI',
      featuresDescription: 'Combineer inhoud, metadata, datums, eigen instructies en herbruikbare blokken tot namen die bij jouw werkwijze passen. Zush stelt voor — jij bekijkt en beslist.',
    ...
    seo: {
      '/': {
        title: 'AI-bestandshernoemer voor Mac en Windows — Zush',
        description:
          'Hernoem bestanden op inhoud met Zush voor Mac en Windows. Regels voor pdf, foto, video en audio, met voorbeeld en herstel. Probeer 50 keer gratis.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('Veelgestelde vragen', 'Gerelateerde tools', 'Gerelateerde gidsen', [
      ...
      ['/rename-documents-with-ai', 'Documenten hernoemen met AI', 'Hernoem EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV en e-mails op basis van inhoud.'],
  ...
  it: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Rinomina i file in base al contenuto con l’IA e applica le tue regole di denominazione. Visualizza ogni nome, annulla qualsiasi batch e scegli IA cloud o IA offline.',
      heroHighlights: ['Rinomina i file in base al contenuto con l’IA', 'le tue regole di denominazione'],
      buyPro: 'Acquista PRO',
      trustSignals: ['Inizia gratis', 'Nessuna registrazione', 'Nessuna carta di credito richiesta'],
      heroModes: ['Prima l’anteprima', 'Regole personalizzate', 'Annulla con un clic', 'IA offline', 'IA cloud'],
      featuresTitle: 'Il tuo sistema di nomi, potenziato dall’IA',
      featuresDescription: 'Combina contenuto, metadati, date, istruzioni personalizzate e blocchi riutilizzabili in nomi adatti al tuo lavoro. Zush propone — tu controlli e decidi.',
    ...
    seo: {
      '/': {
        title: 'Rinomina file con IA per Mac e Windows — Zush',
        description:
          'Rinomina i file in base al contenuto con Zush su Mac e Windows. Regole per PDF, foto, video e audio, anteprima e annullamento. Prova 50 rinomine gratis.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('Domande frequenti', 'Strumenti correlati', 'Guide correlate', [
      ...
      ['/rename-documents-with-ai', 'Rinomina documenti con IA', 'Rinomina EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV ed email in base al contenuto.'],
  ...
  ja: localized({
    ...
    home: {
      heroTitle: 'ファイルリネーム\nMac・Windows対応',
      heroAccent: 'ファイルリネーム',
      heroSubtitle: 'AIで内容に基づいてファイル名を変更し、独自の命名ルールを適用できます。すべてのファイル名を確認し、任意のバッチを元に戻して、Cloud AIまたはオフラインAIを選べます。',
      heroHighlights: ['AIで内容に基づいてファイル名を変更', '独自の命名ルール'],
      buyPro: 'PROを購入',
      trustSignals: ['無料で始める', '登録不要', 'クレジットカード不要'],
      heroModes: ['先にプレビュー', 'カスタムルール', 'ワンクリックで元に戻す', 'オフラインAI', 'クラウドAI'],
      featuresTitle: 'AI でつくる、自分の命名システム',
      featuresDescription: 'ファイル内容、メタデータ、日付、カスタム指示、再利用可能なブロックを組み合わせ、作業に合う名前を作成。Zush が提案し、あなたが確認して決定します。',
    ...
    seo: {
      '/': {
        title: 'Mac・Windows 向け AI ファイルリネーム — Zush',
        description:
          'Zush は Mac と Windows でファイルを内容に基づいてリネーム。PDF、写真、動画、音声に独自ルールを適用し、プレビューと取り消しに対応。50 回まで無料。',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('よくある質問', '関連ツール', '関連ガイド', [
      ...
      ['/rename-documents-with-ai', 'AIで文書をリネーム', 'EPUB、FB2、DOCX、XLSX、PPTX、TXT、CSV、メールを内容に基づいてリネームします。'],
  ...
  ko: localized({
    ...
    home: {
      ...
      heroSubtitle: 'AI로 파일 내용을 읽어 이름을 바꾸고 나만의 이름 규칙을 적용하세요. 모든 파일명을 미리 보고, 일괄 작업을 되돌리며 Cloud AI 또는 오프라인 AI를 선택할 수 있습니다.',
      heroHighlights: ['AI로 파일 내용을 읽어 이름을 바꾸고', '나만의 이름 규칙'],
      buyPro: 'PRO 구매',
      trustSignals: ['무료로 시작하기', '회원가입 불필요', '카드 필요 없음'],
      heroModes: ['먼저 미리보기', '사용자 규칙', '한 번에 되돌리기', '오프라인 AI', '클라우드 AI'],
      featuresTitle: 'AI로 만드는 나만의 이름 규칙',
      featuresDescription: '파일 내용, 메타데이터, 날짜, 사용자 지침과 재사용 블록을 조합해 작업 방식에 맞는 이름을 만드세요. Zush가 제안하고, 사용자가 검토하고 결정합니다.',
    ...
    seo: {
      '/': {
        title: 'Mac·Windows용 AI 파일 이름 변경 — Zush',
        description:
          'Zush로 Mac과 Windows에서 파일 내용을 바탕으로 이름을 변경하세요. PDF, 사진, 영상, 오디오에 규칙을 적용하고 미리보기와 실행 취소를 사용하세요. 50회 무료.',
      },
      '/rename-pdf-with-ai': {
    ...
    featurePages: localizedFeaturePages('자주 묻는 질문', '관련 도구', '관련 가이드', [
      ...
      ['/rename-documents-with-ai', 'AI로 문서 이름 변경', 'EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV, 이메일을 실제 내용으로 이름 변경합니다.'],
  ...
  'zh-cn': localized({
    ...
    footer: {
      ...
      privacy: '隐私政策',
      refund: '退款政策',
      ...localizedFooterDetails['zh-cn'],
    },
    home: {
      heroTitle: '文件重命名工具\n适用于 Mac 和 Windows',
      heroAccent: '文件重命名工具',
      heroSubtitle: '使用 AI 按内容重命名，并应用你自己的命名规则。预览每个文件名、撤销任意批次，并可选择 Cloud AI 或离线 AI。',
      heroHighlights: ['使用 AI 按内容重命名', '你自己的命名规则'],
      buyPro: '购买 PRO',
      trustSignals: ['免费开始', '无需注册', '无需信用卡'],
      heroModes: ['先预览', '自定义规则', '一键撤销', '离线 AI', '云端 AI'],
      featuresTitle: '由 AI 驱动的专属命名系统',
      featuresDescription: '组合文件内容、元数据、日期、自定义指令和可复用模块，生成符合工作方式的名称。Zush 提供建议，由你审核并决定。',
    ...
    platforms: {
      mac: {
        ...
        ctaSubtitle: '设置命名规则，预览每项更改，并通过 Zush Cloud、自己的 AI 服务商或本地 AI 重命名 Finder 文件。',
        faqDescription: '关于 Zush for Mac 和产品功能的常见问题。',
        features: [
          '适用于 Mac 的文件重命名工具，用 AI 批量重命名截图、视频、PDF、照片和文档',
          '文件夹监控，自动处理新文件',
          '批量重命名并支持逐个重新生成',
          '自定义文件名和元数据标签提示词',
          '从 Activity 记录一键恢复',
          ...
          '60+ 语言和灵活日期格式',
          'BYOK 支持云端重命名；FREE 在所有模式间共享 50 次，PRO 无限制',
          '通过 Ollama 使用本地 AI；设置后可离线工作',
        ],
        faqs: [
      ...
      windows: {
        ...
        ctaSubtitle: '设置命名规则，预览每项更改，并通过 Zush Cloud、自己的 AI 服务商或本地 AI 重命名文件。',
        faqDescription: '关于 Zush for Windows 和产品功能的常见问题。',
        features: [
          '适用于 Windows 11 和 10 的文件重命名工具，用 AI 大量重命名截图、视频、PDF、照片和文档',
          '文件夹监控，自动处理新文件',
          '批量重命名并支持逐个重新生成',
          '自定义文件名和元数据标签提示词',
          '从 Activity 记录一键恢复',
    ...
    seo: {
      '/': {
        title: 'Mac 和 Windows AI 文件重命名工具 — Zush',
        description:
          '使用 Zush 在 Mac 和 Windows 上按内容重命名文件。为 PDF、照片、视频和音频设置命名规则，支持预览和撤销。免费试用 50 次重命名。',
      },
    ...
    featurePages: localizedFeaturePages('常见问题', '相关工具', '相关指南', [
      ...
      ['/rename-documents-with-ai', '用 AI 重命名文档', '根据实际内容重命名 EPUB、FB2、DOCX、XLSX、PPTX、TXT、CSV 和邮件文件。'],
  ...
  tr: localized({
    ...
    downloadMenu: localizedDownloadMenu.tr,
    footer: {
      description: 'Mac ve Windows için yapay zekâ dosya adlandırıcı ve toplu yeniden adlandırma aracı',
      product: 'Ürün',
      byFileType: 'Dosya türüne göre',
      resources: 'Kaynaklar',
      support: 'Destek',
      pricing: 'Fiyatlandırma',
      contactSupport: 'Destek ekibiyle iletişime geç',
      feedback: 'Özellik ve hata bildirimleri',
      terms: 'Kullanım koşulları',
      privacy: 'Gizlilik',
      refund: 'İade politikası',
      ...localizedFooterDetails.tr,
    },
    home: {
      heroTitle: 'Dosya Adlandırıcı\nMac ve Windows için',
      heroAccent: 'Dosya Adlandırıcı',
      heroSubtitle: 'Dosyaları içeriklerine göre AI ile adlandırın ve kendi adlandırma kurallarınızı uygulayın. Her dosya adını önizleyin, toplu işlemleri geri alın ve Cloud AI veya çevrimdışı AI’ı seçin.',
      heroHighlights: ['Dosyaları içeriklerine göre AI ile adlandırın', 'kendi adlandırma kurallarınızı'],
      buyPro: 'PRO satın al',
      trustSignals: ['Ücretsiz başlayın', 'Kayıt gerekmez', 'Kredi kartı gerekmez'],
      heroModes: ['Önce önizle', 'Özel kurallar', 'Tek tıkla geri al', 'Çevrimdışı AI', 'Bulut AI'],
      featuresTitle: 'Yapay zekâ destekli adlandırma sistemin',
      featuresDescription: 'Dosya içeriğini, meta verileri, tarihleri, özel talimatları ve yeniden kullanılabilir blokları çalışma şekline uyan adlarda birleştir. Zush önerir — sen inceler ve karar verirsin.',
      ...
      ...withLocalizedFileExamples('tr', localizedHomeDetails.tr),
    },
    pricing: {
      planName: 'Zush PRO 🌟',
    ...
    platforms: {
      mac: {
        ...
        heroSubtitle:
          'Seçtiğiniz ayrıntılardan Finder adları oluşturun. Her öneriyi uygulamadan önce görün, istediğiniz toplu işlemi geri alın veya desteklenen çevrimdışı AI’ı kullanın.',
        ctaTitle: 'Zush’u Mac’te ücretsiz deneyin',
        ctaSubtitle: 'Adlandırma kurallarını belirleyin, her değişikliği görün ve Finder dosyalarını Zush Cloud, kendi AI sağlayıcınız veya çevrimdışı AI ile yeniden adlandırın.',
        faqDescription: 'Mac için Zush ve ürün özellikleri hakkında sık sorulan sorular.',
        features: [
          'Ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve belgeleri yapay zekâyla toplu yeniden adlandıran Mac dosya adlandırıcı',
          'Yeni dosyalar ve düzenli temizlik için klasör izleme',
          'Her dosya için yeniden oluşturma seçeneğiyle toplu yeniden adlandırma',
          'Adlar ve meta veri etiketleri için özel istemler',
          'Etkinlik geçmişinden tek tıklamayla geri alma',
          'Apple Silicon ve Intel için yerel sürüm',
          '60’tan fazla dil ve esnek tarih biçimleri',
          'Kendi sağlayıcı anahtarınızla BYOK; FREE tüm modlarda ortak 50 işlem sunar, PRO sınırsızdır',
          'Ollama aracılığıyla Çevrimdışı Yapay Zekâ modu',
        ],
        faqs: [
          { question: 'Zush Apple Silicon’da çalışıyor mu?', answer: 'Evet. Zush, macOS 15 veya daha yeni sürüm kullanan Apple Silicon ve Intel Mac’lerde yerel olarak çalışır.' },
          { question: 'Uygulama Apple tarafından noter onaylı mı?', answer: 'Evet. .dmg kodla imzalanmış ve noter onaylıdır; bu nedenle Gatekeeper desteklenen macOS sürümlerinde uygulamayı normal şekilde açar.' },
          { question: 'Zush’u çevrimdışı kullanabilir miyim?', answer: 'Evet. Tüm planlardaki kullanıcılar Ollama’nın özel yerel modeliyle Çevrimdışı Yapay Zekâ modunu etkinleştirebilir. FREE tüm modlarda ortak 50 işlem sunar; PRO limiti kaldırır.' },
        ],
      },
      windows: {
        ...
        heroSubtitle:
          'Seçtiğiniz ayrıntılardan Dosya Gezgini adları oluşturun. Her öneriyi uygulamadan önce görün, istediğiniz toplu işlemi geri alın veya desteklenen çevrimdışı AI’ı kullanın.',
        ctaTitle: 'Zush’u Windows’ta ücretsiz deneyin',
        ctaSubtitle: 'Adlandırma kurallarını belirleyin, her değişikliği görün ve dosyaları Zush Cloud, kendi AI sağlayıcınız veya çevrimdışı AI ile yeniden adlandırın.',
        faqDescription: 'Windows için Zush ve ürün özellikleri hakkında sık sorulan sorular.',
        features: [
          'Ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve belgeleri yapay zekâyla toplu yeniden adlandıran Windows 11 ve 10 dosya adlandırıcı',
          'Yeni dosyalar ve düzenli temizlik için klasör izleme',
          'Her dosya için yeniden oluşturma seçeneğiyle toplu yeniden adlandırma',
          'Adlar ve meta veri etiketleri için özel istemler',
          'Etkinlik geçmişinden tek tıklamayla geri alma',
          'Otomatik güncellemelerle Microsoft Store kurulumu',
          '60’tan fazla dil ve esnek tarih biçimleri',
          'Kendi sağlayıcı anahtarınızla BYOK; FREE tüm modlarda ortak 50 işlem sunar, PRO sınırsızdır',
          'Ollama aracılığıyla Çevrimdışı Yapay Zekâ modu',
        ],
    ...
    seo: {
      '/': {
        title: 'Mac ve Windows için AI Dosya Adlandırıcı — Zush',
        description:
          'Mac ve Windows’ta Zush ile dosyaları içeriğine göre adlandırın. PDF, fotoğraf, video ve ses için kurallar, önizleme ve geri alma. 50 adlandırma ücretsiz.',
      },
      '/mac': {
        title: 'Mac Dosya Adlandırıcı: Yapay Zekâyla Toplu Yeniden Adlandırma | Zush',
        description: 'Mac’te dosyaları içeriklerine göre yapay zekâyla toplu yeniden adlandırın: ekran görüntüleri, PDF’ler, fotoğraflar, videolar, sesler, tasarım dosyaları ve belgeler.',
      },
      '/windows': {
        title: 'Windows Dosya Adlandırıcı: Yapay Zekâyla Toplu Yeniden Adlandırma | Zush',
    ...
    featurePages: localizedFeaturePages('Sık sorulan sorular', 'İlgili araçlar', 'İlgili rehberler', [
      { question: 'Yeniden adlandırmayı geri alabilir miyim?', answer: 'Evet. Zush yeniden adlandırma geçmişini saklar; böylece dosyaları tek tıklamayla orijinal adlarına döndürebilirsiniz.' },
    ], [
      ...
      ['/rename-documents-with-ai', 'Belgeleri yapay zekâyla yeniden adlandırın', 'EPUB, FB2, DOCX, XLSX, PPTX, TXT, CSV ve e-posta dosyalarını gerçek içeriklerine göre adlandırın.'],
  ...
  ar: localized({
    ...
    home: {
      ...
      heroSubtitle: 'أعد تسمية الملفات حسب المحتوى بالذكاء الاصطناعي وطبّق قواعد التسمية الخاصة بك. عاين كل اسم وتراجع عن أي دفعة واختر Cloud AI أو الذكاء الاصطناعي دون اتصال.',
      heroHighlights: ['أعد تسمية الملفات حسب المحتوى بالذكاء الاصطناعي', 'قواعد التسمية الخاصة بك'],
      buyPro: 'شراء PRO',
      trustSignals: ['ابدأ مجانًا', 'لا يلزم التسجيل', 'لا تحتاج إلى بطاقة ائتمان'],
      heroModes: ['المعاينة أولًا', 'قواعد مخصصة', 'تراجع بنقرة واحدة', 'ذكاء اصطناعي دون اتصال', 'الذكاء الاصطناعي السحابي'],
      featuresTitle: 'نظام التسمية الخاص بك، مدعوم بالذكاء الاصطناعي',
      featuresDescription: 'اجمع محتوى الملفات والبيانات الوصفية والتواريخ والتعليمات المخصصة والكتل القابلة لإعادة الاستخدام في أسماء تناسب طريقة عملك. يقترح Zush — وأنت تراجع وتقرر.',
    ...
    platforms: {
      mac: {
        ...
        heroSubtitle:
          'أنشئ أسماء Finder من التفاصيل التي تختارها. عاين كل اقتراح قبل التطبيق، وتراجع عن أي دفعة، أو استخدم الذكاء الاصطناعي المدعوم دون اتصال.',
        ctaTitle: 'جرّب Zush مجانا على Mac',
        ctaSubtitle: 'حدّد قواعد التسمية وعاين كل تغيير وأعد تسمية ملفات Finder عبر Zush Cloud أو مزودك الخاص أو الذكاء الاصطناعي دون اتصال.',
        faqDescription: 'كل ما تحتاج إلى معرفته عن Zush لنظام Mac وبقية المنتج.',
        features: [
          'أداة إعادة تسمية ملفات لنظام Mac مع إعادة تسمية بالدفعات بالذكاء الاصطناعي للقطات الشاشة والفيديو وPDF والصور والمستندات',
        ...
        faqs: [
          ...
          { question: 'هل يمكن استخدام Zush دون اتصال؟', answer: 'نعم. يمكن للمستخدمين في جميع الخطط تفعيل وضع الذكاء الاصطناعي دون اتصال باستخدام نماذج محلية خاصة عبر Ollama.' },
        ],
      },
      windows: {
        ...
        heroSubtitle:
          'أنشئ أسماء File Explorer من التفاصيل التي تختارها. عاين كل اقتراح قبل التطبيق، وتراجع عن أي دفعة، أو استخدم الذكاء الاصطناعي المدعوم دون اتصال.',
        ctaTitle: 'جرّب Zush مجانا على Windows',
        ctaSubtitle: 'حدّد قواعد التسمية وعاين كل تغيير وأعد تسمية الملفات عبر Zush Cloud أو مزودك الخاص أو الذكاء الاصطناعي دون اتصال.',
        faqDescription: 'كل ما تحتاج إلى معرفته عن Zush لنظام Windows وبقية المنتج.',
        features: [
          'أداة إعادة تسمية ملفات لنظامي Windows 11 و10 مع إعادة تسمية جماعية بالذكاء الاصطناعي للقطات الشاشة والفيديو وPDF والصور والمستندات',
          'مراقبة المجلدات للملفات الجديدة والتنظيف المتكرر',
          'إعادة تسمية دفعات مع إعادة توليد لكل ملف',
          'تعليمات مخصصة للأسماء ووسوم البيانات الوصفية',
          'تراجع بنقرة واحدة من سجل النشاط',
    ...
    seo: {
      '/': {
        title: 'إعادة تسمية الملفات بالذكاء الاصطناعي لـ Mac وWindows — Zush',
        description:
          'أعد تسمية الملفات حسب المحتوى مع Zush على Mac وWindows. قواعد لملفات PDF والصور والفيديو والصوت، مع معاينة وتراجع. جرّب 50 إعادة تسمية مجانًا.',
      },
      '/mac': {
        title: 'أداة إعادة تسمية الملفات لنظام Mac: إعادة تسمية بالدفعات بالذكاء الاصطناعي | Zush',
        description: 'أداة إعادة تسمية ملفات لنظام Mac تعيد تسمية الملفات بالدفعات حسب المحتوى باستخدام الذكاء الاصطناعي: لقطات الشاشة وPDF والصور والفيديو والصوت والتصميم والمستندات.',
      },
      '/windows': {
    ...
    featurePages: localizedFeaturePages('الأسئلة الشائعة', 'أدوات ذات صلة', 'أدلة ذات صلة', [
      ...
      ['/rename-documents-with-ai', 'إعادة تسمية المستندات بالذكاء الاصطناعي', 'أعد تسمية EPUB وFB2 وDOCX وXLSX وPPTX وTXT وCSV وملفات البريد بحسب محتواها الفعلي.'],
