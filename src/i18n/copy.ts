...
const EN_COPY: LocaleCopy = {
  ...
  footer: {
    description: 'AI file renamer with templates, Naming Blocks, audio support, and batch rename for Mac and Windows',
    product: 'Product',
  ...
  home: {
    ...
    downloadSubtitle: 'Batch rename files, monitor folders, and rename screenshots, PDFs, photos, audio, videos, and documents by content.',
  ...
  platforms: {
    mac: {
      ...
      softwareDescription:
        'AI file renamer and batch rename tool for macOS. Rename screenshots, audio, videos, PDFs, photos, and documents with templates, naming blocks, cloud AI, or Offline AI mode via Ollama.',
      heroTitle: 'AI File Renamer & Batch Rename Tool for Mac',
      heroSubtitle:
        'Batch rename screenshots, audio, videos, PDFs, photos, and documents on macOS with AI. Use templates and naming blocks, watch folders automatically, or use Offline AI mode with private local models via Ollama.',
      ctaTitle: 'Try Zush free on Mac',
      ctaSubtitle: 'Install the signed macOS app and start renaming screenshots, audio, videos, PDFs, photos, and documents in minutes.',
      faqDescription: 'Everything you need to know about Zush for Mac and the rest of the product.',
      features: [
        'AI-powered renaming for screenshots, audio, videos, PDFs, photos, documents',
    ...
    windows: {
      ...
      softwareDescription:
        'AI file renamer and batch rename tool for Windows. Rename screenshots, audio, videos, PDFs, photos, and documents with templates, naming blocks, and descriptive names.',
      heroTitle: 'AI File Renamer & Batch Rename Tool for Windows',
      heroSubtitle:
        'Batch rename screenshots, audio, videos, PDFs, photos, and documents on Windows with AI. Use templates and naming blocks, watch folders automatically with a Microsoft Store install, free to try with no signup.',
      ctaTitle: 'Try Zush free on Windows',
      ctaSubtitle: 'Open the Microsoft Store and start renaming screenshots, audio, videos, PDFs, photos, and documents with the full Windows build.',
  ...
  seo: {
    '/': {
      ...
      description:
        'Batch rename files with AI, watch folders automatically, and rename screenshots, PDFs, photos, audio, videos, and documents by content. 50 free files.',
    },
  },
};
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  de: {
    ...
    faqItems: [{ question: 'Was ist Zush?', answer: 'Zush ist eine KI-Desktop-App für Mac und Windows, die Dateien automatisch nach Inhalt umbenennt.' }, { question: 'Welche Dateiformate werden unterstützt?', answer: 'Zush unterstützt Bilder, Audio, Videos, Screenshots, PDFs, Dokumente, Tabellen, Präsentationen, Textdateien, CSV und mehr.' }, { question: 'Kann ich eine Umbenennung rückgängig machen?', answer: 'Ja. Zush speichert den Verlauf, damit du ursprüngliche Dateinamen mit einem Klick wiederherstellen kannst.' }, { question: 'Funktioniert Zush offline?', answer: 'Cloud-Verarbeitung benötigt Internet. PRO-Nutzer können Offline-KI mit lokalen Ollama-Modellen verwenden.' }, { question: 'Wie funktioniert der Preis?', answer: 'Zush PRO ist ein Einmalkauf ohne Abos oder versteckte Monatsgebühren.' }],
  },
  fr: {
    featureCards: {
  ...
  hi: {
    ...
    whyZush: {
      ...
      formatsEyebrow: '98 समर्थित फॉर्मेट',
