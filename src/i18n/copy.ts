...
const localizedFooterDetails: Record<Exclude<Locale, 'en'>, FooterVisibleCopy> = {
  ...
  hi: {
    ...
    designedWith: 'के साथ',
    productLinks: {
      aiFileRenamer: 'AI फ़ाइल नाम बदलने वाला टूल',
      aiImageRenamer: 'AI इमेज नाम बदलने वाला टूल',
      batchRenameFiles: 'कई फ़ाइलों के नाम एक साथ बदलें',
      autoRenameFiles: 'फ़ाइलों के नाम अपने-आप बदलें',
      mac: 'Mac के लिए Zush',
...
export const COPY: Record<Locale, LocaleCopy> = {
  ...
  hi: localized({
    ...
    featurePages: localizedFeaturePages('अक्सर पूछे जाने वाले सवाल', 'संबंधित टूल', 'संबंधित गाइड', [
      ...
      ['/ai-file-renamer', 'AI फ़ाइल नाम-बदलाव टूल', 'स्क्रीनशॉट, PDF, दस्तावेज़ और फ़ोटो को खोजने लायक AI नाम दें।'],
      ['/auto-rename-files', 'AI से फ़ाइलों के नाम अपने-आप बदलें', 'फ़ोल्डर देखें और Zush को नए स्क्रीनशॉट, डाउनलोड, एक्सपोर्ट और दस्तावेज़ों के नाम अपने-आप बदलने दें।'],
      ['/batch-rename-files', 'AI से कई फ़ाइलों के नाम एक साथ बदलें', 'कई फ़ाइलों को स्पष्ट AI नाम, प्रीव्यू नियंत्रण और एक-क्लिक वापसी के साथ एक बार में नाम दें।'],
      ['/ai-image-renamer', 'AI इमेज नाम-बदलाव टूल', 'इमेज, स्क्रीनशॉट, mockup और फ़ोटो को AI vision और खोजने लायक फ़ाइल नामों से नाम दें।'],
