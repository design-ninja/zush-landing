...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  nl: {
    ...
    videos: { title: 'Maak een tour door Zush', titleAccent: 'Zush', description: 'Eén korte demo per functie — klik op een tab om het in actie te zien', playDemo: 'Demo afspelen', switchTo: 'Wissel naar', items: { 'batch-rename': { title: 'AI-bulkhernoemen', description: 'Hernoem meerdere bestanden op echte inhoud voordat je toepast' }, monitor: { title: 'Folders Monitor', description: 'Bewaak mappen en hernoem nieuwe bestanden' }, tags: { title: 'Slimme tags', description: 'Genereer tags voor sneller zoeken' }, naming: { title: 'Naming Blocks', description: 'Maak herbruikbare namen met 145+ blokken' }, 'naming-blocks': { title: 'Naming Blocks', description: 'Bouw bestandsnamen op uit je bestandsinhoud met 145+ kant-en-klare blokken' }, multilanguage: { title: 'Meertalig', description: 'Genereer namen in meer dan 60 talen' }, 'custom-prompts': { title: 'Eigen prompts', description: 'Stuur naamgeneratie met eigen instructies' }, byok: { title: 'BYOK', description: 'Koppel je AI-provider voor onbeperkt hernoemen' }, 'offline-ai': { title: 'Offline AI-hernoemen', description: 'Gebruik private lokale modellen via Ollama voor ondersteunde bestanden' }, activity: { title: 'Activiteitsgeschiedenis', description: 'Bekijk recente hernoemingen en draai wijzigingen terug' } } },
    whyZush: { title: 'Waarom Zush wint van generieke hernoemtools', titlePlatform: 'Waarom Zush wint op {os}', description: 'AI-bulkhernoemen, automatische mapbewaking, herstel, BYOK, offline AI en gemengde formaten in één desktopapp', descriptionPlatform: 'Native gevoel, snel hernoemen, eenmalige prijs en minder keuzes op {os}', nativeEyebrow: 'Desktop-native gevoel', nativeEyebrowPlatform: '{os}-native gevoel', nativeTitle: 'Native, snel en modern', nativeDescription: 'Zush voelt als een echte desktopapp: snel open, schoon in gebruik en passend bij je systeem.', nativeDescriptionPlatform: 'Zush voelt als een echte native {os}-app: snel open, schoon in gebruik en passend bij je systeem.', pricingTrustItems: ['✨ Gratis proberen', '💵 Eenmalige optie', '↩️ 14 dagen terugbetaling'], priceEyebrow: 'Reusable templates', priceTitle: 'One setup for every folder', priceDescription: 'Save naming rules for screenshots, expenses, music tracks, client notes, legal files, travel bookings, and monitored folders.', priceLabel: '11 built-in', speedEyebrow: 'Supersnel', speedTitle: 'Hernoemen in seconden', speedDescription: 'Opruimen werkt alleen als het je werk niet stoort. Sleep bestanden, controleer, pas toe en ga door.', formatsEyebrow: '100+ ondersteunde formaten', formatsTitle: 'Screenshots, PDFs, foto’s, audio, documenten en video’s', formatsDescription: 'Ondersteunt AVIF, RAW, Office-bestanden, PDFs, ondertitels, MP3, M4A, WAV, FLAC en gangbare videoformaten.', controlEyebrow: 'Lage-risico automatisering', controlTitle: 'Bulk hernoemen, mappen bewaken, veilig herstellen', controlDescription: 'Gebruik Zush als batch file renamer voor oude stapels, automatische hernoemer voor nieuwe mappen en laag-risico workflow met volledige geschiedenis.', workflowSteps: ['Oude stapels hernoemen', 'Nieuwe mappen bewaken', 'Uit geschiedenis herstellen'] },
  ...
  hi: {
    ...
    videos: {
      ...
      items: {
        ...
        monitor: { title: 'Folders Monitor', description: 'Folders watch करें और नई files auto rename करें' },
    ...
    whyZush: {
      ...
      pricingTrustItems: ['✨ Free try करें', '🧩 145+ Naming Blocks', '↩️ 14-day refund'],
      priceEyebrow: 'Reusable templates',
  ...
  ar: {
    ...
    videos: {
      ...
      items: {
        ...
        monitor: { title: 'Folders Monitor', description: 'راقب المجلدات وأعد تسمية الملفات الجديدة تلقائيا' },
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  de: localized({
    ...
    home: {
      ...
      buyPro: 'PRO kaufen 🌟',
      trustSignals: ['✨ Kostenlos testen', '💳 Keine Kreditkarte', '💵 Einmalkauf möglich'],
      featuresTitle: 'Stapelumbenennung, Templates, Namensbausteine und Audio',
  ...
  fr: localized({
    ...
    home: {
      ...
      buyPro: 'Acheter PRO 🌟',
      trustSignals: ['✨ Essai gratuit', '💳 Sans carte bancaire', '💵 Achat unique possible'],
      featuresTitle: 'Renommage par lot, modèles, blocs de nommage et audio',
  ...
  'pt-br': localized({
    ...
    home: {
      ...
      buyPro: 'Comprar PRO 🌟',
      trustSignals: ['✨ Teste grátis', '💳 Sem cartão', '💵 Compra única disponível'],
      featuresTitle: 'Renomeação em lote, modelos, blocos de nomes e áudio',
  ...
  es: localized({
    ...
    home: {
      ...
      buyPro: 'Comprar PRO 🌟',
      trustSignals: ['✨ Prueba gratis', '💳 Sin tarjeta', '💵 Compra única disponible'],
      featuresTitle: 'Renombrado por lotes, plantillas, bloques de nombres y audio',
  ...
  nl: localized({
    ...
    home: {
      ...
      buyPro: 'Koop PRO 🌟',
      trustSignals: ['✨ Gratis proberen', '💳 Geen creditcard', '💵 Eenmalige optie'],
      featuresTitle: 'Bulk hernoemen, templates, Naming Blocks en audio',
  ...
  it: localized({
    ...
    home: {
      ...
      buyPro: 'Acquista PRO 🌟',
      trustSignals: ['✨ Prova gratis', '💳 Senza carta', '💵 Acquisto unico disponibile'],
      featuresTitle: 'Rinomina in batch, modelli, blocchi di nomi e audio',
  ...
  ja: localized({
    ...
    home: {
      ...
      buyPro: 'PROを購入 🌟',
      trustSignals: ['✨ 無料で試せる', '💳 カード不要', '💵 買い切りあり'],
      featuresTitle: '一括リネーム、テンプレート、命名ブロック、音声対応',
  ...
  ko: localized({
    ...
    home: {
      ...
      buyPro: 'PRO 구매 🌟',
      trustSignals: ['✨ 무료 체험', '💳 카드 불필요', '💵 일회성 옵션'],
      featuresTitle: '일괄 이름 변경, 템플릿, Naming Blocks, 오디오 지원',
  ...
  'zh-cn': localized({
    ...
    home: {
      ...
      buyPro: '购买 PRO 🌟',
      trustSignals: ['✨ 免费试用', '💳 无需信用卡', '💵 可一次性购买'],
      featuresTitle: '批量重命名、模板、命名块和音频支持',
  ...
  hi: localized({
    ...
    home: {
      ...
      featuresTitle: 'Batch rename, templates, Naming Blocks और audio support',
  ...
  ar: localized({
    ...
    home: {
      ...
      featuresTitle: 'إعادة تسمية بالدفعات، القوالب، كتل التسمية، ودعم الصوت',
