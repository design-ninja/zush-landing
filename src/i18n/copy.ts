...
const localizedFullHomeFaqItems: Partial<Record<Exclude<Locale, 'en'>, FAQCopyItem[]>> = {
  ...
  tr: [
    ...
    { question: 'Ücretlendirme nasıl çalışır?', answer: 'Zush PRO iki plan sunar: ayda 8 USD Monthly veya tek seferlik 38 USD One-Time. Her ikisi de sınırsız PRO, BYOK ve Çevrimdışı Yapay Zekâ’nın kilidini açar.' },
    { question: 'BYOK (Bring Your Own Key) nedir?', answer: 'BYOK, PRO kullanıcılarının kendi Gemini, Groq, OpenAI veya Claude API anahtarlarını bağlayarak sınırsız bulut yeniden adlandırma yapmasını sağlar. Anahtar yerel ve güvenli depolamada tutulur.' },
    { question: 'Monthly ile One-Time arasındaki fark nedir?', answer: 'Monthly plan ayda 8 USD’dir ve esnektir. One-Time plan 38 USD’dir ve ömür boyu erişim sağlar. Her ikisi de sınırsız PRO, BYOK ve Çevrimdışı Yapay Zekâ’yı açar.' },
    ...
    { question: 'Uygulama çevrimdışı çalışır mı?', answer: 'Bulut işleme için internet gerekir. PRO kullanıcıları Ollama ve uyumlu bir model kurduktan sonra Çevrimdışı Yapay Zekâ’yı etkinleştirebilir.' },
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  tr: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Zush PRO’ya dâhil',
      proDescription: 'Her PRO planı Çevrimdışı Yapay Zekâ’yı açar. Ollama ve yerel model ayrıca kurulur.',
      closeLabel: 'Kapat',
    },
    showcase: {
      ...
      items: {
        ...
        byok: { title: 'BYOK', description: 'Sınırsız yeniden adlandırma için kendi yapay zekâ sağlayıcınızı bağlayın' },
    ...
    platforms: {
      mac: {
        ...
        features: [
          ...
          'Sınırsız bulut yeniden adlandırma için BYOK',
        ...
        faqs: [
          ...
          { question: 'Zush’u çevrimdışı kullanabilir miyim?', answer: 'Evet. PRO kullanıcıları Ollama’nın özel yerel modeliyle Çevrimdışı Yapay Zekâ modunu etkinleştirebilir.' },
        ],
      },
      windows: {
