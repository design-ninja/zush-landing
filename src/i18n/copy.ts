...
const localizedFullHomeFaqItems: Partial<Record<Exclude<Locale, 'en'>, FAQCopyItem[]>> = {
  de: [
    ...
    { question: 'Was ist BYOK (Bring Your Own Key)?', answer: 'BYOK erlaubt Nutzern aller Pläne, eigene API-Schlüssel von Gemini, Groq, OpenAI oder Claude zu verbinden. FREE umfasst 50 Umbenennungen in allen Modi; PRO entfernt das Limit. Der Schlüssel wird lokal sicher gespeichert.' },
  ...
  fr: [
    ...
    { question: 'Qu’est-ce que BYOK (Bring Your Own Key) ?', answer: 'BYOK permet aux utilisateurs de toutes les offres de connecter leur clé Gemini, Groq, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité. La clé est stockée localement de façon sécurisée.' },
  ...
  'pt-br': [
    ...
    { question: 'O que é BYOK (Bring Your Own Key)?', answer: 'BYOK permite conectar sua própria chave Gemini, Groq, OpenAI ou Claude para renomeações cloud; o FREE inclui 50 entre todos os modos e o PRO é ilimitado. A chave fica armazenada localmente com segurança.' },
  ...
  es: [
    ...
    { question: '¿Qué es BYOK (Bring Your Own Key)?', answer: 'BYOK permite conectar tu propia clave de Gemini, Groq, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado. La clave se guarda localmente de forma segura.' },
  ...
  nl: [
    ...
    { question: 'Wat is BYOK (Bring Your Own Key)?', answer: 'BYOK laat gebruikers van elk abonnement hun eigen Gemini-, Groq-, OpenAI- of Claude-sleutel koppelen voor cloudhernoemen; FREE bevat 50 voor alle modi en PRO is onbeperkt. De sleutel wordt lokaal veilig opgeslagen.' },
  ...
  it: [
    ...
    { question: 'Cos’è BYOK (Bring Your Own Key)?', answer: 'BYOK consente agli utenti di tutti i piani di collegare una chiave Gemini, Groq, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato. La chiave è salvata localmente in modo sicuro.' },
  ...
  ja: [
    ...
    { question: 'BYOK（Bring Your Own Key）とは？', answer: 'すべてのプランのユーザーが Gemini、Groq、OpenAI、Claude の自分の API キーを接続し、クラウドリネームを利用でき、FREE は全モード共通 50 回、PRO は無制限となる機能です。キーはローカルに安全に保存されます。' },
  ...
  ko: [
    ...
    { question: 'BYOK(Bring Your Own Key)이란 무엇인가요?', answer: '모든 플랜의 사용자가 Gemini, Groq, OpenAI, Claude API 키를 연결해 클라우드 이름 변경을 사용하며 FREE는 모든 모드에서 공통 50회, PRO는 무제한인 기능입니다. 키는 로컬에 안전하게 저장됩니다.' },
  ...
  tr: [
    ...
    { question: 'BYOK (Bring Your Own Key) nedir?', answer: 'BYOK, tüm planlardaki kullanıcıların kendi Gemini, Groq, OpenAI veya Claude API anahtarlarını bağlayarak bulut yeniden adlandırmayı kullanmasını sağlar. FREE tüm modlarda ortak 50 işlem sunar; PRO limiti kaldırır. Anahtar yerel ve güvenli depolamada tutulur.' },
  ...
  ar: [
    ...
    { question: 'ما هو BYOK (Bring Your Own Key)؟', answer: 'يتيح BYOK للمستخدمين في جميع الخطط ربط مفاتيح Gemini أو Groq أو OpenAI أو Claude الخاصة بهم لإعادة التسمية عبر السحابة؛ تشمل FREE ‏50 عملية مشتركة بين جميع الأوضاع، وPRO غير محدود. يتم تخزين المفتاح محليا وبشكل آمن.' },
...
const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    heroSubtitle:
      'Rename files by content with AI, then shape every filename with your own rules. Preview each suggestion, undo any batch, and choose between Cloud AI, BYOK, or Offline AI.',
    heroHighlights: ['Rename files by content with AI', 'your own rules'],
    buyPro: 'Buy PRO',
    trustSignals: ['Get started for free', 'No registration', 'No credit card required'],
    heroModes: ['Preview first', 'Custom rules', 'One-click undo', 'Offline AI'],
    ...
    offlineAiModal: {
      ...
      description: 'Offline AI is an optional mode. It runs a local Ollama model on your Mac or Windows PC — no cloud involved.',
      points: [
      ...
      proDescription: 'Free includes 50 renames across Cloud AI, BYOK, and Offline AI. PRO removes the limit. Ollama and a local model are installed separately.',
      closeLabel: 'Close',
    },
    showcase: {
  ...
  pricing: {
    ...
    features: [
      { title: 'Unlimited AI Renames', desc: 'Remove the 50-rename limit across Cloud AI, BYOK, and Offline AI' },
    ],
  ...
  platforms: {
    mac: {
      ...
      softwareDescription:
        'Zush is an AI file renamer for Mac that builds filenames from content, metadata, dates, custom prompts, and reusable naming rules. Preview every change, undo any batch, or use Offline AI with Ollama.',
      heroTitle: 'AI File Renamer for Mac',
      heroSubtitle:
        'Build Finder filenames from the details you choose. Preview every suggestion, apply changes when you are ready, undo any batch, or keep supported analysis on-device with Offline AI.',
      ctaTitle: 'Try Zush free on Mac',
      ctaSubtitle: 'Set your naming rules, preview every change, and rename Finder files with Zush Cloud, your own AI provider, or Offline AI.',
      ...
      faqs: [
        ...
        { question: 'Can I use Zush offline?', answer: 'Yes. Users on every plan can enable Offline AI mode with private local models via Ollama. Free includes 50 renames across all AI modes; PRO removes the limit.' },
      ],
    },
    windows: {
...
const localizedPlatforms: Record<Exclude<Locale, 'en' | 'zh-cn' | 'tr' | 'ar'>, LocaleCopy['platforms']> = {
  de: {
    mac: {
      ...
      softwareDescription: 'KI-Dateiumbenenner für Mac mit eigenen Namensregeln aus Inhalt, Metadaten, Daten und wiederverwendbaren Bausteinen. Prüfe jede Änderung, nutze Undo oder Offline-KI.',
      heroTitle: 'Dateiumbenenner für Mac',
      heroSubtitle: 'Erstelle Finder-Dateinamen aus den Details, die du auswählst. Prüfe jeden Vorschlag, wende Änderungen erst dann an, nutze Undo oder unterstützte Offline-KI.',
      ctaTitle: 'Zush kostenlos auf Mac testen',
      ctaSubtitle: 'Lege deine Namensregeln fest, prüfe jede Änderung und benenne Finder-Dateien mit Zush Cloud, deinem KI-Anbieter oder Offline-KI um.',
    ...
    windows: {
      ...
      softwareDescription: 'KI-Dateiumbenenner für Windows mit eigenen Namensregeln aus Inhalt, Metadaten, Daten und wiederverwendbaren Bausteinen. Prüfe jede Änderung, nutze Undo oder Offline-KI.',
      heroTitle: 'Dateiumbenenner für Windows',
      heroSubtitle: 'Erstelle Dateinamen für den Datei-Explorer aus den Details, die du auswählst. Prüfe jeden Vorschlag, wende Änderungen erst dann an, nutze Undo oder unterstützte Offline-KI.',
      ctaTitle: 'Zush kostenlos auf Windows testen',
      ctaSubtitle: 'Lege deine Namensregeln fest, prüfe jede Änderung und benenne Dateien mit Zush Cloud, deinem KI-Anbieter oder Offline-KI um.',
  ...
  fr: {
    mac: {
      ...
      softwareDescription: 'Renommeur de fichiers IA pour Mac avec règles personnalisées basées sur le contenu, les métadonnées, les dates et des blocs réutilisables. Aperçu, annulation et IA hors ligne.',
      heroTitle: 'Renommeur de fichiers pour Mac',
      heroSubtitle: 'Créez des noms Finder avec les détails que vous choisissez. Prévisualisez chaque proposition, appliquez quand vous êtes prêt, annulez un lot ou utilisez l’IA hors ligne.',
      ctaTitle: 'Essayez Zush gratuitement sur Mac',
      ctaSubtitle: 'Définissez vos règles, prévisualisez chaque changement et renommez dans Finder avec Zush Cloud, votre fournisseur d’IA ou l’IA hors ligne.',
    ...
    windows: {
      ...
      softwareDescription: 'Renommeur de fichiers IA pour Windows avec règles personnalisées basées sur le contenu, les métadonnées, les dates et des blocs réutilisables. Aperçu, annulation et IA hors ligne.',
      heroTitle: 'Renommeur de fichiers pour Windows',
      heroSubtitle: 'Créez des noms pour l’Explorateur avec les détails que vous choisissez. Prévisualisez chaque proposition, appliquez quand vous êtes prêt, annulez un lot ou utilisez l’IA hors ligne.',
      ctaTitle: 'Essayez Zush gratuitement sur Windows',
      ctaSubtitle: 'Définissez vos règles, prévisualisez chaque changement et renommez dans l’Explorateur avec Zush Cloud, votre fournisseur d’IA ou l’IA hors ligne.',
  ...
  'pt-br': {
    mac: {
      ...
      softwareDescription: 'Renomeador de arquivos com IA para Mac com regras próprias baseadas em conteúdo, metadados, datas e blocos reutilizáveis. Prévia, desfazer e IA offline.',
      heroTitle: 'Renomeador de arquivos para Mac',
      heroSubtitle: 'Crie nomes no Finder com os detalhes que você escolhe. Veja cada sugestão, aplique quando estiver pronto, desfaça qualquer lote ou use IA offline.',
      ctaTitle: 'Teste o Zush grátis no Mac',
      ctaSubtitle: 'Defina suas regras, veja cada alteração e renomeie no Finder com Zush Cloud, seu provedor de IA ou IA offline.',
    ...
    windows: {
      ...
      softwareDescription: 'Renomeador de arquivos com IA para Windows com regras próprias baseadas em conteúdo, metadados, datas e blocos reutilizáveis. Prévia, desfazer e IA offline.',
      heroTitle: 'Renomeador de arquivos para Windows',
      heroSubtitle: 'Crie nomes no Explorador de Arquivos com os detalhes que você escolhe. Veja cada sugestão, aplique quando estiver pronto, desfaça qualquer lote ou use IA offline.',
      ctaTitle: 'Teste o Zush grátis no Windows',
      ctaSubtitle: 'Defina suas regras, veja cada alteração e renomeie no Explorador com Zush Cloud, seu provedor de IA ou IA offline.',
  ...
  es: {
    mac: {
      breadcrumbLabel: 'Zush para Mac',
      softwareName: 'Zush para Mac',
      softwareDescription: 'Renombrador de archivos con IA para Mac con reglas propias basadas en contenido, metadatos, fechas y bloques reutilizables. Vista previa, deshacer e IA sin conexión.',
      heroTitle: 'Renombrador de archivos para Mac',
      heroSubtitle: 'Crea nombres en Finder con los detalles que eliges. Previsualiza cada propuesta, aplica cuando estés listo, deshaz cualquier lote o usa IA sin conexión.',
      ctaTitle: 'Prueba Zush gratis en Mac',
      ctaSubtitle: 'Define tus reglas, previsualiza cada cambio y renombra en Finder con Zush Cloud, tu proveedor de IA o IA sin conexión.',
    ...
    windows: {
      breadcrumbLabel: 'Zush para Windows',
      softwareName: 'Zush para Windows',
      softwareDescription: 'Renombrador de archivos con IA para Windows con reglas propias basadas en contenido, metadatos, fechas y bloques reutilizables. Vista previa, deshacer e IA sin conexión.',
      heroTitle: 'Renombrador de archivos para Windows',
      heroSubtitle: 'Crea nombres en el Explorador con los detalles que eliges. Previsualiza cada propuesta, aplica cuando estés listo, deshaz cualquier lote o usa IA sin conexión.',
      ctaTitle: 'Prueba Zush gratis en Windows',
      ctaSubtitle: 'Define tus reglas, previsualiza cada cambio y renombra en el Explorador con Zush Cloud, tu proveedor de IA o IA sin conexión.',
  ...
  nl: {
    mac: {
      ...
      softwareDescription: 'AI-bestandshernoemer voor Mac met eigen regels op basis van inhoud, metadata, datums en herbruikbare blokken. Preview, undo en Offline AI.',
      heroTitle: 'Bestandshernoemer voor Mac',
      heroSubtitle: 'Bouw Finder-namen uit de details die jij kiest. Bekijk elk voorstel, pas toe wanneer je klaar bent, herstel elke batch of gebruik Offline AI.',
      ctaTitle: 'Probeer Zush gratis op Mac',
      ctaSubtitle: 'Stel je naamregels in, bekijk elke wijziging en hernoem Finder-bestanden met Zush Cloud, je AI-provider of Offline AI.',
    ...
    windows: {
      ...
      softwareDescription: 'AI-bestandshernoemer voor Windows met eigen regels op basis van inhoud, metadata, datums en herbruikbare blokken. Preview, undo en Offline AI.',
      heroTitle: 'Bestandshernoemer voor Windows',
      heroSubtitle: 'Bouw namen voor Verkenner uit de details die jij kiest. Bekijk elk voorstel, pas toe wanneer je klaar bent, herstel elke batch of gebruik Offline AI.',
      ctaTitle: 'Probeer Zush gratis op Windows',
      ctaSubtitle: 'Stel je naamregels in, bekijk elke wijziging en hernoem bestanden met Zush Cloud, je AI-provider of Offline AI.',
  ...
  it: {
    mac: {
      ...
      softwareDescription: 'Rinomina file con IA per Mac con regole personalizzate basate su contenuto, metadati, date e blocchi riutilizzabili. Anteprima, annulla e IA offline.',
      heroTitle: 'Rinomina file per Mac',
      heroSubtitle: 'Crea nomi Finder con i dettagli che scegli. Visualizza ogni proposta, applica quando vuoi, annulla qualsiasi batch o usa l’IA offline.',
      ctaTitle: 'Prova Zush gratis su Mac',
      ctaSubtitle: 'Imposta le tue regole, visualizza ogni modifica e rinomina in Finder con Zush Cloud, il tuo provider IA o l’IA offline.',
    ...
    windows: {
      ...
      softwareDescription: 'Rinomina file con IA per Windows con regole personalizzate basate su contenuto, metadati, date e blocchi riutilizzabili. Anteprima, annulla e IA offline.',
      heroTitle: 'Rinomina file per Windows',
      heroSubtitle: 'Crea nomi per Esplora file con i dettagli che scegli. Visualizza ogni proposta, applica quando vuoi, annulla qualsiasi batch o usa l’IA offline.',
      ctaTitle: 'Prova Zush gratis su Windows',
      ctaSubtitle: 'Imposta le tue regole, visualizza ogni modifica e rinomina in Esplora file con Zush Cloud, il tuo provider IA o l’IA offline.',
  ...
  ja: {
    mac: {
      ...
      softwareDescription: 'Mac向けAIファイルリネーム。内容、メタデータ、日付、再利用ブロックで独自ルールを作成し、すべての変更をプレビュー。UndoとオフラインAIにも対応。',
      heroTitle: 'Mac向けファイルリネーム',
      heroSubtitle: '選んだ詳細からFinderのファイル名を作成。すべての候補を確認してから適用し、バッチを元に戻すかオフラインAIを利用できます。',
      ctaTitle: 'Mac で Zush を無料で試す',
      ctaSubtitle: '命名ルールを設定し、変更を確認して、Zush Cloud、自分のAIプロバイダー、オフラインAIでFinderのファイルをリネーム。',
    ...
    windows: {
      ...
      softwareDescription: 'Windows向けAIファイルリネーム。内容、メタデータ、日付、再利用ブロックで独自ルールを作成し、すべての変更をプレビュー。UndoとオフラインAIにも対応。',
      heroTitle: 'Windows向けファイルリネーム',
      heroSubtitle: '選んだ詳細からエクスプローラーのファイル名を作成。すべての候補を確認してから適用し、バッチを元に戻すかオフラインAIを利用できます。',
      ctaTitle: 'Windows で Zush を無料で試す',
      ctaSubtitle: '命名ルールを設定し、変更を確認して、Zush Cloud、自分のAIプロバイダー、オフラインAIでファイルをリネーム。',
  ...
  ko: {
    mac: {
      ...
      softwareDescription: 'Mac용 AI 파일 이름 변경 도구입니다. 내용, 메타데이터, 날짜와 재사용 블록으로 규칙을 만들고 모든 변경을 미리 보며 되돌리기와 오프라인 AI를 지원합니다.',
      heroTitle: 'Mac용 파일 이름 변경 도구',
      heroSubtitle: '선택한 세부 정보로 Finder 이름을 만드세요. 모든 제안을 확인한 뒤 적용하고, 일괄 작업을 되돌리거나 오프라인 AI를 사용할 수 있습니다.',
      ctaTitle: 'Mac에서 Zush 무료 체험',
      ctaSubtitle: '이름 규칙을 정하고 모든 변경을 확인한 뒤 Zush Cloud, 내 AI 제공업체 또는 오프라인 AI로 Finder 파일 이름을 변경하세요.',
    ...
    windows: {
      ...
      softwareDescription: 'Windows용 AI 파일 이름 변경 도구입니다. 내용, 메타데이터, 날짜와 재사용 블록으로 규칙을 만들고 모든 변경을 미리 보며 되돌리기와 오프라인 AI를 지원합니다.',
      heroTitle: 'Windows용 파일 이름 변경 도구',
      heroSubtitle: '선택한 세부 정보로 파일 탐색기 이름을 만드세요. 모든 제안을 확인한 뒤 적용하고, 일괄 작업을 되돌리거나 오프라인 AI를 사용할 수 있습니다.',
      ctaTitle: 'Windows에서 Zush 무료 체험',
      ctaSubtitle: '이름 규칙을 정하고 모든 변경을 확인한 뒤 Zush Cloud, 내 AI 제공업체 또는 오프라인 AI로 파일 이름을 변경하세요.',
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  de: {
    featureCards: {
      ...
      byok: { title: 'Eigener API-Schlüssel', description: 'Verbinde Gemini, Groq, OpenAI oder Claude für Cloud-Umbenennungen; FREE umfasst 50 in allen Modi, PRO ist unbegrenzt. Schlüssel bleiben lokal gespeichert.' },
  ...
  fr: {
    featureCards: {
      ...
      byok: { title: 'Votre propre clé API', description: 'Connectez Gemini, Groq, OpenAI ou Claude pour les renommages cloud; FREE en inclut 50 tous modes confondus, PRO est illimité. Les clés restent stockées localement.' },
  ...
  es: {
    featureCards: {
      ...
      byok: { title: 'Trae tu propia clave', description: 'Conecta Gemini, Groq, OpenAI o Claude para renombrados cloud; FREE incluye 50 entre todos los modos y PRO es ilimitado. Las claves se guardan localmente.' },
  ...
  nl: {
    featureCards: {
      ...
      byok: { title: 'Eigen sleutel gebruiken', description: 'Koppel Gemini, Groq, OpenAI of Claude voor cloud-hernoemen. FREE bevat 50 hernoemingen voor alle modi; PRO verwijdert de limiet. Sleutels blijven lokaal opgeslagen.' },
  ...
  it: {
    featureCards: {
      ...
      byok: { title: 'Usa la tua chiave', description: 'Collega Gemini, Groq, OpenAI o Claude per rinomine cloud; FREE ne include 50 tra tutte le modalità e PRO è illimitato. Le chiavi restano locali.' },
  ...
  ja: {
    featureCards: {
      ...
      byok: { title: '自分のキーを使用', description: 'Gemini、Groq、OpenAI、Claude を接続してクラウドリネーム。FREE は全モード共通 50 回、PRO は無制限。キーはローカルに安全保存されます。' },
  ...
  ko: {
    featureCards: {
      ...
      byok: { title: '내 키 가져오기', description: 'Gemini, Groq, OpenAI, Claude를 연결해 클라우드에서 이름을 변경하세요. FREE는 모든 모드에서 공통 50회이며 PRO는 제한이 없습니다. 키는 로컬에 저장됩니다.' },
  ...
  tr: {
    featureCards: {
      ...
      byok: { title: 'Kendi anahtarınızı kullanın', description: 'Bulut yeniden adlandırma için kendi Gemini, Groq, OpenAI veya Claude API anahtarınızı bağlayın. FREE tüm modlarda ortak 50 işlem sunar; PRO limiti kaldırır. Anahtarlar yerel ve güvenli depolamada tutulur.' },
  ...
  'zh-cn': {
    faqItems: [
      ...
      { question: '什么是 BYOK（Bring Your Own Key）？', answer: 'BYOK 允许所有方案的用户连接自己的 Gemini、Groq、OpenAI 或 Claude API key，用于云端重命名。FREE 在所有模式间共享 50 次；PRO 会移除此限制。密钥会保存在本地安全存储中。' },
    ...
    featureCards: {
      ...
      byok: { title: '使用自己的密钥', description: '连接 Gemini、Groq、OpenAI 或 Claude，实现云端重命名；FREE 在所有模式间共享 50 次，PRO 无限制。密钥会安全保存在本地。' },
  ...
  ar: {
    featureCards: {
      ...
      byok: { title: 'استخدم مفتاحك الخاص', description: 'اربط مفتاح API الخاص بك من Gemini أو Groq أو OpenAI أو Claude لإعادة التسمية عبر السحابة؛ تشمل FREE ‏50 عملية مشتركة بين جميع الأوضاع، وPRO غير محدود. يتم حفظ المفاتيح محليا بأمان.' },
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  de: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Benenne Dateien mit KI nach Inhalt um und forme jeden Namen nach deinen Regeln. Prüfe jeden Vorschlag, nutze Undo und wähle zwischen Cloud-KI, BYOK und Offline-KI.',
      heroHighlights: ['Benenne Dateien mit KI nach Inhalt um', 'nach deinen Regeln'],
      buyPro: 'PRO kaufen',
      trustSignals: ['Kostenlos starten', 'Keine Registrierung', 'Keine Kreditkarte erforderlich'],
      heroModes: ['Erst prüfen', 'Eigene Regeln', 'Ein-Klick-Undo', 'Offline-KI'],
  ...
  fr: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renommez les fichiers selon leur contenu, puis façonnez chaque nom avec vos règles. Prévisualisez chaque proposition, annulez un lot et choisissez Cloud AI, BYOK ou l’IA hors ligne.',
      heroHighlights: ['Renommez les fichiers selon leur contenu', 'avec vos règles'],
      buyPro: 'Acheter PRO',
      trustSignals: ['Commencez gratuitement', 'Sans inscription', 'Sans carte bancaire'],
      heroModes: ['Aperçu d’abord', 'Règles sur mesure', 'Annulation en un clic', 'IA hors ligne'],
  ...
  'pt-br': localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renomeie arquivos por conteúdo com IA e molde cada nome com suas regras. Veja cada sugestão, desfaça qualquer lote e escolha Cloud AI, BYOK ou IA offline.',
      heroHighlights: ['Renomeie arquivos por conteúdo com IA', 'com suas regras'],
      buyPro: 'Comprar PRO',
      trustSignals: ['Comece grátis', 'Sem cadastro', 'Sem cartão de crédito'],
      heroModes: ['Prévia primeiro', 'Regras próprias', 'Desfazer em um clique', 'IA offline'],
  ...
  es: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Renombra archivos por contenido con IA y da forma a cada nombre con tus reglas. Previsualiza cada propuesta, deshaz cualquier lote y elige Cloud AI, BYOK o IA sin conexión.',
      heroHighlights: ['Renombra archivos por contenido con IA', 'con tus reglas'],
      buyPro: 'Comprar PRO',
      trustSignals: ['Empieza gratis', 'Sin registro', 'Sin tarjeta de crédito'],
      heroModes: ['Vista previa', 'Reglas propias', 'Deshacer en un clic', 'IA sin conexión'],
  ...
  nl: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Hernoem bestanden op inhoud met AI en bouw elke naam volgens jouw regels. Bekijk elk voorstel, herstel elke batch en kies Cloud AI, BYOK of Offline AI.',
      heroHighlights: ['Hernoem bestanden op inhoud met AI', 'volgens jouw regels'],
      buyPro: 'Koop PRO',
      trustSignals: ['Gratis aan de slag', 'Geen registratie', 'Geen creditcard nodig'],
      heroModes: ['Eerst bekijken', 'Eigen regels', 'Undo met één klik', 'Offline AI'],
  ...
  it: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Rinomina i file in base al contenuto e crea ogni nome secondo le tue regole. Visualizza ogni proposta, annulla qualsiasi batch e scegli Cloud AI, BYOK o IA offline.',
      heroHighlights: ['Rinomina i file in base al contenuto', 'secondo le tue regole'],
      buyPro: 'Acquista PRO',
      trustSignals: ['Inizia gratis', 'Nessuna registrazione', 'Nessuna carta di credito richiesta'],
      heroModes: ['Prima l’anteprima', 'Regole personalizzate', 'Annulla con un clic', 'IA offline'],
  ...
  ja: localized({
    ...
    home: {
      heroTitle: 'ファイルリネーム\nMac・Windows対応',
      heroAccent: 'ファイルリネーム',
      heroSubtitle: 'AIで内容に基づいてリネームし、自分のルールで各ファイル名を構成。候補を確認し、バッチを元に戻し、Cloud AI、BYOK、オフラインAIから選べます。',
      heroHighlights: ['AIで内容に基づいてリネーム', '自分のルール'],
      buyPro: 'PROを購入',
      trustSignals: ['無料で始める', '登録不要', 'クレジットカード不要'],
      heroModes: ['先にプレビュー', 'カスタムルール', 'ワンクリックで元に戻す', 'オフラインAI'],
  ...
  ko: localized({
    ...
    home: {
      ...
      heroSubtitle: 'AI로 내용에 따라 이름을 바꾸고 사용자 규칙으로 각 파일명을 구성하세요. 제안을 미리 보고, 일괄 작업을 되돌리며 Cloud AI, BYOK 또는 오프라인 AI를 선택할 수 있습니다.',
      heroHighlights: ['AI로 내용에 따라 이름을 바꾸고', '사용자 규칙'],
      buyPro: 'PRO 구매',
      trustSignals: ['무료로 시작하기', '회원가입 불필요', '카드 필요 없음'],
      heroModes: ['먼저 미리보기', '사용자 규칙', '한 번에 되돌리기', '오프라인 AI'],
  ...
  'zh-cn': localized({
    ...
    home: {
      heroTitle: '文件重命名工具\n适用于 Mac 和 Windows',
      heroAccent: '文件重命名工具',
      heroSubtitle: '使用 AI 按内容重命名，并按你的规则构建每个文件名。预览所有建议、撤销任意批次，并可选择 Cloud AI、BYOK 或离线 AI。',
      heroHighlights: ['使用 AI 按内容重命名', '按你的规则'],
      buyPro: '购买 PRO',
      trustSignals: ['免费开始', '无需注册', '无需信用卡'],
      heroModes: ['先预览', '自定义规则', '一键撤销', '离线 AI'],
    ...
    platforms: {
      mac: {
        breadcrumbLabel: 'Zush for Mac',
        softwareName: 'Zush for Mac',
        softwareDescription: '适用于 Mac 的 AI 文件重命名工具。可用内容、元数据、日期和可复用模块创建自定义规则，预览所有更改，并支持撤销和离线 AI。',
        heroTitle: '适用于 Mac 的文件重命名工具',
        heroSubtitle: '用你选择的信息生成 Finder 文件名。应用前预览每项建议，可撤销任意批次，或使用受支持的离线 AI。',
        ctaTitle: '在 Mac 上免费试用 Zush',
        ctaSubtitle: '设置命名规则，预览每项更改，并通过 Zush Cloud、自己的 AI 服务商或离线 AI 重命名 Finder 文件。',
      ...
      windows: {
        breadcrumbLabel: 'Zush for Windows',
        softwareName: 'Zush for Windows',
        softwareDescription: '适用于 Windows 的 AI 文件重命名工具。可用内容、元数据、日期和可复用模块创建自定义规则，预览所有更改，并支持撤销和离线 AI。',
        heroTitle: '适用于 Windows 的文件重命名工具',
        heroSubtitle: '用你选择的信息生成文件资源管理器名称。应用前预览每项建议，可撤销任意批次，或使用受支持的离线 AI。',
        ctaTitle: '在 Windows 上免费试用 Zush',
        ctaSubtitle: '设置命名规则，预览每项更改，并通过 Zush Cloud、自己的 AI 服务商或离线 AI 重命名文件。',
  ...
  tr: localized({
    ...
    home: {
      ...
      heroSubtitle: 'Dosyaları içeriklerine göre AI ile adlandırın ve her adı kendi kurallarınızla oluşturun. Önerileri önizleyin, toplu işlemleri geri alın; Cloud AI, BYOK veya çevrimdışı AI’ı seçin.',
      heroHighlights: ['Dosyaları içeriklerine göre AI ile adlandırın', 'kendi kurallarınızla'],
      buyPro: 'PRO satın al',
      trustSignals: ['Ücretsiz başlayın', 'Kayıt gerekmez', 'Kredi kartı gerekmez'],
      heroModes: ['Önce önizle', 'Özel kurallar', 'Tek tıkla geri al', 'Çevrimdışı AI'],
  ...
  ar: localized({
    ...
    home: {
      ...
      heroSubtitle: 'أعد تسمية الملفات حسب المحتوى وأنشئ كل اسم وفق قواعدك. عاين الاقتراحات وتراجع عن أي دفعة واختر بين Cloud AI وBYOK والذكاء الاصطناعي دون اتصال.',
      heroHighlights: ['أعد تسمية الملفات حسب المحتوى', 'وفق قواعدك'],
      buyPro: 'شراء PRO',
      trustSignals: ['ابدأ مجانًا', 'لا يلزم التسجيل', 'لا تحتاج إلى بطاقة ائتمان'],
      heroModes: ['المعاينة أولًا', 'قواعد مخصصة', 'تراجع بنقرة واحدة', 'ذكاء اصطناعي دون اتصال'],
