  ...
  home: {
    ...
    videos: {
      ...
      items: {
        ...
        monitor: { title: 'Automatic File Renamer', description: 'Watch folders and rename new screenshots, design files, PDFs, photos, audio, videos, iWork documents, and downloads as they appear' },
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  it: {
    ...
    videos: { title: 'Guarda Zush in azione', titleAccent: 'Zush', description: 'Scopri rinomina batch con IA, monitoraggio automatico, IA locale e nomi basati sul contenuto in workflow reali', playDemo: 'Riproduci demo', switchTo: 'Passa a', items: { 'batch-rename': { title: 'Rinomina batch IA', description: 'Rinomina più file per contenuto reale prima di applicare' }, monitor: { title: 'Rinomina automatica', description: 'Monitora cartelle e rinomina nuovi screenshot, PDF, foto, audio, video e download' }, tags: { title: 'Tag intelligenti', description: 'Genera tag per cercare i file più velocemente' }, naming: { title: 'Blocchi di nomi', description: 'Crea nomi riutilizzabili con 145+ blocchi' }, multilanguage: { title: 'Multilingua', description: 'Genera nomi in oltre 60 lingue' }, 'custom-prompts': { title: 'Prompt personalizzati', description: 'Guida la generazione con le tue istruzioni' }, byok: { title: 'BYOK', description: 'Collega il tuo provider IA per rinomine illimitate' }, 'offline-ai': { title: 'Rinomina IA offline', description: 'Usa modelli locali privati via Ollama per i file supportati' }, activity: { title: 'Cronologia attività', description: 'Controlla le rinomine recenti e annulla le modifiche' } } },
  ...
  'zh-cn': {
    ...
    videos: { title: '观看 Zush 实际运行', titleAccent: 'Zush', description: '查看 AI 批量重命名、自动文件夹监控、本地 AI 和按内容命名在真实工作流中的表现', playDemo: '播放演示', switchTo: '切换到', items: { 'batch-rename': { title: 'AI 批量重命名', description: '根据真实内容批量检查并重命名文件后再应用' }, monitor: { title: '自动文件重命名工具', description: '监控文件夹，并重命名新截图、PDF、照片、音频、视频和下载文件' }, tags: { title: '智能标签', description: '生成标签，让文件搜索更快' }, naming: { title: '命名块', description: '用 145+ 个块创建可复用的文件名' }, multilanguage: { title: '多语言', description: '生成 60 多种语言的文件名' }, 'custom-prompts': { title: '自定义提示词', description: '用自己的指令控制文件名生成' }, byok: { title: 'BYOK', description: '连接自己的 AI 服务商，实现无限重命名' }, 'offline-ai': { title: '离线 AI 重命名', description: '对支持的文件使用 Ollama 私有本地模型' }, activity: { title: '活动历史', description: '查看最近的重命名并在需要时撤销' } } },
  ...
  ar: {
    ...
    videos: {
      ...
      items: {
        ...
        monitor: { title: 'أداة إعادة تسمية تلقائية', description: 'راقب المجلدات وأعد تسمية لقطات الشاشة وملفات PDF والصور والصوت والفيديوهات والتنزيلات الجديدة' },
