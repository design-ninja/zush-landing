...
const localizedPlatforms: Record<Exclude<Locale, 'en' | 'zh-cn' | 'tr' | 'ar'>, LocaleCopy['platforms']> = {
  de: {
    mac: {
      ...
      softwareDescription: 'Dateiumbenenner für Mac und KI-Stapelumbenennungstool für macOS. Benenne Dateien aus Finder-Ordnern, Screenshots, Videos, PDFs, Fotos und Dokumente nach Inhalt um.',
      heroTitle: 'Dateiumbenenner für Mac',
      heroSubtitle: 'Benenne Dateien auf dem Mac stapelweise mit KI um: Screenshots, Videos, PDFs, Fotos, iWork- und Office-Dokumente. Überwache Ordner automatisch oder nutze Offline-KI über Ollama.',
      ctaTitle: 'Zush kostenlos auf Mac testen',
      ctaSubtitle: 'Installiere den signierten Dateiumbenenner für macOS und benenne Screenshots, Videos, PDFs, Fotos und Dokumente in wenigen Minuten stapelweise um.',
    ...
    windows: {
      ...
      softwareDescription: 'Dateiumbenenner für Windows 11 und 10 mit KI-Bulk- und Stapelumbenennung. Benenne Screenshots, Videos, PDFs, Fotos und Dokumente nach Inhalt um.',
      heroTitle: 'Dateiumbenenner für Windows',
      heroSubtitle: 'Benenne Dateien unter Windows 11 und 10 mit KI in großen Mengen um: Screenshots, Videos, PDFs, Fotos und Office-Dokumente. Installation über den Microsoft Store mit automatischen Updates.',
      ctaTitle: 'Zush kostenlos auf Windows testen',
      ctaSubtitle: 'Öffne den Microsoft Store und nutze ein Windows-Stapelumbenennungstool für Screenshots, Videos, PDFs, Fotos und Office-Dokumente.',
  ...
  fr: {
    mac: {
      ...
      softwareDescription: 'Renommeur de fichiers pour Mac et outil de renommage par lot avec l’IA. Renommez dossiers Finder, screenshots, vidéos, PDF, photos et documents selon leur contenu.',
      heroTitle: 'Renommeur de fichiers pour Mac',
      heroSubtitle: 'Renommez des fichiers par lot sur Mac avec l’IA : screenshots, vidéos, PDF, photos, documents iWork et Office. Surveillez les dossiers ou utilisez le mode IA hors ligne via Ollama.',
      ctaTitle: 'Essayez Zush gratuitement sur Mac',
      ctaSubtitle: 'Installez le renommeur de fichiers macOS signé et commencez à renommer screenshots, vidéos, PDF, photos et documents en quelques minutes.',
    ...
    windows: {
      ...
      softwareDescription: 'Renommeur de fichiers pour Windows 11 et 10 avec renommage en masse et par lot via l’IA. Renommez screenshots, vidéos, PDF, photos et documents selon leur contenu.',
      heroTitle: 'Renommeur de fichiers pour Windows',
      heroSubtitle: 'Renommez des fichiers en masse sur Windows 11 et 10 avec l’IA : screenshots, vidéos, PDF, photos et documents Office. Installation via Microsoft Store avec mises à jour automatiques.',
      ctaTitle: 'Essayez Zush gratuitement sur Windows',
      ctaSubtitle: 'Ouvrez le Microsoft Store et utilisez un outil Windows de renommage par lot pour screenshots, vidéos, PDF, photos et documents Office.',
  ...
  'pt-br': {
    mac: {
      ...
      softwareDescription: 'Renomeador de arquivos para Mac e ferramenta de renomeação em lote com IA para macOS. Renomeie arquivos do Finder, screenshots, vídeos, PDFs, fotos e documentos pelo conteúdo.',
      heroTitle: 'Renomeador de arquivos para Mac',
      heroSubtitle: 'Renomeie arquivos em lote no Mac com IA: screenshots, vídeos, PDFs, fotos, documentos iWork e Office. Monitore pastas ou use o modo IA offline via Ollama.',
      ctaTitle: 'Teste o Zush grátis no Mac',
      ctaSubtitle: 'Instale o renomeador de arquivos macOS assinado e comece a renomear screenshots, vídeos, PDFs, fotos e documentos em minutos.',
    ...
    windows: {
      ...
      softwareDescription: 'Renomeador de arquivos para Windows 11 e 10 com renomeação em massa e em lote por IA. Renomeie screenshots, vídeos, PDFs, fotos e documentos pelo conteúdo.',
      heroTitle: 'Renomeador de arquivos para Windows',
      heroSubtitle: 'Renomeie arquivos em massa no Windows 11 e 10 com IA: screenshots, vídeos, PDFs, fotos e documentos Office. Instalação pela Microsoft Store com atualizações automáticas.',
      ctaTitle: 'Teste o Zush grátis no Windows',
      ctaSubtitle: 'Abra a Microsoft Store e use uma ferramenta de renomeação em lote para Windows em screenshots, vídeos, PDFs, fotos e documentos Office.',
  ...
  es: {
    mac: {
      breadcrumbLabel: 'Zush para Mac',
      softwareName: 'Zush para Mac',
      softwareDescription: 'Renombrador de archivos para Mac y herramienta de renombrado por lotes con IA. Renombra archivos de Finder, capturas, videos, PDFs, fotos y documentos según su contenido.',
      heroTitle: 'Renombrador de archivos para Mac',
      heroSubtitle: 'Renombra archivos por lotes en Mac con IA: capturas, videos, PDFs, fotos, documentos iWork y Office. Monitorea carpetas o usa el modo IA offline mediante Ollama.',
      ctaTitle: 'Prueba Zush gratis en Mac',
      ctaSubtitle: 'Instala el renombrador de archivos macOS firmado y empieza a renombrar capturas, videos, PDFs, fotos y documentos en minutos.',
    ...
    windows: {
      breadcrumbLabel: 'Zush para Windows',
      softwareName: 'Zush para Windows',
      softwareDescription: 'Renombrador de archivos para Windows 11 y 10 con renombrado masivo y por lotes con IA. Renombra capturas, videos, PDFs, fotos y documentos según su contenido.',
      heroTitle: 'Renombrador de archivos para Windows',
      heroSubtitle: 'Renombra archivos en masa en Windows 11 y 10 con IA: capturas, videos, PDFs, fotos y documentos Office. Instalación desde Microsoft Store con actualizaciones automáticas.',
      ctaTitle: 'Prueba Zush gratis en Windows',
      ctaSubtitle: 'Abre Microsoft Store y usa una herramienta de renombrado por lotes para Windows con capturas, videos, PDFs, fotos y documentos Office.',
  ...
  nl: {
    mac: {
      ...
      softwareDescription: 'Bestandshernoemer voor Mac en AI-batchhernoemtool voor macOS. Hernoem Finder-bestanden, screenshots, video’s, PDFs, foto’s en documenten op inhoud.',
      heroTitle: 'Bestandshernoemer voor Mac',
      heroSubtitle: 'Hernoem bestanden batchgewijs op Mac met AI: screenshots, video’s, PDFs, foto’s, iWork- en Office-documenten. Bewaak mappen of gebruik Offline AI via Ollama.',
      ctaTitle: 'Probeer Zush gratis op Mac',
      ctaSubtitle: 'Installeer de ondertekende macOS-bestandshernoemer en begin binnen enkele minuten met het hernoemen van screenshots, video’s, PDFs, foto’s en documenten.',
    ...
    windows: {
      ...
      softwareDescription: 'Bestandshernoemer voor Windows 11 en 10 met AI-bulk- en batchhernoeming. Hernoem screenshots, video’s, PDFs, foto’s en documenten op inhoud.',
      heroTitle: 'Bestandshernoemer voor Windows',
      heroSubtitle: 'Hernoem bestanden in bulk op Windows 11 en 10 met AI: screenshots, video’s, PDFs, foto’s en Office-documenten. Installatie via Microsoft Store met automatische updates.',
      ctaTitle: 'Probeer Zush gratis op Windows',
      ctaSubtitle: 'Open de Microsoft Store en gebruik een Windows-batchhernoemtool voor screenshots, video’s, PDFs, foto’s en Office-documenten.',
  ...
  it: {
    mac: {
      ...
      softwareDescription: 'Rinomina file per Mac e strumento di rinomina in batch con IA per macOS. Rinomina file del Finder, screenshot, video, PDF, foto e documenti in base al contenuto.',
      heroTitle: 'Rinomina file per Mac',
      heroSubtitle: 'Rinomina file in batch su Mac con l’IA: screenshot, video, PDF, foto, documenti iWork e Office. Monitora cartelle o usa la modalità IA offline tramite Ollama.',
      ctaTitle: 'Prova Zush gratis su Mac',
      ctaSubtitle: 'Installa il rinomina file macOS firmato e inizia a rinominare screenshot, video, PDF, foto e documenti in pochi minuti.',
    ...
    windows: {
      ...
      softwareDescription: 'Rinomina file per Windows 11 e 10 con rinomina in massa e in batch tramite IA. Rinomina screenshot, video, PDF, foto e documenti in base al contenuto.',
      heroTitle: 'Rinomina file per Windows',
      heroSubtitle: 'Rinomina file in massa su Windows 11 e 10 con l’IA: screenshot, video, PDF, foto e documenti Office. Installazione dal Microsoft Store con aggiornamenti automatici.',
      ctaTitle: 'Prova Zush gratis su Windows',
      ctaSubtitle: 'Apri il Microsoft Store e usa uno strumento batch per Windows con screenshot, video, PDF, foto e documenti Office.',
  ...
  ja: {
    mac: {
      ...
      softwareDescription: 'Mac向けファイルリネーム兼AI一括リネームツール。Finderのファイル、スクリーンショット、動画、PDF、写真、文書を内容に基づいてリネームします。',
      heroTitle: 'Mac向けファイルリネーム',
      heroSubtitle: 'MacでファイルをAIで一括リネーム: スクリーンショット、動画、PDF、写真、iWork・Office文書に対応。フォルダ監視やOllamaのオフラインAIも使えます。',
      ctaTitle: 'Mac で Zush を無料で試す',
      ctaSubtitle: '署名済みのmacOSファイルリネームアプリをインストールし、数分でスクリーンショット、動画、PDF、写真、文書のリネームを始められます。',
    ...
    windows: {
      ...
      softwareDescription: 'Windows 11/10向けファイルリネーム兼AI大量リネームツール。スクリーンショット、動画、PDF、写真、Office文書を内容に基づいてリネームします。',
      heroTitle: 'Windows向けファイルリネーム',
      heroSubtitle: 'Windows 11/10でファイルをAIで大量リネーム: スクリーンショット、動画、PDF、写真、Office文書に対応。Microsoft Storeからインストールできます。',
      ctaTitle: 'Windows で Zush を無料で試す',
      ctaSubtitle: 'Microsoft Storeを開き、Windows向け一括リネームツールでスクリーンショット、動画、PDF、写真、Office文書を整理できます。',
  ...
  ko: {
    mac: {
      ...
      softwareDescription: 'Mac용 파일 이름 변경 도구이자 AI 일괄 이름 변경 도구입니다. Finder 파일, 스크린샷, 비디오, PDF, 사진, 문서를 내용 기준으로 이름 변경합니다.',
      heroTitle: 'Mac용 파일 이름 변경 도구',
      heroSubtitle: 'Mac에서 파일을 AI로 일괄 이름 변경하세요: 스크린샷, 비디오, PDF, 사진, iWork 및 Office 문서까지 지원합니다. 폴더 모니터링과 Ollama 오프라인 AI도 사용할 수 있습니다.',
      ctaTitle: 'Mac에서 Zush 무료 체험',
      ctaSubtitle: '서명된 macOS 파일 이름 변경 앱을 설치하고 몇 분 안에 스크린샷, 비디오, PDF, 사진, 문서 이름 변경을 시작하세요.',
    ...
    windows: {
      ...
      softwareDescription: 'Windows 11 및 10용 파일 이름 변경 도구이자 AI 대량 이름 변경 도구입니다. 스크린샷, 비디오, PDF, 사진, Office 문서를 내용 기준으로 이름 변경합니다.',
      heroTitle: 'Windows용 파일 이름 변경 도구',
      heroSubtitle: 'Windows 11 및 10에서 파일을 AI로 대량 이름 변경하세요: 스크린샷, 비디오, PDF, 사진, Office 문서까지 지원합니다. Microsoft Store에서 설치할 수 있습니다.',
      ctaTitle: 'Windows에서 Zush 무료 체험',
      ctaSubtitle: 'Microsoft Store를 열고 Windows 일괄 이름 변경 도구로 스크린샷, 비디오, PDF, 사진, Office 문서를 정리하세요.',
  ...
  'zh-cn': localized({
    ...
    platforms: {
      mac: {
        breadcrumbLabel: 'Zush for Mac',
        softwareName: 'Zush for Mac',
        softwareDescription: '适用于 Mac 的文件重命名工具和 AI 批量重命名工具。可根据内容重命名 Finder 文件、截图、视频、PDF、照片和文档。',
        heroTitle: '适用于 Mac 的文件重命名工具',
        heroSubtitle: '在 Mac 上用 AI 批量重命名文件：截图、视频、PDF、照片、iWork 和 Office 文档。可监控文件夹，也支持通过 Ollama 使用离线 AI。',
        ctaTitle: '在 Mac 上免费试用 Zush',
        ctaSubtitle: '安装已签名的 macOS 文件重命名应用，几分钟内开始批量重命名截图、视频、PDF、照片和文档。',
      ...
      windows: {
        breadcrumbLabel: 'Zush for Windows',
        softwareName: 'Zush for Windows',
        softwareDescription: '适用于 Windows 11 和 10 的文件重命名工具和 AI 大量重命名工具。可根据内容重命名截图、视频、PDF、照片和 Office 文档。',
        heroTitle: '适用于 Windows 的文件重命名工具',
        heroSubtitle: '在 Windows 11 和 10 上用 AI 大量重命名文件：截图、视频、PDF、照片和 Office 文档。通过 Microsoft Store 安装并自动更新。',
        ctaTitle: '在 Windows 上免费试用 Zush',
        ctaSubtitle: '打开 Microsoft Store，使用 Windows 批量重命名工具整理截图、视频、PDF、照片和 Office 文档。',
  ...
  tr: localized({
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'Mac için dosya adlandırıcı ve yapay zekâ toplu yeniden adlandırma aracı. Finder dosyalarını, ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve belgeleri içeriklerine göre yeniden adlandırın.',
        heroTitle: 'Mac için dosya adlandırıcı',
        heroSubtitle:
          'Mac’te dosyaları yapay zekâyla toplu yeniden adlandırın: ekran görüntüleri, videolar, PDF’ler, fotoğraflar, iWork ve Office belgeleri. Klasörleri izleyin veya Ollama ile Çevrimdışı Yapay Zekâ modunu kullanın.',
        ctaTitle: 'Zush’u Mac’te ücretsiz deneyin',
        ctaSubtitle: 'İmzalanmış macOS dosya adlandırıcısını kurun ve ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve belgeleri dakikalar içinde toplu yeniden adlandırmaya başlayın.',
      ...
      windows: {
        ...
        softwareDescription:
          'Windows 11 ve 10 için dosya adlandırıcı ve yapay zekâ toplu yeniden adlandırma aracı. Ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve Office belgelerini içeriklerine göre yeniden adlandırın.',
        heroTitle: 'Windows için dosya adlandırıcı',
        heroSubtitle:
          'Windows 11 ve 10’da dosyaları yapay zekâyla toplu yeniden adlandırın: ekran görüntüleri, videolar, PDF’ler, fotoğraflar ve Office belgeleri. Microsoft Store’dan kurun ve otomatik güncellemeler alın.',
        ctaTitle: 'Zush’u Windows’ta ücretsiz deneyin',
        ctaSubtitle: 'Microsoft Store’u açın ve Windows toplu yeniden adlandırma aracıyla ekran görüntülerini, videoları, PDF’leri, fotoğrafları ve Office belgelerini düzenleyin.',
  ...
  ar: localized({
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'أداة إعادة تسمية ملفات لنظام Mac وأداة إعادة تسمية بالدفعات بالذكاء الاصطناعي. أعد تسمية ملفات Finder ولقطات الشاشة والفيديو وPDF والصور والمستندات حسب المحتوى.',
        heroTitle: 'أداة إعادة تسمية الملفات لنظام Mac',
        heroSubtitle:
          'أعد تسمية الملفات بالدفعات على Mac باستخدام الذكاء الاصطناعي: لقطات الشاشة والفيديو وPDF والصور ومستندات iWork وOffice. راقب المجلدات أو استخدم وضع Ollama دون اتصال.',
        ctaTitle: 'جرّب Zush مجانا على Mac',
        ctaSubtitle: 'ثبّت أداة إعادة تسمية الملفات الموقّعة لنظام macOS وابدأ إعادة تسمية لقطات الشاشة والفيديو وPDF والصور والمستندات خلال دقائق.',
      ...
      windows: {
        ...
        softwareDescription:
          'أداة إعادة تسمية ملفات لنظامي Windows 11 و10 مع إعادة تسمية جماعية وبالدفعات بالذكاء الاصطناعي. أعد تسمية لقطات الشاشة والفيديو وPDF والصور ومستندات Office حسب المحتوى.',
        heroTitle: 'أداة إعادة تسمية الملفات لنظام Windows',
        heroSubtitle:
          'أعد تسمية الملفات بكميات كبيرة على Windows 11 و10 باستخدام الذكاء الاصطناعي: لقطات الشاشة والفيديو وPDF والصور ومستندات Office. يثبّت من Microsoft Store مع تحديثات تلقائية.',
        ctaTitle: 'جرّب Zush مجانا على Windows',
        ctaSubtitle: 'افتح Microsoft Store واستخدم أداة إعادة تسمية بالدفعات لنظام Windows مع لقطات الشاشة والفيديو وPDF والصور ومستندات Office.',
