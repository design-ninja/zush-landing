...
export const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    renameDemo: {
      ...
      emptySubtitle: 'Try up to 5 files. Download Zush to rename folders and full-size files.',
      ...
      errors: {
        ...
        tooManyFiles: 'Preview supports up to {limit} files at a time.',
      },
    },
...
const localizedFooterDetails: Record<Exclude<Locale, 'en'>, FooterVisibleCopy> = {
  ...
  ar: {
    ...
    designedWith: 'بواسطة',
    productLinks: {
      aiFileRenamer: 'أداة إعادة تسمية الملفات بالذكاء الاصطناعي',
      aiImageRenamer: 'أداة إعادة تسمية الصور بالذكاء الاصطناعي',
      batchRenameFiles: 'إعادة تسمية الملفات دفعة واحدة',
      autoRenameFiles: 'إعادة تسمية الملفات تلقائيا',
      mac: 'Zush لنظام Mac',
...
const localizedRenameDemo: Record<Exclude<Locale, 'en'>, RenameDemoCopy> = {
  de: {
    ...
    emptySubtitle: 'Teste bis zu 5 Dateien. Lade Zush herunter, um Ordner und Dateien in voller Größe umzubenennen.',
  ...
  fr: {
    ...
    errors: { unsupportedType: '{extension} n’est pas encore pris en charge dans l’aperçu web.', fileTooLarge: 'Cet aperçu dans le navigateur ne peut pas lire ce fichier en toute sécurité. Téléchargez Zush pour renommer les fichiers complets.', emptyPreview: 'Impossible d’extraire assez de contenu de ce fichier.', processingFailed: 'Impossible de préparer ce fichier.', tooManyFiles: 'L’aperçu accepte jusqu’à {limit} fichiers à la fois.' },
  },
  'pt-br': {
    eyebrow: 'Demonstração rápida',
    title: 'Zush AI Rename Demo',
    emptyTitle: 'Solte arquivos aqui',
    emptySubtitle: 'Teste até 5 arquivos. Baixe o Zush para renomear pastas e arquivos completos.',
  ...
  es: {
    ...
    errors: { unsupportedType: '{extension} aún no es compatible con la vista previa web.', fileTooLarge: 'Esta vista previa del navegador no puede leer este archivo de forma segura. Descarga Zush para renombrar archivos completos.', emptyPreview: 'No se pudo extraer suficiente contenido de este archivo.', processingFailed: 'No se pudo preparar este archivo.', tooManyFiles: 'La vista previa admite hasta {limit} archivos a la vez.' },
  },
  nl: {
    eyebrow: 'Snelle demo',
    title: 'Zush AI Rename Demo',
    emptyTitle: 'Sleep bestanden hierheen',
    emptySubtitle: 'Probeer maximaal 5 bestanden. Download Zush om mappen en volledige bestanden te hernoemen.',
  ...
  it: {
    ...
    errors: { unsupportedType: '{extension} non è ancora supportato nell’anteprima web.', fileTooLarge: 'Questa anteprima nel browser non può leggere questo file in sicurezza. Scarica Zush per rinominare file completi.', emptyPreview: 'Impossibile estrarre contenuto sufficiente da questo file.', processingFailed: 'Impossibile preparare questo file.', tooManyFiles: 'L’anteprima supporta fino a {limit} file alla volta.' },
  },
  ja: {
    eyebrow: 'クイックデモ',
    title: 'Zush AI Rename Demo',
    emptyTitle: 'ここにファイルをドロップ',
    emptySubtitle: '最大5ファイルまで試せます。フォルダやフルサイズのファイルをリネームするにはZushをダウンロードしてください。',
    selectFiles: 'ファイルを選択...',
    ...
    errors: { unsupportedType: '{extension} はWebプレビューではまだ対応していません。', fileTooLarge: 'このブラウザプレビューでは、このファイルを安全に読み取れません。フルサイズのファイルをリネームするにはZushをダウンロードしてください。', emptyPreview: 'このファイルから十分な内容を抽出できませんでした。', processingFailed: 'このファイルを準備できませんでした。', tooManyFiles: 'プレビューは一度に最大{limit}ファイルまでです。' },
  },
  ko: {
    eyebrow: '빠른 데모',
    title: 'Zush AI Rename Demo',
    emptyTitle: '여기에 파일을 놓으세요',
    emptySubtitle: '최대 5개 파일을 테스트해 보세요. 폴더와 전체 크기 파일 이름 변경은 Zush를 다운로드하세요.',
    selectFiles: '파일 선택...',
    ...
    errors: { unsupportedType: '{extension} 형식은 아직 웹 미리보기에서 지원되지 않습니다.', fileTooLarge: '이 브라우저 미리보기에서는 이 파일을 안전하게 읽을 수 없습니다. 전체 크기 파일을 이름 변경하려면 Zush를 다운로드하세요.', emptyPreview: '이 파일에서 충분한 내용을 추출하지 못했습니다.', processingFailed: '이 파일을 준비하지 못했습니다.', tooManyFiles: '미리보기는 한 번에 최대 {limit}개 파일을 지원합니다.' },
  },
  'zh-cn': {
    eyebrow: '快速演示',
    title: 'Zush AI Rename Demo',
    emptyTitle: '将文件拖到这里',
    emptySubtitle: '最多试用 5 个文件。下载 Zush 即可重命名文件夹和完整大小文件。',
    selectFiles: '选择文件...',
    ...
    errors: { unsupportedType: '网页预览暂不支持 {extension}。', fileTooLarge: '此浏览器预览无法安全读取该文件。请下载 Zush 来重命名完整大小的文件。', emptyPreview: '无法从此文件提取足够内容。', processingFailed: '无法准备此文件。', tooManyFiles: '预览一次最多支持 {limit} 个文件。' },
  },
  ar: {
    eyebrow: 'عرض سريع',
    title: 'Zush AI Rename Demo',
    emptyTitle: 'أسقط الملفات هنا',
    emptySubtitle: 'جرّب حتى 5 ملفات. نزّل Zush لإعادة تسمية المجلدات والملفات كاملة الحجم.',
    ...
    errors: { unsupportedType: 'لا يدعم معاين الويب {extension} بعد.', fileTooLarge: 'لا يمكن لهذه المعاينة في المتصفح قراءة هذا الملف بأمان. نزّل Zush لإعادة تسمية الملفات كاملة الحجم.', emptyPreview: 'تعذر استخراج محتوى كاف من هذا الملف.', processingFailed: 'تعذر تحضير هذا الملف.', tooManyFiles: 'تدعم المعاينة حتى {limit} ملفات في المرة الواحدة.' },
  },
};
...
export const COPY: Record<Locale, LocaleCopy> = {
  ...
  ar: localized({
    ...
    featurePages: localizedFeaturePages('الأسئلة الشائعة', 'أدوات ذات صلة', 'أدلة ذات صلة', [
      ...
      ['/ai-file-renamer', 'أداة إعادة تسمية الملفات بالذكاء الاصطناعي', 'أعد تسمية لقطات الشاشة وملفات PDF والمستندات والصور بأسماء يولدها الذكاء الاصطناعي ويسهل البحث عنها.'],
      ['/auto-rename-files', 'إعادة تسمية الملفات تلقائيا بالذكاء الاصطناعي', 'راقب المجلدات ودع Zush يعيد تسمية لقطات الشاشة والتنزيلات والتصديرات والمستندات الجديدة تلقائيا.'],
      ['/batch-rename-files', 'إعادة تسمية الملفات دفعة واحدة بالذكاء الاصطناعي', 'أعد تسمية الكثير من الملفات مرة واحدة بأسماء وصفية من الذكاء الاصطناعي، مع معاينة وتحكم وتراجع بنقرة واحدة.'],
      ['/ai-image-renamer', 'أداة إعادة تسمية الصور بالذكاء الاصطناعي', 'أعد تسمية الصور ولقطات الشاشة والنماذج المرئية والصور الفوتوغرافية باستخدام رؤية الذكاء الاصطناعي وأسماء قابلة للبحث.'],
