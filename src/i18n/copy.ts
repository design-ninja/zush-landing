...
const EN_COPY: LocaleCopy = {
  ...
  footer: {
    description: 'File renamer, AI batch rename tool, and bulk rename workflow for Mac and Windows',
    product: 'Product',
  ...
  pricing: {
    ...
    buttonText: 'Buy PRO 🌟',
    buttonHint: '14-day money-back guarantee • Secure via Stripe',
    features: [
  ...
  platforms: {
    mac: {
      ...
      heroSubtitle:
        'Batch rename files with AI on Mac: screenshots, design files, audio, videos, PDFs, photos, iWork, and Office documents. Drag from Finder, watch folders automatically, or use Offline AI mode with private local models via Ollama.',
      ...
      faqDescription: 'Everything you need to know about using Zush as a file renamer and batch rename tool for Mac.',
      features: [
        'File renamer for Mac with AI-powered naming for screenshots, design files, audio, videos, PDFs, photos, iWork, and Office documents',
    ...
    windows: {
      ...
      heroSubtitle:
        'Bulk rename files on Windows 11 and 10 with AI: screenshots, design files, audio, videos, PDFs, photos, iWork, and Office documents. Use templates and naming blocks, watch folders automatically with a Microsoft Store install.',
      ctaTitle: 'Try Zush free on Windows',
      ctaSubtitle: 'Open the Microsoft Store and start using a Windows batch rename tool for screenshots, design files, audio, videos, PDFs, photos, iWork, and Office documents.',
      faqDescription: 'Everything you need to know about using Zush as a file renamer and bulk rename tool for Windows.',
      features: [
        'File renamer for Windows 11 and 10 with AI-powered bulk rename for screenshots, design files, audio, videos, PDFs, photos, iWork, and Office documents',
        'Folder monitoring with file-type exclusions',
        'Batch rename with per-file regenerate',
        'Templates for reusable rename setups',
        'Naming Blocks with 145+ fields for consistent filenames',
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  de: {
    featureCards: {
  ...
  it: {
    ...
    showcase: { title: 'Fai un tour di Zush', titleAccent: 'Zush', description: 'Una breve demo per ogni funzione — clicca una scheda per vederla all’opera', playShowcase: 'Riproduci demo', switchTo: 'Passa a', items: { 'batch-rename': { title: 'Rinomina batch IA', description: 'Rinomina più file per contenuto reale prima di applicare' }, monitor: { title: 'Monitor cartelle', description: 'Monitora cartelle e rinomina i nuovi file' }, activity: { title: 'Cronologia attività', description: 'Controlla le rinomine recenti e annulla le modifiche' }, statistics: { title: 'Statistiche', description: 'Visualizza volume di rinomina, quota di Monitor, attività e tendenze per tipo di file' }, templates: { title: 'Modelli', description: 'Salva configurazioni riutilizzabili per AI Rename e Monitor' }, tags: { title: 'Tag intelligenti', description: 'Genera tag per cercare i file più velocemente' }, 'naming-blocks': { title: 'Blocchi di nomi', description: 'Crea nomi dai contenuti dei tuoi file con 145+ blocchi pronti all’uso' }, multilanguage: { title: 'Multilingua', description: 'Genera nomi in oltre 60 lingue' }, 'custom-prompts': { title: 'Prompt personalizzati', description: 'Guida la generazione con le tue istruzioni' }, byok: { title: 'BYOK', description: 'Collega il tuo provider IA per rinomine illimitate' }, 'offline-ai': { title: 'Rinomina IA offline', description: 'Usa modelli locali privati via Ollama per i file supportati' } } },
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  de: localized({
    ...
    pricing: {
      ...
      buttonHint: '14 Tage Geld-zurück-Garantie • Sicher über Stripe',
  ...
  fr: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: 'Achat unique • Accès à vie', billing: 'une fois', buttonText: 'Acheter PRO 🌟', buttonHint: 'Garantie 14 jours • Paiement sécurisé via Stripe', features: localizedPricingFeatures.fr, ...localizedPricingExtras.fr },
  ...
  'pt-br': localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: 'Compra única • Acesso vitalício', billing: 'único', buttonText: 'Comprar PRO 🌟', buttonHint: 'Garantia de 14 dias • Seguro via Stripe', features: localizedPricingFeatures['pt-br'], ...localizedPricingExtras['pt-br'] },
  ...
  es: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: 'Compra única • Acceso de por vida', billing: 'una vez', buttonText: 'Comprar PRO 🌟', buttonHint: 'Garantía de 14 días • Seguro con Stripe', features: localizedPricingFeatures.es, ...localizedPricingExtras.es },
  ...
  nl: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: 'Eenmalige aankoop • Levenslange toegang', billing: 'eenmalig', buttonText: 'Koop PRO 🌟', buttonHint: '14 dagen geld-terug-garantie • Veilig via Stripe', features: localizedPricingFeatures.nl, ...localizedPricingExtras.nl },
  ...
  it: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: 'Acquisto unico • Accesso a vita', billing: 'una tantum', buttonText: 'Acquista PRO 🌟', buttonHint: 'Garanzia 14 giorni • Sicuro con Stripe', features: localizedPricingFeatures.it, ...localizedPricingExtras.it },
  ...
  ja: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: '買い切り • 永続アクセス', billing: '買い切り', buttonText: 'PRO を購入 🌟', buttonHint: '14日間返金保証 • Stripeで安全決済', features: localizedPricingFeatures.ja, ...localizedPricingExtras.ja },
  ...
  ko: localized({
    ...
    pricing: { planName: 'Zush PRO 🌟', planDescription: '일회성 구매 • 평생 이용', billing: '일회성', buttonText: 'PRO 구매 🌟', buttonHint: '14일 환불 보장 • Stripe 보안 결제', features: localizedPricingFeatures.ko, ...localizedPricingExtras.ko },
  ...
  'zh-cn': localized({
    ...
    pricing: {
      ...
      billing: '一次性',
      buttonText: '购买 PRO 🌟',
      buttonHint: '14 天退款保证 • Stripe 安全支付',
  ...
  hi: localized({
    ...
    pricing: {
      ...
      buttonHint: '14-day money-back guarantee • Stripe के जरिए secure',
  ...
  ar: localized({
    ...
    pricing: {
      ...
      billing: 'مرة واحدة',
      buttonText: 'شراء PRO 🌟',
      buttonHint: 'ضمان استرداد 14 يوما • دفع آمن عبر Stripe',
