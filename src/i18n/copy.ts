...
const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    videos: {
      ...
      switchTo: 'Switch to',
      items: {
        'batch-rename': { title: 'Batch Rename', description: 'Rename up to 50 files at once with AI' },
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  hi: {
    ...
    videos: {
      ...
      items: {
        'batch-rename': { title: 'Batch rename', description: 'AI से multiple files के names एक साथ बदलें' },
