...
const localizedFullHomeFaqItems: Partial<Record<Exclude<Locale, 'en'>, FAQCopyItem[]>> = {
  de: [
    ...
    { question: 'Wie funktioniert der Preis?', answer: 'Zush PRO hat zwei Pläne: Monthly für 8 $/Monat oder One-Time für 38 $. Beide schalten unbegrenztes PRO, BYOK und Offline-KI frei.' },
  ...
  fr: [
    ...
    { question: 'Comment fonctionne le prix ?', answer: 'Zush PRO propose deux offres : Monthly à 8 $/mois ou One-Time à 38 $. Les deux débloquent PRO illimité, BYOK et le mode IA hors ligne.' },
  ...
  'pt-br': [
    ...
    { question: 'Como funciona o preço?', answer: 'Zush PRO tem dois planos: Monthly por US$ 8/mês ou One-Time por US$ 38. Ambos liberam PRO ilimitado, BYOK e IA offline.' },
  ...
  es: [
    ...
    { question: '¿Cómo funciona el precio?', answer: 'Zush PRO tiene dos planes: Monthly por 8 US$/mes o One-Time por 38 US$. Ambos desbloquean PRO ilimitado, BYOK e IA offline.' },
  ...
  nl: [
    ...
    { question: 'Hoe werkt de prijs?', answer: 'Zush PRO heeft twee plannen: Monthly voor $8/maand of One-Time voor $38. Beide ontgrendelen onbeperkte PRO, BYOK en offline AI.' },
  ...
  it: [
    ...
    { question: 'Come funziona il prezzo?', answer: 'Zush PRO ha due piani: Monthly a 8 $/mese oppure One-Time a 38 $. Entrambi sbloccano PRO illimitato, BYOK e IA offline.' },
  ...
  ja: [
    ...
    { question: '料金はどうなっていますか？', answer: 'Zush PRO には Monthly（月額 8 ドル）と One-Time（38 ドル）の 2 つのプランがあります。どちらも無制限 PRO、BYOK、オフライン AI を利用できます。' },
  ...
  ko: [
    ...
    { question: '가격은 어떻게 되나요?', answer: 'Zush PRO는 두 가지 플랜입니다: Monthly 월 $8 또는 One-Time $38. 둘 다 무제한 PRO, BYOK, 오프라인 AI를 제공합니다.' },
  ...
  hi: [
    ...
    { question: 'Pricing कैसे काम करती है?', answer: 'Zush PRO में दो plans हैं: Monthly $8/month या One-Time $38। दोनों unlimited PRO, BYOK और Offline AI unlock करते हैं।' },
    ...
    { question: 'Monthly और One-Time में क्या फर्क है?', answer: 'Monthly $8/month है और flexible है। One-Time $38 है और lifetime access देता है। दोनों unlimited PRO, BYOK और Offline AI unlock करते हैं।' },
    { question: 'कौन से operating systems supported हैं?', answer: 'Zush macOS 15 Sequoia और newer versions, साथ ही Windows 10 / 11 पर चलता है। Mac के लिए signed dmg, Mac App Store और Homebrew, Windows के लिए Microsoft Store available है।' },
  ...
  ar: [
    ...
    { question: 'كيف يعمل السعر؟', answer: 'يتوفر Zush PRO بخطتين: Monthly مقابل 8 دولارات/شهر أو One-Time مقابل 38 دولارا. كلاهما يفتح PRO غير محدود وBYOK وOffline AI.' },
...
const EN_COPY: LocaleCopy = {
  ...
  home: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Included with Zush PRO',
      proDescription: 'Any PRO plan unlocks Offline AI. Ollama and a local model are installed separately.',
      closeLabel: 'Close',
    },
    showcase: {
...
const localizedPricingExtras: Record<Exclude<Locale, 'en'>, PricingExtrasCopy> = {
  ...
  hi: {
    ...
    monthlyPlan: {
      titleSuffix: 'Monthly',
      description: 'Flexible monthly plan',
      buttonText: 'PRO Monthly शुरू करें',
      billing: '/महीना',
    },
    oneTimePlan: {
      titleSuffix: 'One-Time',
      description: 'एक बार pay करके lifetime access',
      buttonText: 'PRO One-Time खरीदें',
      billing: 'one-time',
    },
  },
  ar: {
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  de: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'In Zush PRO enthalten',
      proDescription: 'Jeder PRO-Plan schaltet Offline-KI frei. Ollama und ein lokales Modell werden separat installiert.',
  ...
  fr: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Inclus avec Zush PRO',
      proDescription: 'Chaque plan PRO débloque l’IA hors ligne. Ollama et un modèle local s’installent séparément.',
      closeLabel: 'Fermer',
    },
  ...
  'pt-br': {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Incluído no Zush PRO',
      proDescription: 'Qualquer plano PRO desbloqueia a IA offline. O Ollama e um modelo local são instalados à parte.',
      closeLabel: 'Fechar',
    },
  ...
  es: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Incluido en Zush PRO',
      proDescription: 'Cualquier plan PRO desbloquea la IA offline. Ollama y un modelo local se instalan por separado.',
      closeLabel: 'Cerrar',
    },
  ...
  nl: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Inbegrepen bij Zush PRO',
      proDescription: 'Elk PRO-plan ontgrendelt Offline AI. Ollama en een lokaal model installeer je apart.',
      closeLabel: 'Sluiten',
    },
  ...
  it: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Incluso in Zush PRO',
      proDescription: 'Ogni piano PRO sblocca l’IA offline. Ollama e un modello locale si installano a parte.',
      closeLabel: 'Chiudi',
    },
    showcase: { title: 'Fai un tour di Zush', titleAccent: 'Zush', description: 'Una breve demo per ogni funzione — clicca una scheda per vederla all’opera', playShowcase: 'Riproduci demo', switchTo: 'Passa a', items: { 'batch-rename': { title: 'Rinomina batch IA', description: 'Rinomina più file per contenuto reale prima di applicare' }, monitor: { title: 'Monitor cartelle', description: 'Monitora cartelle e rinomina i nuovi file' }, activity: { title: 'Cronologia attività', description: 'Controlla le rinomine recenti e annulla le modifiche' }, statistics: { title: 'Statistiche', description: 'Visualizza volume di rinomina, quota di Monitor, attività e tendenze per tipo di file' }, templates: { title: 'Modelli', description: 'Salva configurazioni riutilizzabili per AI Rename e Monitor' }, tags: { title: 'Tag intelligenti', description: 'Genera tag per cercare i file più velocemente' }, 'naming-blocks': { title: 'Blocchi di nomi', description: 'Crea nomi dai contenuti dei tuoi file con 145+ blocchi pronti all’uso' }, 'custom-ai-blocks': { title: 'Blocchi IA personalizzati', description: 'Descrivi cosa deve estrarre l’IA e riusalo come tuo blocco di denominazione' }, multilanguage: { title: 'Multilingua', description: 'Genera nomi in oltre 60 lingue' }, 'custom-prompts': { title: 'Prompt personalizzati', description: 'Guida la generazione con le tue istruzioni' }, byok: { title: 'BYOK', description: 'Collega il tuo provider IA per rinomine illimitate' }, 'offline-ai': { title: 'Rinomina IA offline', description: 'Usa modelli locali privati via Ollama per i file supportati' } } },
  ...
  ko: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'Zush PRO에 포함',
      proDescription: '모든 PRO 플랜에서 오프라인 AI를 사용할 수 있습니다. Ollama와 로컬 모델은 별도로 설치합니다.',
      closeLabel: '닫기',
    },
  ...
  hi: {
    featureCards: {
      ...
      customAiBlocks: { title: 'Custom AI Blocks', description: 'बताएं कि Zush को file से क्या extract करना है — brand, client, case number या कोई भी detail — और उसे अपने naming block की तरह किसी भी template में reuse करें। Free version में शामिल।' },
    ...
    offlineAiModal: {
      title: 'AI जो आपके device पर ही रहता है',
      description: 'Offline AI एक optional mode है। Local Ollama model सीधे आपके Mac या Windows PC पर चलता है — बिना cloud के।',
      points: [
        'कुछ भी device से बाहर नहीं जाता। न Zush cloud, न कोई third-party AI।',
        'Screenshots, photos, PDFs और document previews के लिए best है।',
        'ज्यादा models या file types के लिए कभी भी Cloud या BYOK पर switch करें।',
      ],
      proTitle: 'Zush PRO में शामिल',
      proDescription: 'हर PRO plan Offline AI unlock करता है। Ollama और local model अलग से install होते हैं।',
      closeLabel: 'बंद करें',
    },
    showcase: {
      ...
      items: {
        ...
        'custom-ai-blocks': { title: 'Custom AI Blocks', description: 'बताएं कि AI क्या extract करे और उसे अपने naming block की तरह reuse करें' },
  ...
  'zh-cn': {
    ...
    faqItems: [
      ...
      { question: '价格如何计算？', answer: 'Zush PRO 有两个方案：Monthly 每月 8 美元，或 One-Time 38 美元。两者都解锁无限 PRO、BYOK 和离线 AI。' },
  ...
  ar: {
    ...
    offlineAiModal: {
      ...
      proTitle: 'مضمّن مع Zush PRO',
      proDescription: 'كل خطط PRO تفتح Offline AI. يُثبّت Ollama والنموذج المحلي بشكل منفصل.',
      closeLabel: 'إغلاق',
    },
    showcase: {
      title: 'تجوّل في Zush',
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  ja: localized({
    ...
    seo: { '/': { title: 'Mac・Windows対応 ファイルリネーム | AI 一括リネームツール — Zush', description: 'AI で内容に基づいてファイルを一括・大量リネーム。スクリーンショット、PDF、写真、動画、音声、デザインファイル、文書に対応。' } },
  ...
  ko: localized({
    ...
    seo: { '/': { title: 'Mac 및 Windows용 파일 이름 변경 도구 | AI 일괄 이름 변경 — Zush', description: 'AI로 파일 내용을 기준으로 일괄 및 대량 이름 변경. 스크린샷, PDF, 사진, 비디오, 오디오, 디자인 파일, 문서 지원.' } },
  ...
  hi: localized({
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'Mac के लिए file renamer और AI batch rename tool। Finder files, screenshots, videos, PDFs, photos और documents को content के आधार पर rename करें।',
        heroTitle: 'Mac के लिए file renamer',
        heroSubtitle:
          'Mac पर AI से files batch rename करें: screenshots, videos, PDFs, photos, iWork और Office documents। Folders watch करें या Ollama वाला Offline AI mode use करें।',
        ctaTitle: 'Mac पर Zush free try करें',
        ctaSubtitle: 'Signed macOS file renamer install करें और कुछ minutes में screenshots, videos, PDFs, photos और documents batch rename करना शुरू करें।',
        faqDescription: 'Mac के लिए Zush और बाकी product के बारे में जरूरी details।',
        features: [
          'Mac file renamer जो screenshots, videos, PDFs, photos और documents को AI से batch rename करता है',
      ...
      windows: {
        ...
        softwareDescription:
          'Windows 11 और 10 के लिए file renamer और AI bulk rename tool। Screenshots, videos, PDFs, photos और Office documents को content से rename करें।',
        heroTitle: 'Windows के लिए file renamer',
        heroSubtitle:
          'Windows 11 और 10 पर AI से files bulk rename करें: screenshots, videos, PDFs, photos और Office documents। Microsoft Store से install होता है और auto-updates मिलते हैं।',
        ctaTitle: 'Windows पर Zush free try करें',
        ctaSubtitle: 'Microsoft Store खोलें और Windows batch rename tool से screenshots, videos, PDFs, photos और Office documents organize करें।',
        faqDescription: 'Windows के लिए Zush और बाकी product के बारे में जरूरी details।',
        features: [
          'Windows 11 और 10 file renamer जो screenshots, videos, PDFs, photos और documents को AI से bulk rename करता है',
          'नई files और regular cleanup के लिए folder monitoring',
          'हर file को regenerate option के साथ batch rename',
          'Names और metadata tags के लिए custom prompts',
          'Activity log से one-click undo',
    ...
    seo: {
      ...
      '/mac': {
        ...
        description: 'Mac file renamer जो AI से content के आधार पर files batch rename करता है: screenshots, PDFs, photos, videos, audio, design files और documents.',
      },
      '/windows': {
        title: 'Windows के लिए File Renamer: AI से Bulk Rename Files | Zush',
        description: 'Windows 11 और 10 file renamer जो AI से files bulk rename करता है: screenshots, PDFs, photos, videos, audio, design files और Office docs.',
      },
    },
