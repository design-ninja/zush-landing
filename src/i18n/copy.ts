...
const localizedFullHomeFaqItems: Partial<Record<Exclude<Locale, 'en'>, FAQCopyItem[]>> = {
  de: [
    ...
    { question: 'Wie funktioniert der Preis?', answer: `Zush PRO hat zwei Pläne: Monthly für ${PRO_PRICING.monthly.usd} $/Monat oder One-Time für ${PRO_PRICING.oneTime.usd} $. Beide schalten unbegrenztes PRO, BYOK und Offline-KI frei.` },
    ...
    { question: 'Gibt es einen Einmalkauf?', answer: `Ja. Neben dem Monatsplan gibt es einen Einmalkauf für ${PRO_PRICING.oneTime.usd} USD. Beide Pläne enthalten Unlimited PRO, BYOK und Offline-KI.` },
  ...
  fr: [
    ...
    { question: 'Comment fonctionne le prix ?', answer: `Zush PRO propose deux offres : Monthly à ${PRO_PRICING.monthly.usd} $/mois ou One-Time à ${PRO_PRICING.oneTime.usd} $. Les deux débloquent PRO illimité, BYOK et le mode IA hors ligne.` },
    ...
    { question: 'Existe-t-il un achat unique ?', answer: `Oui. En plus du plan mensuel, vous pouvez choisir l’achat unique à ${PRO_PRICING.oneTime.usd} USD. Les deux incluent Unlimited PRO, BYOK et IA hors ligne.` },
  ...
  'pt-br': [
    ...
    { question: 'Como funciona o preço?', answer: `Zush PRO tem dois planos: Monthly por US$ ${PRO_PRICING.monthly.usd}/mês ou One-Time por US$ ${PRO_PRICING.oneTime.usd}. Ambos liberam PRO ilimitado, BYOK e IA offline.` },
  ...
  es: [
    ...
    { question: '¿Cómo funciona el precio?', answer: `Zush PRO tiene dos planes: Monthly por ${PRO_PRICING.monthly.usd} US$/mes o One-Time por ${PRO_PRICING.oneTime.usd} US$. Ambos desbloquean PRO ilimitado, BYOK e IA offline.` },
  ...
  nl: [
    ...
    { question: 'Hoe werkt de prijs?', answer: `Zush PRO heeft twee plannen: Monthly voor ${PRO_PRICING.monthly.label}/maand of One-Time voor ${PRO_PRICING.oneTime.label}. Beide ontgrendelen onbeperkte PRO, BYOK en offline AI.` },
    ...
    { question: 'Is er een eenmalige aankoop?', answer: `Ja. Naast het maandplan kun je kiezen voor een eenmalige aankoop van ${PRO_PRICING.oneTime.usd} USD. Beide bevatten Unlimited PRO, BYOK en Offline AI.` },
  ...
  it: [
    ...
    { question: 'Come funziona il prezzo?', answer: `Zush PRO ha due piani: Monthly a ${PRO_PRICING.monthly.usd} $/mese oppure One-Time a ${PRO_PRICING.oneTime.usd} $. Entrambi sbloccano PRO illimitato, BYOK e IA offline.` },
    ...
    { question: 'Esiste un acquisto unico?', answer: `Sì. Oltre al piano mensile puoi scegliere l’acquisto unico a ${PRO_PRICING.oneTime.usd} USD. Entrambi includono Unlimited PRO, BYOK e IA offline.` },
  ...
  ja: [
    ...
    { question: '料金はどうなっていますか？', answer: `Zush PRO には Monthly（月額 ${PRO_PRICING.monthly.usd} ドル）と One-Time（${PRO_PRICING.oneTime.usd} ドル）の 2 つのプランがあります。どちらも無制限 PRO、BYOK、オフライン AI を利用できます。` },
  ...
  ko: [
    ...
    { question: '가격은 어떻게 되나요?', answer: `Zush PRO는 두 가지 플랜입니다: Monthly 월 ${PRO_PRICING.monthly.label} 또는 One-Time ${PRO_PRICING.oneTime.label}. 둘 다 무제한 PRO, BYOK, 오프라인 AI를 제공합니다.` },
    ...
    { question: '일회성 구매 옵션이 있나요?', answer: `예. 월간 플랜 외에도 ${PRO_PRICING.oneTime.usd} USD 일회성 구매를 선택할 수 있습니다. 둘 다 Unlimited PRO, BYOK, 오프라인 AI를 포함합니다.` },
  ...
  tr: [
    ...
    { question: 'Ücretlendirme nasıl çalışır?', answer: `Zush PRO iki plan sunar: ayda ${PRO_PRICING.monthly.usd} USD Monthly veya tek seferlik ${PRO_PRICING.oneTime.usd} USD One-Time. Her ikisi de sınırsız PRO, BYOK ve Çevrimdışı Yapay Zekâ’nın kilidini açar.` },
    ...
    { question: 'Monthly ile One-Time arasındaki fark nedir?', answer: `Monthly plan ayda ${PRO_PRICING.monthly.usd} USD’dir ve esnektir. One-Time plan ${PRO_PRICING.oneTime.usd} USD’dir ve ömür boyu erişim sağlar. Her ikisi de sınırsız PRO, BYOK ve Çevrimdışı Yapay Zekâ’yı açar.` },
  ...
  ar: [
    ...
    { question: 'كيف يعمل السعر؟', answer: `يتوفر Zush PRO بخطتين: Monthly مقابل ${PRO_PRICING.monthly.usd} دولارات/شهر أو One-Time مقابل ${PRO_PRICING.oneTime.usd} دولارا. كلاهما يفتح PRO غير محدود وBYOK وOffline AI.` },
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'offlineAiModal' | 'showcase' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  'zh-cn': {
    faqItems: [
      ...
      { question: '价格如何计算？', answer: `Zush PRO 有两个方案：Monthly 每月 ${PRO_PRICING.monthly.usd} 美元，或 One-Time ${PRO_PRICING.oneTime.usd} 美元。两者都解锁无限 PRO、BYOK 和离线 AI。` },
      ...
      { question: '是否有一次性购买选项？', answer: `有。除了月付方案，也可以选择 ${PRO_PRICING.oneTime.usd} USD 一次性购买。两者都包含 Unlimited PRO、BYOK 和离线 AI。` },
