...
const localizedFullHomeFaqItems: Record<Exclude<Locale, 'en' | 'zh-cn'>, FAQCopyItem[]> = {
  ...
  hi: [
    { question: 'Zush क्या है?', answer: 'Zush Mac और Windows के लिए एक स्मार्ट डेस्कटॉप ऐप है, जो AI की मदद से फ़ाइलों के नाम अपने-आप बदलता है। यह इमेज, वीडियो और PDF सहित समर्थित दस्तावेज़ों का विश्लेषण करके उपयोगी नाम और मेटाडेटा बनाता है।' },
    { question: 'कौन से फ़ाइल फ़ॉर्मैट समर्थित हैं?', answer: 'Zush इमेज, वीडियो, स्क्रीनशॉट, PDF, दस्तावेज़, स्प्रेडशीट, प्रेज़ेंटेशन, टेक्स्ट फ़ाइल, CSV, SVG और कई रोज़मर्रा के फ़ॉर्मैट को सपोर्ट करता है।' },
    ...
    { question: 'ऐप कौन सा AI मॉडल इस्तेमाल करता है?', answer: 'Zush इमेज, वीडियो और समर्थित दस्तावेज़ों के तेज़ और सटीक विश्लेषण के लिए आधुनिक multimodal AI मॉडल इस्तेमाल करता है। ऑप्टिमाइज़ेशन के साथ मॉडल बदल सकता है।' },
    ...
    { question: 'क्या ऑडियो या वीडियो फ़ाइलें समर्थित हैं?', answer: 'Zush 2.0 MP4, MOV, M4V, MPEG, 3GP, TS, MTS, M2TS, DV और VOB जैसे सामान्य वीडियो फ़ॉर्मैट को sampled frames और वैकल्पिक subtitles संदर्भ से analyze करता है। केवल-ऑडियो फ़ाइलें अभी समर्थित नहीं हैं।' },
...
const localizedHomeDetails: Record<Exclude<Locale, 'en'>, DeepPartial<Pick<HomeCopy, 'featureCards' | 'videos' | 'speedComparison' | 'whyZush' | 'useCases' | 'faqItems' | 'showcaseSlides'>>> = {
  ...
  hi: {
    ...
    whyZush: {
      ...
      formatsEyebrow: '91 समर्थित फ़ॉर्मैट',
      formatsTitle: 'इमेज, दस्तावेज़ और वीडियो',
      formatsDescription: '42 इमेज, 33 दस्तावेज़ और 16 वीडियो फ़ॉर्मैट सपोर्ट करता है, ताकि मिश्रित फ़ोल्डर वास्तविक कॉन्टेंट के आधार पर नाम पा सकें।',
...
const COPY: Record<Locale, LocaleCopy> = {
  ...
  hi: localized({
    ...
    home: {
      ...
      heroAccent: 'अपने-आप।',
      heroSubtitle: 'Mac और Windows के लिए तेज़ AI फ़ाइल नाम-बदलाव टूल। स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों को उपयोगी नामों से अपने-आप नाम दें — फ़ोल्डर निगरानी, BYOK और Offline AI शामिल।',
      buyPro: 'PRO खरीदें 🌟',
    ...
    platforms: {
      mac: {
        ...
        softwareDescription:
          'macOS के लिए AI फ़ाइल नाम-बदलाव टूल। स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम क्लाउड AI या Ollama के Offline AI मोड से बदलें।',
        heroTitle: 'Mac के लिए AI फ़ाइल नाम-बदलाव टूल',
        heroSubtitle:
          'macOS पर स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम AI से बदलें। तेज़ क्लाउड मॉडल या Ollama के निजी स्थानीय मॉडल वाला Offline AI मोड इस्तेमाल करें।',
        ctaTitle: 'Mac पर Zush मुफ़्त आज़माएँ',
        ctaSubtitle: 'Signed macOS ऐप इंस्टॉल करें और कुछ मिनटों में स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम बदलना शुरू करें।',
        faqDescription: 'Mac के लिए Zush और बाकी उत्पाद के बारे में जरूरी बातें।',
        features: [
          'स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के लिए AI नाम-बदलाव',
      ...
      windows: {
        ...
        softwareDescription:
          'Windows के लिए AI फ़ाइल नाम-बदलाव टूल। स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों को स्पष्ट नाम दें।',
        heroTitle: 'Windows के लिए AI फ़ाइल नाम-बदलाव टूल',
        heroSubtitle:
          'Windows पर स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम AI से बदलें। Microsoft Store से इंस्टॉल होता है, अपने-आप अपडेट मिलता है, मुफ़्त आज़मा सकते हैं और साइनअप की ज़रूरत नहीं।',
        ctaTitle: 'Windows पर Zush मुफ़्त आज़माएँ',
        ctaSubtitle: 'Microsoft Store खोलें और पूरे Windows बिल्ड से स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम बदलना शुरू करें।',
    ...
    seo: {
      '/': {
        ...
        description: 'स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम सेकंडों में बदलें। Mac और Windows पर एक साथ नाम बदलें या फ़ोल्डर देखें। मुफ़्त आज़माएँ।',
      },
      '/mac': {
        title: 'Mac के लिए Zush — macOS AI फ़ाइल नाम-बदलाव टूल',
        description: 'Mac पर स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम AI से बदलें। Apple Silicon, Intel, BYOK और Ollama Offline AI सपोर्ट।',
      },
      '/windows': {
        title: 'Windows के लिए Zush — AI फ़ाइल नाम-बदलाव टूल',
        description: 'Windows पर स्क्रीनशॉट, वीडियो, PDF, फ़ोटो और दस्तावेज़ों के नाम AI से बदलें। Microsoft Store इंस्टॉल, अपने-आप अपडेट और मुफ़्त ट्रायल।',
      },
    },
    featurePages: localizedFeaturePages('अक्सर पूछे जाने वाले सवाल', 'संबंधित टूल', 'संबंधित गाइड', [
      ...
      ['/rename-videos-with-ai', 'AI से वीडियो के नाम बदलें', 'MP4, MOV, स्क्रीन रिकॉर्डिंग और क्लिप को फ्रेम, संदर्भ और सबटाइटल से नाम दें।'],
    ]),
  }),
  ar: localized({
    header: {
