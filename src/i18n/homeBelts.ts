...
const en: HomeBeltsCopy = {
  aiModes: {
    ...
    description: 'Rename files with cloud AI, your own provider key, or a private local model — same Zush workflow.',
    offlineBadge: 'On-device',
    offlineTitle: 'Private Offline AI with Ollama',
    offlineDescription: 'Analyze files with a local model on your Mac or Windows PC — content never leaves your device.',
    offlinePrivacy: 'Local model · no cloud analysis',
    offlineLink: 'Set up Offline AI',
