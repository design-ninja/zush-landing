...
const en: HomeBeltsCopy = {
  aiModes: {
    ...
    byokDescription: 'Gemini, OpenRouter, OpenAI, or Claude',
...
export const HOME_BELTS_COPY: Record<Locale, HomeBeltsCopy> = {
  ...
  de: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI oder Claude',
  ...
  fr: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI ou Claude',
  ...
  es: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI o Claude',
  ...
  nl: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI of Claude',
  ...
  tr: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI veya Claude',
  ...
  ja: {
    aiModes: {
      ...
      byokDescription: 'Gemini、OpenRouter、OpenAI、Claude',
  ...
  ko: {
    aiModes: {
      ...
      byokDescription: 'Gemini, OpenRouter, OpenAI 또는 Claude',
  ...
  'zh-cn': {
    aiModes: {
      ...
      byokDescription: 'Gemini、OpenRouter、OpenAI 或 Claude',
  ...
  ar: {
    aiModes: {
      ...
      byokDescription: 'Gemini أو OpenRouter أو OpenAI أو Claude',
