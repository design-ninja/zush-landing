...
const ENHANCEMENTS: Record<NonEnglishLocale, LocaleEnhancement> = {
  fr: {
    accountants: {
      seo: {
        title: "Renommeur de fichiers IA pour comptables | Zush",
  ...
  de: {
    accountants: {
      seo: {
        title: "KI-Dateiumbenenner für Buchhaltung und Kanzleien | Zush",
  ...
  es: {
    accountants: {
      seo: { title: "Renombrador de archivos con IA para contables | Zush", description: "Renombra por lotes facturas, recibos, extractos, formularios fiscales y escaneos por proveedor, fecha, número, importe y cliente. Vista previa en Mac y Windows." },
    ...
    photographers: {
      seo: { title: "Renombrador de archivos con IA para fotógrafos y vídeo | Zush", description: "Renombra fotos RAW, JPEG y clips por proyecto, fecha, sujeto, escena y toma. Flujo por lotes para fotografía y vídeo en Mac y Windows." },
  ...
  'pt-br': {
    accountants: {
      seo: { title: "Renomeador de arquivos com IA para contadores | Zush", description: "Renomeie em lote notas, recibos, extratos, formulários fiscais e digitalizações por fornecedor, data, número, valor e cliente. Prévia no Mac e Windows." },
    ...
    photographers: {
      seo: { title: "Renomeador com IA para fotógrafos e videomakers | Zush", description: "Renomeie fotos RAW, JPEG e vídeos por projeto, data, assunto, cena e tomada. Fluxo em lote no Mac e Windows." }, pageTitle: "Renomeador com IA para fotógrafos e videomakers",
  ...
  it: {
    accountants: {
      seo: { title: "Rinomina file con IA per commercialisti | Zush", description: "Rinomina in batch fatture, ricevute, estratti, moduli fiscali e scansioni per fornitore, data, numero, importo e cliente. Anteprima su Mac e Windows." }, pageTitle: "Rinomina file con IA per commercialisti",
  ...
  nl: {
    accountants: {
      seo: { title: "AI-bestandshernoemer voor accountants | Zush", description: "Hernoem facturen, bonnen, afschriften, belastingformulieren en scans in bulk op leverancier, datum, nummer, bedrag en klant. Preview op Mac en Windows." }, pageTitle: "AI-bestandshernoemer voor accountants", hero: { eyebrow: "AI-bestandshernoemer voor accountants en kantoren", titleLead: "Geef boekhoudstukken namen op", titleAccent: "leverancier, datum en nummer", subtitle: "Zush is de naamgevingslaag voor boekhoudstukken, geen documentbeheer of grootboek. Het benoemt facturen, bonnen, afschriften, belastingformulieren en scans volgens de conventie van elke klant, met bulkpreview en ongedaan maken op Mac en Windows." },
  ...
  ja: {
    accountants: {
      seo: { title: "会計担当者向けAIファイル名変更ツール | Zush", description: "請求書、領収書、明細書、税務書類、スキャンを取引先、日付、番号、金額、顧客別に一括改名。MacとWindowsで事前確認できます。" }, pageTitle: "会計担当者向けAIファイル名変更ツール", hero: { eyebrow: "会計担当者・会計事務所向けAIファイル名変更", titleLead: "会計書類を整理できる名前へ：", titleAccent: "取引先・日付・番号", subtitle: "Zushは会計書類のファイル名を整えるレイヤーであり、文書管理や総勘定元帳ではありません。請求書、領収書、明細書、税務書類、スキャンを顧客ごとの規則で命名し、MacとWindowsで一括プレビューと取り消しができます。" },
    ...
    photographers: {
      seo: { title: "写真家・映像制作者向けAIファイル名変更 | Zush", description: "RAW、JPEG、動画をプロジェクト、日付、被写体、シーン、テイク別に一括改名。MacとWindows対応。" }, pageTitle: "写真家・映像制作者向けAIファイル名変更ツール", hero: { eyebrow: "写真家・映像制作者向け", titleLead: "写真向けAIファイル命名：", titleAccent: "撮影をプロジェクト・シーン・テイクで整理", subtitle: "Zushは写真家と映像制作者向けのデスクトップAIファイル名変更ツールです。利用可能なメタデータと視覚的内容を組み合わせてRAW、JPEG、対応動画を命名し、カタログ、編集、映像制作のツールはそのまま使えます。" },
  ...
  'zh-cn': {
    ...
    photographers: {
      seo: { title: "面向摄影师与视频创作者的 AI 文件重命名 | Zush", description: "按项目、日期、主体、场景和镜次批量重命名 RAW、JPEG 与视频。支持 Mac 和 Windows。" }, pageTitle: "面向摄影师与视频创作者的 AI 文件重命名工具", hero: { eyebrow: "面向摄影师与视频创作者", titleLead: "摄影工作流的 AI 文件命名：", titleAccent: "按项目、场景和镜次整理拍摄素材", subtitle: "Zush 是面向摄影师与视频创作者的桌面 AI 文件重命名工具。它结合可用元数据与视觉内容为 RAW、JPEG 和支持的视频命名，而目录、编辑与剪辑工具仍用于创作。" },
