...
const staticPages: Partial<Record<Exclude<Locale, 'en'>, Record<StaticLocalizedRoute, StaticPageCopy>>> = {
  de: {
    ...
    '/privacy-policy': {
      ...
      updated: 'Zuletzt aktualisiert: 2. September 2026',
      sections: [
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Lizenz', title: 'Nutzung und Zahlungen', body: 'Du erhältst eine persönliche, nicht übertragbare Lizenz. BYOK und Offline-KI sind in FREE mit einem gemeinsamen Limit von 50 Umbenennungen verfügbar. Zush PRO entfernt dieses Limit als Monatsplan oder Einmalkauf. Zahlungen werden über Paddle oder Store-Plattformen abgewickelt.' },
  ...
  fr: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Licence', title: 'Utilisation et paiements', body: 'Vous recevez une licence personnelle non transférable. BYOK et l’IA hors ligne sont disponibles avec FREE dans la limite partagée de 50 renommages. Zush PRO supprime cette limite en abonnement mensuel ou achat unique. Les paiements sont traités par Paddle ou les stores.' },
  ...
  'pt-br': {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Licença', title: 'Uso e pagamentos', body: 'Você recebe uma licença pessoal e intransferível. BYOK e IA offline estão disponíveis no FREE com um limite compartilhado de 50 renomeações. O Zush PRO remove esse limite no plano mensal ou na compra única. Pagamentos são processados por Paddle ou lojas.' },
  ...
  es: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Licencia', title: 'Uso y pagos', body: 'Recibes una licencia personal e intransferible. BYOK e IA offline están disponibles en FREE con un límite compartido de 50 renombrados. Zush PRO elimina ese límite con el plan mensual o la compra única. Los pagos se procesan mediante Paddle o tiendas.' },
  ...
  nl: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Licentie', title: 'Gebruik en betalingen', body: 'Je krijgt een persoonlijke, niet-overdraagbare licentie. BYOK en Offline AI zijn beschikbaar in FREE met een gedeelde limiet van 50 hernoemingen. Zush PRO verwijdert die limiet via een maandplan of eenmalige aankoop. Betalingen lopen via Paddle of stores.' },
  ...
  it: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'Licenza', title: 'Uso e pagamenti', body: 'Ricevi una licenza personale non trasferibile. BYOK e IA offline sono disponibili in FREE con un limite condiviso di 50 rinomine. Zush PRO rimuove il limite con un piano mensile o un acquisto unico. I pagamenti sono gestiti da Paddle o dagli store.' },
  ...
  ja: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: 'ライセンス', title: '利用と支払い', body: '個人用で譲渡不可のライセンスが付与されます。FREE では BYOK と Offline AI を共通 50 回まで利用できます。月額または買い切りの Zush PRO はこの上限を解除します。支払いは Paddle またはストア経由です。' },
  ...
  ko: {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: '라이선스', title: '사용 및 결제', body: '개인적이고 양도할 수 없는 라이선스가 제공됩니다. FREE는 BYOK와 오프라인 AI를 공통 50회까지 제공합니다. 월간 또는 일회성 Zush PRO는 이 제한을 제거합니다. 결제는 Paddle 또는 스토어에서 처리됩니다.' },
  ...
  'zh-cn': {
    ...
    '/terms-of-service': {
      ...
      sections: [
        ...
        { eyebrow: '许可', title: '使用与付款', body: '你获得个人、不可转让的使用许可。FREE 可在 BYOK 和离线 AI 之间共享 50 次重命名；月付或一次性购买的 Zush PRO 会移除此限制。付款由 Paddle 或应用商店处理。' },
