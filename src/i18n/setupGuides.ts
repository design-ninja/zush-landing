  ...
  es: {
    ...
    byok: {
      ...
      faqs: [
        ...
        { question: '¿Necesito PRO?', answer: 'Sí, BYOK es exclusivo de PRO. Puedes actualizar con un pago único de 38 US$.' },
      ],
  ...
  nl: {
    ...
    byok: {
      ...
      faqs: [
        ...
        { question: 'Heb ik PRO nodig?', answer: 'Ja, BYOK is exclusief voor PRO. Gratis gebruikers kunnen upgraden met een eenmalige betaling van 38 dollar.' },
      ],
