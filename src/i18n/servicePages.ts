...
const en: ServicePageCopy = {
  ...
  seo: {
    ...
    '/manage-subscription/confirm': { title: 'Opening Subscription Portal — Zush', description: 'Open the secure billing portal for Zush.' },
...
const serviceCopies: Partial<Record<Locale, ServicePageCopy>> = {
  ...
  de: {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: 'Weiterleitung zum Zahlungsportal...',
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO ist aktiv. Du kannst unbegrenzte PRO-Umbenennungen, BYOK und Offline-KI nutzen.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Abo-Portal wird geöffnet — Zush', description: 'Öffne das sichere Zahlungsportal für Zush.' },
  ...
  fr: {
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO est actif. Profitez des renommages PRO illimités, de BYOK et du mode IA hors ligne.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Ouverture du portail d’abonnement — Zush', description: 'Ouvrez le portail de facturation sécurisé pour Zush.' },
  ...
  'pt-br': {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: 'Redirecionando para o portal de cobrança...',
    ...
    thankYou: {
      ...
      activatedText: 'Seu Zush PRO está ativo. Aproveite renomeações PRO ilimitadas, BYOK e modo IA offline.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Abrindo portal da assinatura — Zush', description: 'Abra o portal de cobrança seguro do Zush.' },
  ...
  es: {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: 'Redirigiendo al portal de facturación...',
    ...
    thankYou: {
      ...
      activatedText: 'Tu Zush PRO está activo. Disfruta renombrados PRO ilimitados, BYOK y modo IA offline.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Abriendo portal de suscripción — Zush', description: 'Abre el portal de facturación seguro de Zush.' },
  ...
  nl: {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: 'Doorsturen naar het betalingsportaal...',
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO is actief. Je kunt onbeperkte PRO-hernoemingen, BYOK en Offline AI gebruiken.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Abonnementsportaal openen — Zush', description: 'Open het veilige betalingsportaal voor Zush.' },
  ...
  it: {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: 'Reindirizzamento al portale di fatturazione...',
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO è attivo. Usa rinomine PRO illimitate, BYOK e la modalità IA offline.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'Apertura portale abbonamento — Zush', description: 'Apri il portale di fatturazione sicuro per Zush.' },
  ...
  ja: {
    ...
    manageSubscriptionConfirm: {
      ...
      redirecting: '請求ポータルにリダイレクトしています...',
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO が有効になりました。無制限の PRO リネーム、BYOK、オフライン AI モードを利用できます。',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: 'サブスクリプションポータルを開く — Zush', description: 'Zush の安全な請求ポータルを開きます。' },
  ...
  ko: {
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO가 활성화되었습니다. 무제한 PRO 이름 변경, BYOK, 오프라인 AI 모드를 사용할 수 있습니다.',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: '구독 포털 여는 중 — Zush', description: 'Zush용 보안 결제 포털을 엽니다.' },
  ...
  'zh-cn': {
    ...
    thankYou: {
      ...
      activatedText: 'Zush PRO 已激活。你可以使用无限 PRO 重命名、BYOK 和离线 AI 模式。',
    ...
    seo: {
      ...
      '/manage-subscription/confirm': { title: '正在打开订阅门户 — Zush', description: '打开 Zush 的安全账单门户。' },
