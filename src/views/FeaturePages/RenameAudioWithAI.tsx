...
const RenameAudioWithAI = () => (
  <FeatureLandingPage
    ...
    definitionText="Rename audio with AI using Zush to replace generic track, memo, interview, podcast, and meeting filenames with searchable names based on metadata, recognition, and transcript context. Zush renames files in place, with optional AI folder sorting (beta)."
    showcaseSlides={[
      {
        files: [
