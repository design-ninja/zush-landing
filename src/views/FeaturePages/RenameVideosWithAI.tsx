...
const RenameVideosWithAI = () => (
  <FeatureLandingPage
    ...
    definitionText="Rename videos with AI using Zush to replace generic screen recording, camera, and export filenames with searchable names based on sampled frames, visible context, and subtitles. Zush renames files in place, with optional AI folder sorting (beta)."
    showcaseSlides={[
      {
        files: [
