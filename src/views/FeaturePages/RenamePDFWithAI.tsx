...
const RenamePDFWithAI = () => (
  <FeatureLandingPage
    ...
    definitionText="Rename PDFs with AI using Zush to read invoices, contracts, scans, and reports, then turn weak filenames into searchable document titles. Zush renames files in place, with optional AI folder sorting (beta)."
    showcaseSlides={[
      {
        files: [
