...
export async function GET() {
  ...
  const body = [
    ...
    `- [Zush vs Sparkle](${SITE_ORIGIN}/blog/zush-vs-sparkle)`,
    `- [Zush vs Bulk Rename Utility](${SITE_ORIGIN}/blog/zush-vs-bulk-rename-utility)`,
    ...
    `- [Automatic File Organizer for Windows](${SITE_ORIGIN}/blog/automate-file-organization-windows)`,
    `- [Batch Rename Google Drive Files](${SITE_ORIGIN}/blog/batch-rename-google-drive-files)`,
    `- [Batch Rename Dropbox Files](${SITE_ORIGIN}/blog/batch-rename-dropbox-files)`,
    `- [Batch Rename iCloud Drive Files](${SITE_ORIGIN}/blog/rename-organize-icloud-drive-files)`,
