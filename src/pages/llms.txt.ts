...
export async function GET() {
  ...
  const body = [
    ...
    '- Privacy options: BYOK supports Gemini, Groq, OpenAI, and Claude. LM Studio and Ollama keep supported analysis on the computer and do not silently fall back to cloud analysis while selected.',
    ...
    '- LM Studio and Ollama fit users who want local model control; BYOK fits users who prefer their own Gemini, Groq, OpenAI, or Claude key.',
