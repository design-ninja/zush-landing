...
export async function GET() {
  ...
  const body = [
    ...
    '- AI modes: Zush Cloud AI and BYOK are cloud routes; Built-in Local AI, LM Studio, and Ollama are local routes on Mac and Windows.',
    '- Privacy options: BYOK supports Gemini, Groq, OpenAI, and Claude. Built-in Local AI, LM Studio, and Ollama keep supported analysis on the computer and do not silently fall back to cloud analysis while selected.',
    `- Pricing: FREE includes 50 AI renames shared across Zush Cloud AI, BYOK, Built-in Local AI, LM Studio, and Ollama; ${PRO_PRICING_SUMMARY} PRO removes the rename limit.`,
    ...
    '- Built-in Local AI fits users who want Zush to manage the local runtime and model; LM Studio and Ollama fit users who manage their own local models; BYOK fits users who prefer their own Gemini, Groq, OpenAI, or Claude key.',
