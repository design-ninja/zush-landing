...
- Free starter: $0; includes ${APP_CONFIG.free_tier_limit} AI renames shared across Zush Cloud AI, BYOK, LM Studio, and Ollama; no credit card required. Templates, Naming Blocks, Custom AI Blocks, and custom AI prompts are included free.
...
- Every AI mode is available on every plan. Both paid plans remove the ${APP_CONFIG.free_tier_limit}-rename limit across Zush Cloud AI, BYOK, LM Studio, and Ollama.
...
- Processing modes: managed Zush Cloud AI; BYOK with Gemini, Groq, OpenAI, or Claude; LM Studio; and Ollama. LM Studio and Ollama keep supported analysis on the Mac or Windows PC and do not silently fall back to cloud analysis while selected.
